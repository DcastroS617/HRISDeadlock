<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="OvertimeCompaniesList.aspx.cs" Inherits="HRISWeb.Overtime.OvertimeCompaniesList" %>
                    ...
                    <div class="row">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%=txtCompanieCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblCompanieCode")%></label>
                                    </div>
                                    <div class="col-sm-7">

                                        <asp:TextBox ID="txtCompanieCode" CssClass="form-control control-validation  " runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-5">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%=txtCompanieName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblCompanieName")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtCompanieName" CssClass="form-control" runat="server" autocomplete="off" MaxLength="250" type="text"></asp:TextBox>
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div>
                                <asp:GridView ID="grvList"
                                    ...
                                    CssClass="table table-striped table-hover table-bordered" DataKeyNames="OvertimeCompanieCode"
                                    ...
                                    <Columns>
                                            ...
                                            <HeaderTemplate>
                                                <div style="width: 100%; vertical-align: middle; text-align: center;">
                                                    <asp:LinkButton ID="lbtnOvertimeCompanieCodeSort" runat="server" CommandName="Sort" CommandArgument="OvertimeCompanieCode">                
                                                        <span><%= GetLocalResourceObject("lblCompanieCode") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvOvertimeCompanieCode" data-id="OvertimeCompanieCode" data-value="<%# Eval("OvertimeCompanieCode") %>"><%# Eval("OvertimeCompanieCode") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" HeaderStyle-VerticalAlign="Middle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="lbtnOvertimeCompanieNameSort" runat="server" CommandName="Sort" CommandArgument="OvertimeCompanieName">                
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" HeaderStyle-VerticalAlign="Middle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="lbtnOvertimeCompanieActivatedSort" runat="server" CommandName="Sort" CommandArgument="OvertimeCompanieActivated">                
                                                        <span><%= GetLocalResourceObject("lblCompanieActivated") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvOvertimeCompanieActivated" data-id="OvertimeCompanieActivated" aria-hidden="true" data-value="<%# Eval("OvertimeCompanieActivated") %>" class="fa <%# ((DOLE.HRIS.Shared.Entity.OvertimeCompaniesEntity)Container.DataItem).OvertimeCompanieActivated ? "fa-check-circle" : "fa-times-circle" %> "></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                ...
                <asp:UpdatePanel runat="server" ID="uppDialogControl">
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                <asp:HiddenField ID="hdfOvertimeCompanieCode" runat="server" Value="" />
                                <div class="form-group" style="display:none;">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtOverTimeCompanieCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblCompanieCode")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtOverTimeCompanieCode" ReadOnly="true" CssClass="form-control control-validation" runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtOverTimeCompanieName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblCompanieName")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtOverTimeCompanieName" CssClass="form-control" runat="server" autocomplete="off" MaxLength="250" type="text"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= chkOverTimeCompanieActivated.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblCompanieActivated")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:CheckBox runat="server" ID="chkOverTimeCompanieActivated" />
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">     
        ...
        function pageLoad(sender, args) {
            ...
            $('#<%= btnAdd.ClientID %>').on('click', function (ev) {
                ...
                $("#<%=txtOverTimeCompanieCode.ClientID%>").val("");
                $("#<%=txtOverTimeCompanieName.ClientID%>").val("");
                $("#<%=chkOverTimeCompanieActivated.ClientID%>").prop('checked', false);
                if (validator != null) {
                    validator.resetForm();
                    validator.destroy();
                }
        ...
        function ProcessAcceptRequest(resetId) {
            ...
            $("#<%=txtOverTimeCompanieCode.ClientID%>").prop('disabled', false);
            if (!ValidateForm()) {
                setTimeout(function () {
                    ResetButton(resetId);
            ...
            $("#<%=txtOverTimeCompanieCode.ClientID%>").prop('disabled', true);
            return false;
        }
            ...
            if (validator == null) {
                ...
                var validator =
                    $('#' + document.forms[0].id).validate({
                        ...
                        rules: {
                            <%= txtOverTimeCompanieCode.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
                },
                            <%= txtOverTimeCompanieName.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
        ...
        function ProcessBtnAddUserRequest(resetId) {
            ...
            /// <param name="resetId" type="String">Id of the button to reset if not request proceed</param>
            if (!IsOnlyOneRowCheked($("#<%= txtOverTimeCompanieCode.ClientID%>"))) {
                ErrorButton(resetId);
                ...
                var checks = $('#<%= txtOverTimeCompanieCode.ClientID%>').find('input:checkbox[id*="chkSelected"]:checked:not(#chkSelectedAll)');
