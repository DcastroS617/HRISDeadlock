<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="CodeRoleApproverList.aspx.cs" Inherits="HRISWeb.Overtime.CodeRoleApproverList" %>
                    ...
                    <div class="row">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%=txtApproverID.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblCodeRoleApproverID")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtApproverID" CssClass="form-control control-validation cleanPasteText EnterKey" runat="server" autocomplete="off"  type="number" ></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-5">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%=txtApprover.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblRoleApprover")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtApprover" CssClass="form-control cleanPasteText EnterKey" runat="server" onkeypress="return isNumberOrLetter(event);" autocomplete="off" MaxLength="250" type="text"></asp:TextBox>
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div>
                                <asp:GridView ID="grvList"
                                    ...
                                    CssClass="table table-striped table-hover table-bordered" DataKeyNames="CodeRoleApproverID"
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; vertical-align: middle; text-align: center;">
                                                    <asp:LinkButton ID="lbtnCodeRoleApproverIDSort" runat="server" CommandName="Sort" CommandArgument="CodeRoleApproverID">                
                                                        <span><%= GetLocalResourceObject("lblCodeRoleApproverID") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvCodeRoleApproverID" data-id="CodeRoleApproverID" data-value="<%# Eval("CodeRoleApproverID") %>"><%# Eval("CodeRoleApproverID") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" HeaderStyle-VerticalAlign="Middle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="lbtnRoleApproverSort" runat="server" CommandName="Sort" CommandArgument="RoleApprover">                
                                                        <span><%= GetLocalResourceObject("lblRoleApprover") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvRoleApprover" data-id="RoleApprover" data-value="<%# Eval("RoleApprover") %>"><%# Eval("RoleApprover") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                ...
                <asp:UpdatePanel runat="server" ID="uppDialogControl">
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                <asp:HiddenField ID="hdfCodeRoleApproverID" runat="server" Value="" />
                                <div class="form-group" style="display:none;">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%= txtCodeRoleApproverID.ClientID%>"  class="control-label"><%=GetLocalResourceObject("lblCodeRoleApproverID")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                       <asp:TextBox ID="txtCodeRoleApproverID" ReadOnly="true" CssClass="form-control control-validation cleanPasteText EnterKey" runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%= txtRoleApprover.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblRoleApprover")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                       <asp:TextBox ID="txtRoleApprover" CssClass="form-control cleanPasteText EnterKey" onkeypress="return isNumberOrLetter(event);" runat="server" autocomplete="off" MaxLength="250" type="text"></asp:TextBox>
                                    </div>
                                </div>
                        ...
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <asp:Panel ID="pnlDuplicatedDialogDataDetail" runat="server">
                                    <div class="form-group">
                                        <div class="col-sm-5 text-left">
                                            <label for="<%= txtDuplicatedCourseCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblCodeRoleApproverID")%></label>
                                        </div>

                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtDuplicatedCourseCode" CssClass="form-control cleanPasteText ignoreValidation" runat="server" onkeypress="return isNumberOrLetter(event)" ReadOnly="true"></asp:TextBox>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <div class="col-sm-5 text-left">
                                            <label for="<%= txtDuplicatedCourseName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblRoleApprover")%></label>
                                        </div>

                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtDuplicatedCourseName" CssClass="form-control cleanPasteText ignoreValidation" runat="server" ReadOnly="true"></asp:TextBox>
                                        </div>
                                    </div>
                                </asp:Panel>
                            </div>
    ...
    <script type="text/javascript">
        ...
        function pageLoad(sender, args) {
            ...
            $('#<%= btnAdd.ClientID %>').on('click', function (ev) {
                ...
                $("#<%=txtCodeRoleApproverID.ClientID%>").val("");
                $("#<%=txtRoleApprover.ClientID%>").val("");
        ...
        function ProcessAcceptRequest(resetId) {
            ...
            $("#<%=txtCodeRoleApproverID.ClientID%>").prop('disabled', false);
            if (!ValidateForm()) {
                setTimeout(function () {
                    ResetButton(resetId);
            ...
            $("#<%=txtCodeRoleApproverID.ClientID%>").prop('disabled', true);
            return false;
        }
            ...
            if (validator == null) {
                ...
                var validator =
                    $('#' + document.forms[0].id).validate({
                        ...
                        rules: {
                            <%= txtCodeRoleApproverID.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
                },
                            <%= txtRoleApprover.UniqueID %>: {
                                required: true
                                , normalizer: function( value ) {
                                    return $.trim( value );
                                }
        ...
        function ProcessBtnAddUserRequest(resetId) {
            ...
            /// <param name="resetId" type="String">Id of the button to reset if not request proceed</param>
            if (!IsOnlyOneRowCheked($("#<%= txtCodeRoleApproverID.ClientID%>"))) {
                ErrorButton(resetId);
                ...
                var checks = $('#<%= txtCodeRoleApproverID.ClientID%>').find('input:checkbox[id*="chkSelected"]:checked:not(#chkSelectedAll)');
