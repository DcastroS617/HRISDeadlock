<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DayType.aspx.cs" Inherits="HRISWeb.Overtime.DayType" %>
                    ...
                    <div class="row">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%=txtDayTypeCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDayTypeCode")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtDayTypeCode" CssClass="form-control control-validation cleanPasteText EnterKey" runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-5">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%=txtDayTypeName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDayTypeName")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtDayTypeName" CssClass="form-control cleanPasteText EnterKey" onkeypress="return isNumberOrLetter(event);" runat="server" autocomplete="off" MaxLength="250" type="text"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div>
                                <asp:GridView ID="grvList"
                                    ...
                                    CssClass="table table-striped table-hover table-bordered" DataKeyNames="DayTypeCode"
                                    ...
                                    <Columns>
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            ...
                                            <ItemTemplate>
                                                <span id="dvOvertimeDayTypeCode" data-id="OvertimeDayTypeCode" data-value="<%# Eval("DayTypeCode") %>"><%# Eval("DayTypeCode") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" HeaderStyle-VerticalAlign="Middle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="lbtnOvertimeDayTypeNameSort" runat="server" CommandName="Sort" CommandArgument="OvertimeDayTypeName">                
                                                        <span><%= GetLocalResourceObject("lblDayTypeName") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvOvertimeDayTypeName" data-id="DayTypesName" data-value="<%# Eval("DayTypesName") %>"><%# Eval("DayTypesName") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                ...
                <asp:UpdatePanel runat="server" ID="uppDialogControl">
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                <asp:HiddenField ID="hdfOvertimeDayTypeCode" runat="server" Value="" />
                                <div class="form-group" style="display:none;">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtOverTimeDayTypeCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDayTypeCode")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtOverTimeDayTypeCode" ReadOnly="true" CssClass="form-control control-validation cleanPasteText EnterKey" runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtOverTimeDayTypeName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDayTypeName")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtOverTimeDayTypeName" CssClass="form-control cleanPasteText EnterKey" onkeypress="return isNumberOrLetter(event);" runat="server" autocomplete="off" MaxLength="250" type="text"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">     
        ...
        function pageLoad(sender, args) {
            ...
            $('#<%= btnAdd.ClientID %>').on('click', function (ev) {
                ...
                $("#<%=txtOverTimeDayTypeCode.ClientID%>").val("");
                $("#<%=txtOverTimeDayTypeName.ClientID%>").val("");
                if (validator != null) {
                    validator.resetForm();
                    validator.destroy();
                }
        ...
        function ProcessAcceptRequest(resetId) {
            ...
            $("#<%=txtOverTimeDayTypeCode.ClientID%>").prop('disabled', false);
            if (!ValidateForm()) {
                setTimeout(function () {
                    ResetButton(resetId);
            ...
            $("#<%=txtOverTimeDayTypeCode.ClientID%>").prop('disabled', true);
            return false;
        }
            ...
            if (validator == null) {
                ...
                var validator =
                    $('#' + document.forms[0].id).validate({
                        ...
                        rules: {
                            <%= txtOverTimeDayTypeCode.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
                },
                            <%= txtOverTimeDayTypeName.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
        ...
        function ProcessBtnAddUserRequest(resetId) {
            ...
            /// <param name="resetId" type="String">Id of the button to reset if not request proceed</param>
            if (!IsOnlyOneRowCheked($("#<%= txtOverTimeDayTypeCode.ClientID%>"))) {
                ErrorButton(resetId);
                ...
                var checks = $('#<%= txtOverTimeDayTypeCode.ClientID%>').find('input:checkbox[id*="chkSelected"]:checked:not(#chkSelectedAll)');
