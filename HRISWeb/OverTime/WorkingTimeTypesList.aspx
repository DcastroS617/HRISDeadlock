<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="WorkingTimeTypesList.aspx.cs" Inherits="HRISWeb.Overtime.WorkingTimeTypesList" %>
                    ...
                    <div class="row">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-7 text-left">
                                        <label for="<%=txtTimeTypeCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblWorkingTimeTypeCode")%></label>
                                    </div>
                                    <div class="col-sm-5">
                                        <asp:TextBox ID="txtTimeTypeCode" CssClass="form-control control-validation cleanPasteText EnterKey" runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-7 text-left">
                                        <label for="<%=txtTimeTypeName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblWorkingTimeTypeName")%></label>
                                    </div>
                                    <div class="col-sm-5">
                                        <asp:TextBox ID="txtTimeTypeName" CssClass="form-control cleanPasteText EnterKey" onkeypress="return isNumberOrLetter(event);" runat="server" autocomplete="off" MaxLength="250" type="text"></asp:TextBox>
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-6 text-left">
                                        <label for="<%=txtTotalTime.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTotalWorkingTime")%></label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtTotalTime" CssClass="form-control control-validation cleanPasteText EnterKey" runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div>
                                <asp:GridView ID="grvList"
                                    ...
                                    CssClass="table table-striped table-hover table-bordered" DataKeyNames="WorkingTimeTypeCode"
                                    ...
                                    <Columns>
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; vertical-align: middle; text-align: center;">
                                                    <asp:LinkButton ID="lbtnWorkingTimeTypeCodeSort" runat="server" CommandName="Sort" CommandArgument="WorkingTimeTypeCode">                
                                                        <span><%= GetLocalResourceObject("lblWorkingTimeTypeCode") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvWorkingTimeTypeCode" data-id="WorkingTimeTypeCode" data-value="<%# Eval("WorkingTimeTypeCode") %>"><%# Eval("WorkingTimeTypeCode") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" HeaderStyle-VerticalAlign="Middle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="lbtnWorkingTimeTypeNameSort" runat="server" CommandName="Sort" CommandArgument="WorkingTimeTypeName">                
                                                        <span><%= GetLocalResourceObject("lblWorkingTimeTypeName") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvWorkingTimeTypeName" data-id="WorkingTimeTypeName" data-value="<%# Eval("WorkingTimeTypeName") %>"><%# Eval("WorkingTimeTypeName") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" HeaderStyle-VerticalAlign="Middle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="lbtnWorkingTimeTypeDescriptionSort" runat="server" CommandName="Sort" CommandArgument="WorkingTimeTypeDescription">                
                                                        <span><%= GetLocalResourceObject("lblWorkingTimeTypeDescription") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvWorkingTimeTypeDescription" data-id="WorkingTimeTypeDescription" data-value="<%# Eval("WorkingTimeTypeDescription") %>"><%# Eval("WorkingTimeTypeDescription") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" HeaderStyle-VerticalAlign="Middle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="lbtnTotalWorkingTimeSort" runat="server" CommandName="Sort" CommandArgument="TotalWorkingTime">                
                                                        <span><%= GetLocalResourceObject("lblTotalWorkingTime") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvTotalWorkingTime" data-id="TotalWorkingTime" data-value="<%# Eval("TotalWorkingTime") %>"><%# Eval("TotalWorkingTime") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" HeaderStyle-VerticalAlign="Middle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="lbtnMaxWorkingTimeSort" runat="server" CommandName="Sort" CommandArgument="MaxWorkingTime">                
                                                        <span><%= GetLocalResourceObject("lblMaxWorkingTime") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvMaxWorkingTime" data-id="MaxWorkingTime" data-value="<%# Eval("MaxWorkingTime") %>"><%# Eval("MaxWorkingTime") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                        ...
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group" style="display:none;">
                                    <div class="col-sm-6 text-left">
                                        <label for="<%= txtWorkingTimeTypeCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblWorkingTimeTypeCode")%></label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtWorkingTimeTypeCode" ReadOnly="true" CssClass="form-control control-validation cleanPasteText EnterKey" runat="server" autocomplete="off" type="number"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-6 text-left">
                                        <label for="<%= txtWorkingTimeTypeName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblWorkingTimeTypeName")%></label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtWorkingTimeTypeName" CssClass="form-control cleanPasteText EnterKey" onkeypress="return isNumberOrLetter(event);" runat="server" autocomplete="off" MaxLength="250" type="text"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-6 text-left" style="padding-right: inherit;">
                                        <label for="<%= txtWorkingTimeTypeDescription.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblWorkingTimeTypeDescription")%></label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtWorkingTimeTypeDescription" onkeypress="return isNumberOrLetter(event);" CssClass="form-control  cleanPasteText EnterKey" TextMode="MultiLine" Rows="3" runat="server" autocomplete="off" MaxLength="250" type="text"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-6 text-left">
                                        <label for="<%= txtTotalWorkingTime.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTotalWorkingTime")%></label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtTotalWorkingTime" CssClass="form-control control-validation cleanPasteText EnterKey" onkeypress="return isNumber(event);" runat="server" autocomplete="off" type="number" MaxLength="2" min="1" max="99" oninput="maxLengthCheck(this)"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-6 text-left">
                                        <label for="<%= txtMaxWorkingTime.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblMaxWorkingTime")%></label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtMaxWorkingTime" CssClass="form-control control-validation cleanPasteText EnterKey" onkeypress="return isNumber(event);" runat="server" autocomplete="off" type="number" MaxLength="2" min="1" max="99" oninput="maxLengthCheck(this)"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">     
        ...
        function pageLoad(sender, args) {
            ...
            $('#<%= btnAdd.ClientID %>').on('click', function (ev) {
                ...
                $("#<%=txtWorkingTimeTypeCode.ClientID%>").val("");
                $("#<%=txtWorkingTimeTypeName.ClientID%>").val("");
                $("#<%=txtWorkingTimeTypeDescription.ClientID%>").val("");
                $("#<%=txtTotalWorkingTime.ClientID%>").val("");
                $("#<%=txtMaxWorkingTime.ClientID%>").val("");
                if (validator != null) {
                    validator.resetForm();
                    validator.destroy();
                }
        ...
        function ProcessAcceptRequest(resetId) {
            ...
            $("#<%=txtWorkingTimeTypeCode.ClientID%>").prop('disabled', false);
            if (!ValidateForm()) {
                setTimeout(function () {
                    ResetButton(resetId);
            ...
            $("#<%=txtWorkingTimeTypeCode.ClientID%>").prop('disabled', true);
            return false;
        }
            ...
            if (validator == null) {
                ...
                var validator =
                    $('#' + document.forms[0].id).validate({
                        ...
                        rules: {
                            <%= txtWorkingTimeTypeCode.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
                },
                            <%= txtWorkingTimeTypeName.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
                },
                            <%= txtWorkingTimeTypeDescription.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
                },
                        <%= txtTotalWorkingTime.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
                },
                        <%= txtMaxWorkingTime.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
        ...
        function ProcessBtnAddUserRequest(resetId) {
            ...
            /// <param name="resetId" type="String">Id of the button to reset if not request proceed</param>
            if (!IsOnlyOneRowCheked($("#<%= txtWorkingTimeTypeCode.ClientID%>"))) {
                ErrorButton(resetId);
                ...
                var checks = $('#<%= txtWorkingTimeTypeCode.ClientID%>').find('input:checkbox[id*="chkSelected"]:checked:not(#chkSelectedAll)');
