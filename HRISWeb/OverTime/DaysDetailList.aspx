<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DaysDetailList.aspx.cs" Inherits="HRISWeb.Overtime.DaysDetailList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntBody" runat="server">
                    ...
                    <div class="row">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%=txtDetailCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDaysDetailCode")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtDetailCode" CssClass="form-control control-validation  cleanPasteText EnterKey" runat="server" autocomplete="off" onkeypress="return isNumber(event);" type="number"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%=cboTypeCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDayTypeCode")%></label>
                                    </div>
                                    <div class="col-sm-7">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-6 text-left">
                                        <label for="<%=txtDescriptionDayFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDescriptionDays")%></label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:TextBox runat="server" ID="txtDescriptionDayFilter" onkeypress="return isNumberOrLetter(event);" class="form-control control-validation  cleanPasteText EnterKey" type="text" autocomplete="off" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%=dtpDateBase.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblCodeDateBase")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:TextBox runat="server" ID="dtpDateBase" class="form-control date control-validation cleanPasteDigits" placeholder='<%$ Code:GetLocalResourceObject("lblDateFormatPlaceHolder") %>' type="text" autocomplete="off" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div>
                                <asp:GridView ID="grvList"
                                    ...
                                    CssClass="table table-striped table-hover table-bordered" DataKeyNames="DaysDetailCode"
                                    ...
                                    <Columns>
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; vertical-align: middle; text-align: center;">
                                                    <asp:LinkButton ID="lbtnDaysDetailCodeSort" runat="server" CommandName="Sort" CommandArgument="DaysDetailCode">                
                                                        <span><%= GetLocalResourceObject("lblDaysDetailCode") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvDaysDetailCode" data-id="DaysDetailCode" data-value="<%# Eval("DaysDetailCode") %>"><%# Eval("DaysDetailCode") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" HeaderStyle-VerticalAlign="Middle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="lbtnDayTypeCodeSort" runat="server" CommandName="Sort" CommandArgument="DayTypeCode">                
                                                        <span><%= GetLocalResourceObject("lblDayTypeCode") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvDayTypesName" data-id="DayTypesName" data-value="<%# Eval("DayTypesName") %>"><%# Eval("DayTypesName") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; vertical-align: middle; text-align: center;">
                                                    <asp:LinkButton ID="lbtnDescriptionDaysSort" runat="server" CommandName="Sort" CommandArgument="DescriptionDays">                
                                                        <span><%= GetLocalResourceObject("lblDescriptionDays") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvDescriptionDay" data-id="DescriptionDay" data-value="<%# Eval("DescriptionDay") %>"><%# Eval("DescriptionDay") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" HeaderStyle-VerticalAlign="Middle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="lbtnCodeDateBaseSort" runat="server" CommandName="Sort" CommandArgument="CodeDateBase">                
                                                        <span><%= GetLocalResourceObject("lblCodeDateBase") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvCodeDateBase" data-id="CodeDateBase" data-value="<%# Eval("CodeDateBaseFormatted") %>"><%# Eval("CodeDateBaseFormatted") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
            ...
            <asp:UpdatePanel ID="uppActions" runat="server">
                ...
                <ContentTemplate>
                    <div class="btn-group" role="group" aria-label="main-buttons">
                        ...
                        <button id="btnEdit" type="button" runat="server" class="btn btn-default btnAjaxAction" onserverclick="btnEdit_ServerClick" onclick="return ProcessEditRequest(this.id);"
                        ...
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group" style="display:none;">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%= txtDaysDetailCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDaysDetailCode")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtDaysDetailCode" ReadOnly="true" CssClass="form-control control-validation cleanPasteText EnterKey" onkeypress="return isNumber(event);" runat="server" autocomplete="off" type="number"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%= cboDayTypeCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDayTypeCode")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:DropDownList ID="cboDayTypeCode" CssClass="form-control control-validation" data-live-search="true" AutoPostBack="false" runat="server"></asp:DropDownList>
                                        <label id="lblcboDayTypeCode" for="<%= cboDayTypeCode.ClientID%>" class="label label-danger label-validation" data-toggle="tooltip" data-container="body" data-placement="left" data-content="<%= GetLocalResourceObject("msjValidation") %>" style="display: none; float: right; margin-right: 6px; margin-top: -23px; position: relative; z-index: 2;">!</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%= txtDescriptionDay.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDescriptionDays")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:TextBox runat="server" ID="txtDescriptionDay" onkeypress="return isNumberOrLetter(event);" class="form-control control-validation  cleanPasteText EnterKey" type="text" autocomplete="off" />
                                        <label id="lbltxtDescriptionDay" for="<%= txtDescriptionDay.ClientID%>" class="label label-danger label-validation" data-toggle="tooltip" data-container="body" data-placement="left" data-content="<%= GetLocalResourceObject("msjValidation") %>" style="display: none; float: right; margin-right: 6px; margin-top: -23px; position: relative; z-index: 2;">!</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%= dtpCodeDateBase.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblCodeDateBase")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:TextBox runat="server" ID="dtpCodeDateBase" class="form-control date control-validation cleanPasteDigits" placeholder='<%$ Code:GetLocalResourceObject("lblDateFormatPlaceHolder") %>' type="text" autocomplete="off" />
                                        <label id="lbldtpCodeDateBase" for="<%= dtpCodeDateBase.ClientID%>" class="label label-danger label-validation" data-toggle="tooltip" data-container="body" data-placement="left" data-content="<%= GetLocalResourceObject("msjValidation") %>" style="display: none; float: right; margin-right: 6px; margin-top: -23px; position: relative; z-index: 2;">!</label>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">     
        ...
        function pageLoad(sender, args) {
            ...
            $('#<%= dtpDateBase.ClientID %>').datetimepicker({
                format: 'MM/DD/YYYY',
            });
            $('#<%= dtpCodeDateBase.ClientID %>').datetimepicker({
                format: 'MM/DD/YYYY',
            });
            ...
            $(".btnDelete").click(function (ev) {
                ...
                '<%= GetLocalResourceObject("msjDelete") %>'
                   ...
                   <%= ClientScript.GetPostBackEventReference(btnDeleteH, String.Empty) %>;
                    ...
                    $('#<%=btnDelete.ClientID%>').button('reset');
                }
            });
            ...
            $('#<%= btnAdd.ClientID %>').on('click', function (ev) {
                ...
                $("#<%=txtDaysDetailCode.ClientID%>").val("");
                $("#<%=cboDayTypeCode.ClientID%>").val("");
                $("#<%=txtDescriptionDay.ClientID%>").val("");
                $("#<%=dtpCodeDateBase.ClientID%>").val("");
                if (validator != null) {
                    validator.resetForm();
                    validator.destroy();
                }
        ...
        function ProcessAcceptRequest(resetId) {
            ...
            $("#<%=txtDaysDetailCode.ClientID%>").prop('disabled', false);
            if (!ValidateForm()) {
                setTimeout(function () {
                    ResetButton(resetId);
            ...
            $("#<%=txtDaysDetailCode.ClientID%>").prop('disabled', true);
            return false;
        }
        ...
        //declare the validator
                ///var drpvalue = document.getElementById("<%=cboDayTypeCode.ClientID%>");
                ...
                var validator =
                    $('#' + document.forms[0].id).validate({
                        ...
                        rules: {
                            <%= txtDaysDetailCode.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
                },
                            <%= cboDayTypeCode.UniqueID %>: {
                    required: true
                        , validSelection: true
                },
                            <%= txtDescriptionDay.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
                },
                             <%= dtpCodeDateBase.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
        ...
        function ProcessBtnAddUserRequest(resetId) {
            ...
            /// <param name="resetId" type="String">Id of the button to reset if not request proceed</param>
            if (!IsOnlyOneRowCheked($("#<%= txtDaysDetailCode.ClientID%>"))) {
                ErrorButton(resetId);
                ...
                var checks = $('#<%= txtDaysDetailCode.ClientID%>').find('input:checkbox[id*="chkSelected"]:checked:not(#chkSelectedAll)');
