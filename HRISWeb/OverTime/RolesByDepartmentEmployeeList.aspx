<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="RolesByDepartmentEmployeeList.aspx.cs" Inherits="HRISWeb.Overtime.RolesByDepartmentEmployeeList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntBody" runat="server">
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div>
                                <asp:GridView ID="grvList"
                                    ...
                                    CssClass="table table-striped table-hover table-bordered" DataKeyNames="RolesByDepartmentEmployeeID"
                                    ...
                                    <Columns>
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" Visible="false">
                                            <HeaderTemplate>
                                                <div style="width: 100%; vertical-align: middle; text-align: center;">
                                                    <asp:LinkButton ID="lbtnRolesByDepartmentEmployeeIDSort" runat="server" CommandName="Sort" CommandArgument="RolesByDepartmentEmployeeID">                
                                                        <span><%= GetLocalResourceObject("lblRolesByDepartmentEmployeeID") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvRolesByDepartmentEmployeeID" data-id="RolesByDepartmentEmployeeID" data-value="<%# Eval("RolesByDepartmentEmployeeID") %>"><%# Eval("RolesByDepartmentEmployeeID") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" HeaderStyle-VerticalAlign="Middle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="lbtnRoleApproversCodeSort" runat="server" CommandName="Sort" CommandArgument="RoleApproversCode">                
                                                        <span><%= GetLocalResourceObject("lblRoleApproversCode") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvRoleApproversCode" data-id="RoleApproversCode" data-value="<%# Eval("RoleApproversDescription") %>"><%# Eval("RoleApproversDescription") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                        ...
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group" style="display:none;">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%= txtRolesByDepartmentEmployeeID.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblRolesByDepartmentEmployeeID")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtRolesByDepartmentEmployeeID" ReadOnly="true" CssClass="form-control control-validation" runat="server" autocomplete="off"  type="number"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                    ...
                                    <div class="col-sm-7">
                                        <asp:DropDownList ID="cboDepartmentCode" CssClass="form-control control-validation" OnSelectedIndexChanged="cboDepartmentCode_SelectedIndexChanged" data-live-search="true" AutoPostBack="true" runat="server"></asp:DropDownList>                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                    ...
                                    <div class="col-sm-7">
                                        <asp:DropDownList ID="cboEmployeeCode"  CssClass="form-control control-validation" data-live-search="true" AutoPostBack="false" runat="server"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%= cboRoleApproversCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblRoleApproversCode")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:DropDownList ID="cboRoleApproversCode" CssClass="form-control control-validation" data-live-search="true" AutoPostBack="false" runat="server"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">     
        ...
        function RedirectHome(currentUserIsModuleAdmin) {
        ...
        function pageLoad(sender, args) {
            ...
            $('#<%= btnAdd.ClientID %>').on('click', function (ev) {
                ...
                $("#<%=txtRolesByDepartmentEmployeeID.ClientID%>").val("");
                $("#<%=cboDepartmentCode.ClientID%>").val("");
                $("#<%=cboEmployeeCode.ClientID%>").val("");
                $("#<%=cboRoleApproversCode.ClientID%>").val("");
                if (validator != null) {
                    validator.resetForm();
                    validator.destroy();
                }
        ...
        function ProcessAcceptRequest(resetId) {
            ...
            $("#<%=txtRolesByDepartmentEmployeeID.ClientID%>").prop('disabled', false);
            if (!ValidateForm()) {
                setTimeout(function () {
                    ResetButton(resetId);
            ...
            $("#<%=txtRolesByDepartmentEmployeeID.ClientID%>").prop('disabled', true);
            return false;
        }
        ...
        function ValidateForm() {
            ...
            if (validator == null) {
                ...
                var drpvalue = document.getElementById("<%=cboRoleApproversCode.ClientID%>");
                ...
                var validator =
                    $('#' + document.forms[0].id).validate({
                        ...
                        rules: {
                            <%= txtRolesByDepartmentEmployeeID.UniqueID %>: {
                    required: true
        ...
        function ProcessBtnAddUserRequest(resetId) {
            ...
            /// <param name="resetId" type="String">Id of the button to reset if not request proceed</param>
            if (!IsOnlyOneRowCheked($("#<%= txtRolesByDepartmentEmployeeID.ClientID%>"))) {
                ErrorButton(resetId);
                ...
                var checks = $('#<%= txtRolesByDepartmentEmployeeID.ClientID%>').find('input:checkbox[id*="chkSelected"]:checked:not(#chkSelectedAll)');
