<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="WorkingTimeRangesList.aspx.cs" Inherits="HRISWeb.Overtime.WorkingTimeRangeList" %>
                    ...
                    <div class="row">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-6 text-left">
                                        <label for="<%=txtTimeRangeCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblWorkingTimeRangeCode")%></label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtTimeRangeCode" CssClass="form-control control-validation cleanPasteText EnterKey" runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-6 text-left">
                                        <label for="<%=cboTimeTypeCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblWorkingTimeTypeCode")%></label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:DropDownList ID="cboTimeTypeCode" CssClass="form-control control-validation EnterKey" data-live-search="true" AutoPostBack="false" runat="server"></asp:DropDownList>
                        ...
                        <div class="col-sm-4">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-6 text-left">
                                        <label for="<%=cboStartTime.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblWorkingStartTime")%></label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:DropDownList ID="cboStartTime" CssClass="form-control control-validation EnterKey" data-live-search="true" AutoPostBack="false" runat="server"></asp:DropDownList>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-6 text-left">
                                        <label for="<%=cboEndTime.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblWorkingEndTime")%></label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:DropDownList ID="cboEndTime" CssClass="form-control control-validation EnterKey" data-live-search="true" AutoPostBack="false" runat="server"></asp:DropDownList>
                        ...
                        <div class="col-sm-4">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <%--<label for="<%=chkCompanieActivated.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblCompanieActivated")%></label>--%>
                                    </div>
                                    <div class="col-sm-7 text-right">
                                        <%-- <asp:CheckBox runat="server" ID="chkCompanieActivated" />--%>
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div>
                                <asp:GridView ID="grvList"
                                    ...
                                    CssClass="table table-striped table-hover table-bordered" DataKeyNames="WorkingTimeRangeCode"
                                    ...
                                    <Columns>
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; vertical-align: middle; text-align: center;">
                                                    <asp:LinkButton ID="lbtnWorkingTimeRangeCodeSort" runat="server" CommandName="Sort" CommandArgument="WorkingTimeRangeCode">                
                                                        <span><%= GetLocalResourceObject("lblWorkingTimeRangeCode") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvWorkingTimeRangeCode" data-id="WorkingTimeRangeCode" data-value="<%# Eval("WorkingTimeRangeCode") %>"><%# Eval("WorkingTimeRangeCode") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; vertical-align: middle; text-align: center;">
                                                    <asp:LinkButton ID="lbtnWorkingStartTimeSort" runat="server" CommandName="Sort" CommandArgument="WorkingStartTime">                
                                                        <span><%= GetLocalResourceObject("lblWorkingStartTime") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvWorkingStartTime" data-id="WorkingStartTime" data-value="<%# Eval("WorkingStartTime") %>"><%# Eval("WorkingStartTime") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; vertical-align: middle; text-align: center;">
                                                    <asp:LinkButton ID="lbtnWorkingEndTimeSort" runat="server" CommandName="Sort" CommandArgument="WorkingEndTime">                
                                                        <span><%= GetLocalResourceObject("lblWorkingEndTime") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvWorkingEndTime" data-id="WorkingEndTime" data-value="<%# Eval("WorkingEndTime") %>"><%# Eval("WorkingEndTime") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                        ...
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group" style="display:none;">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%= txtWorkingTimeRangeCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblWorkingTimeRangeCode")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtWorkingTimeRangeCode" ReadOnly="true" CssClass="form-control control-validation"  onkeypress="return isNumberOrLetter(event);"  runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%= DropWorkingTimeTypeCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblWorkingTimeTypeCode")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:DropDownList ID="DropWorkingTimeTypeCode" CssClass="form-control control-validation EnterKey" data-live-search="true" AutoPostBack="false" runat="server"></asp:DropDownList>
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%= DropWorkingStartTime.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblWorkingStartTime")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:DropDownList ID="DropWorkingStartTime" CssClass="form-control control-validation EnterKey" data-live-search="true" AutoPostBack="false" runat="server"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%= DropWorkingEndTime.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblWorkingEndTime")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:DropDownList ID="DropWorkingEndTime" CssClass="form-control control-validation EnterKey" data-live-search="true" AutoPostBack="false" runat="server"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">     
        ...
        function pageLoad(sender, args) {
            ...
            $('#<%= btnAdd.ClientID %>').on('click', function (ev) {
                ...
                $("#<%=txtWorkingTimeRangeCode.ClientID%>").val("");
                $("#<%=DropWorkingTimeTypeCode.ClientID%>").val("");
                $("#<%=DropWorkingStartTime.ClientID%>").val("");
                $("#<%=DropWorkingEndTime.ClientID%>").val("");
                if (validator != null) {
                    validator.resetForm();
                    validator.destroy();
                }
        ...
        function ProcessAcceptRequest(resetId) {
            ...
            $("#<%=txtWorkingTimeRangeCode.ClientID%>").prop('disabled', false);
            if (!ValidateForm()) {
                setTimeout(function () {
                    ResetButton(resetId);
            ...
            $("#<%=txtWorkingTimeRangeCode.ClientID%>").prop('disabled', true);
            return false;
        }
        ...
        function ValidateForm() {
            ...
            if (validator == null) {
                ...
                var drpvalue = document.getElementById("<%=DropWorkingTimeTypeCode.ClientID%>");
                ...
                var validator =
                    $('#' + document.forms[0].id).validate({
                        ...
                        rules: {
                            <%= txtWorkingTimeRangeCode.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
                },
                            <%= DropWorkingTimeTypeCode.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
                },
                            <%= DropWorkingStartTime.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
                },
                            <%= DropWorkingEndTime.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
        ...
        function ProcessBtnAddUserRequest(resetId) {
            ...
            /// <param name="resetId" type="String">Id of the button to reset if not request proceed</param>
            if (!IsOnlyOneRowCheked($("#<%= txtWorkingTimeRangeCode.ClientID%>"))) {
                ErrorButton(resetId);
                ...
                var checks = $('#<%= txtWorkingTimeRangeCode.ClientID%>').find('input:checkbox[id*="chkSelected"]:checked:not(#chkSelectedAll)');
