<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="UserCodeList.aspx.cs" Inherits="HRISWeb.Overtime.UserCodeList" %>
                    ...
                    <div class="row">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%=txtUserCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblUserCodeID")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtUserCode" CssClass="form-control control-validation cleanPasteText EnterKey" runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-5">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%=cboRoleApproverID.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblCodeRoleApproverID")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:DropDownList ID="cboRoleApproverID" CssClass="form-control control-validation" data-live-search="true" AutoPostBack="false" runat="server"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div>
                                <asp:GridView ID="grvList"
                                    ...
                                    CssClass="table table-striped table-hover table-bordered" DataKeyNames="UserCodeID"
                                    ...
                                    <Columns>
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; vertical-align: middle; text-align: center;">
                                                    <asp:LinkButton ID="lbtnUserCodeIDSort" runat="server" CommandName="Sort" CommandArgument="UserCodeID">                
                                                        <span><%= GetLocalResourceObject("lblUserCodeID") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvUserCodeID" data-id="UserCodeID" data-value="<%# Eval("UserCodeID") %>"><%# Eval("UserCodeID") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" HeaderStyle-VerticalAlign="Middle">
                                            ...
                                            <ItemTemplate>
                                                <span id="dvCodeRoleApproverID" data-id="CodeRoleApproverID" data-value="<%# Eval("RoleApprover") %>"><%# Eval("RoleApprover") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                        ...
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group" style="display:none;">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%= txtUserCodeID.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblUserCodeID")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtUserCodeID" ReadOnly="true" CssClass="form-control control-validation  cleanPasteText EnterKey" runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%= cboCodeRoleApproverID.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblCodeRoleApproverID")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:DropDownList ID="cboCodeRoleApproverID" CssClass="form-control control-validation" data-live-search="true" AutoPostBack="false" runat="server"></asp:DropDownList>
                                         <label id="lblcboCodeRoleApproverID" for="<%= cboCodeRoleApproverID.ClientID%>" class="label label-danger label-validation" data-toggle="tooltip" data-container="body" data-placement="left" data-content="<%= GetLocalResourceObject("msjValidation") %>" style="display: none; float: right; margin-right: 6px; margin-top: -23px; position: relative; z-index: 2;">!</label>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">     
        ...
        function pageLoad(sender, args) {
            ...
            $('#<%= btnAdd.ClientID %>').on('click', function (ev) {
                ...
                $("#<%=txtUserCodeID.ClientID%>").val("");
                $("#<%=cboCodeRoleApproverID.ClientID%>").val("");
                if (validator != null) {
                    validator.resetForm();
                    validator.destroy();
                }
        ...
        function ProcessAcceptRequest(resetId) {
            ...
            $("#<%=txtUserCodeID.ClientID%>").prop('disabled', false);
            if (!ValidateForm()) {
                setTimeout(function () {
                    ResetButton(resetId);
            ...
            $("#<%=txtUserCodeID.ClientID%>").prop('disabled', true);
            return false;
        }
        ...
        function ValidateForm() {
            ...
            if (validator == null) {
                ...
                var drpvalue = document.getElementById("<%=cboCodeRoleApproverID.ClientID%>");
                ...
                var validator =
                    $('#' + document.forms[0].id).validate({
                        ...
                        rules: {
                            <%= txtUserCodeID.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
                },
                            <%= cboCodeRoleApproverID.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
        ...
        function ProcessBtnAddUserRequest(resetId) {
            ...
            /// <param name="resetId" type="String">Id of the button to reset if not request proceed</param>
            if (!IsOnlyOneRowCheked($("#<%= txtUserCodeID.ClientID%>"))) {
                ErrorButton(resetId);
                ...
                var checks = $('#<%= txtUserCodeID.ClientID%>').find('input:checkbox[id*="chkSelected"]:checked:not(#chkSelectedAll)');
