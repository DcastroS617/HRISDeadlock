<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="WorkDepartmentList.aspx.cs" Inherits="HRISWeb.Overtime.WorkDepartmentList" %>
                    ...
                    <div class="row">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-7 text-left">
                                        <label for="<%=txtDepartmentCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblWorkDepartmentCode")%></label>
                                    </div>
                                    <div class="col-sm-5">

                                        <asp:TextBox ID="txtDepartmentCode" CssClass="form-control control-validation  " runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-7 text-left">
                                        <label for="<%=txtDepartmentName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblWorkDepartmentName")%></label>
                                    </div>
                                    <div class="col-sm-5">
                                        <asp:TextBox ID="txtDepartmentName" CssClass="form-control" runat="server" autocomplete="off" MaxLength="250" type="text"></asp:TextBox>
                                        </button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-6 text-left">
                                        <label for="<%=cboCompanieName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblCompanieName")%></label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:DropDownList ID="cboCompanieName" CssClass="form-control control-validation" data-live-search="true" AutoPostBack="false" runat="server"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div>
                                <asp:GridView ID="grvList"
                                    ...
                                    CssClass="table table-striped table-hover table-bordered" DataKeyNames="WorkDepartmentCode"
                                    ...
                                    <Columns>
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; vertical-align: middle; text-align: center;">
                                                    <asp:LinkButton ID="lbtnWorkDepartmentCodeSort" runat="server" CommandName="Sort" CommandArgument="WorkDepartmentCode">                
                                                        <span><%= GetLocalResourceObject("lblWorkDepartmentCode") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvWorkDepartmentCode" data-id="WorkDepartmentCode" data-value="<%# Eval("WorkDepartmentCode") %>"><%# Eval("WorkDepartmentCode") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" HeaderStyle-VerticalAlign="Middle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="lbtnOvertimeCompanieCodeSort" runat="server" CommandName="Sort" CommandArgument="OvertimeCompanieCode">                
                                                        <span><%= GetLocalResourceObject("lblCompanieName") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvOvertimeCompanieName" data-id="OvertimeCompanieName" data-value="<%# Eval("OvertimeCompanieName") %>"><%# Eval("OvertimeCompanieName") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; vertical-align: middle; text-align: center;">
                                                    <asp:LinkButton ID="lbtnWorkDepartmentNameSort" runat="server" CommandName="Sort" CommandArgument="WorkDepartmentName">                
                                                        <span><%= GetLocalResourceObject("lblWorkDepartmentName") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvWorkDepartmentName" data-id="WorkDepartmentName" data-value="<%# Eval("WorkDepartmentName") %>"><%# Eval("WorkDepartmentName") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" HeaderStyle-VerticalAlign="Middle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="lbtnWorkDepartmentActivedSort" runat="server" CommandName="Sort" CommandArgument="WorkDepartmentActived">                
                                                        <span><%= GetLocalResourceObject("lblWorkDepartmentActived") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                 <span id="dvWorkDepartmentActived" data-id="WorkDepartmentActived" aria-hidden="true" data-value="<%# Eval("WorkDepartmentActived") %>" class="fa <%# ((DOLE.HRIS.Shared.Entity.WorkDepartmentsEntity)Container.DataItem).WorkDepartmentActived ? "fa-check-circle" : "fa-times-circle" %> "></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                        ...
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group" style="display:none;">
                                    <div class="col-sm-6 text-left">
                                        <label for="<%= txtWorkDepartmentCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblWorkDepartmentCode")%></label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtWorkDepartmentCode" ReadOnly="true" CssClass="form-control control-validation" runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-6 text-left">
                                        <label for="<%= cboOvertimeCompanieCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblCompanieName")%></label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:DropDownList ID="cboOvertimeCompanieCode" CssClass="form-control control-validation" data-live-search="true" AutoPostBack="false" runat="server"></asp:DropDownList>

                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-6 text-left">
                                        <label for="<%= txtWorkDepartmentName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblWorkDepartmentName")%></label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtWorkDepartmentName" CssClass="form-control" runat="server" autocomplete="off" MaxLength="250" type="text"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-6 text-left">
                                        <label for="<%= chkWorkDepartmentActived.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblWorkDepartmentActived")%></label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:CheckBox runat="server" ID="chkWorkDepartmentActived" />
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">     
        ...
        function pageLoad(sender, args) {
            ...
            $('#<%= btnAdd.ClientID %>').on('click', function (ev) {
                ...
                $("#<%=txtWorkDepartmentCode.ClientID%>").val("");
                $("#<%=cboOvertimeCompanieCode.ClientID%>").val("");
                $("#<%=txtWorkDepartmentName.ClientID%>").val("");
                $("#<%=chkWorkDepartmentActived.ClientID%>").prop('checked', false);
                if (validator != null) {
                    validator.resetForm();
                    validator.destroy();
                }
        ...
        function ProcessAcceptRequest(resetId) {
            ...
            $("#<%=txtWorkDepartmentCode.ClientID%>").prop('disabled', false);
            if (!ValidateForm()) {
                setTimeout(function () {
                    ResetButton(resetId);
            ...
            $("#<%=txtWorkDepartmentCode.ClientID%>").prop('disabled', true);
            return false;
        }
        ...
        function ValidateForm() {
            ...
            if (validator == null) {
                ...
                var drpvalue = document.getElementById("<%=cboOvertimeCompanieCode.ClientID%>");
                ...
                var validator =
                    $('#' + document.forms[0].id).validate({
                        ...
                        rules: {
                            <%= txtWorkDepartmentCode.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
                },
                            <%= cboOvertimeCompanieCode.UniqueID %>: {
                                required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                                }
                            ...
                            <%= txtWorkDepartmentName.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
        ...
        function ProcessBtnAddUserRequest(resetId) {
            ...
            /// <param name="resetId" type="String">Id of the button to reset if not request proceed</param>
            if (!IsOnlyOneRowCheked($("#<%= txtWorkDepartmentCode.ClientID%>"))) {
                ErrorButton(resetId);
                ...
                var checks = $('#<%= txtWorkDepartmentCode.ClientID%>').find('input:checkbox[id*="chkSelected"]:checked:not(#chkSelectedAll)');
