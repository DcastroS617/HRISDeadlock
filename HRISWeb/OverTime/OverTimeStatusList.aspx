<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="OverTimeStatusList.aspx.cs" Inherits="HRISWeb.Overtime.OverTimeStatusList" %>
                    ...
                    <div class="row">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-6 text-left">
                                        <label for="<%=txtStatusCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblOverTimeStatusCode")%></label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtStatusCode" CssClass="form-control control-validation  cleanPasteText EnterKey" runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-5">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-6 text-left">
                                        <label for="<%=txtStatusName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblOverTimeStatusName")%></label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtStatusName" CssClass="form-control cleanPasteText EnterKey" onkeypress="return isNumberOrLetter(event);" runat="server" autocomplete="off" MaxLength="250" type="text"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div>
                                <asp:GridView ID="grvList"
                                    ...
                                    DataKeyNames="OverTimeStatusCode"
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; vertical-align: middle; text-align: center;">
                                                    <asp:LinkButton ID="lbtnOverTimeStatusCodeSort" runat="server" CommandName="Sort" CommandArgument="OverTimeStatusCode" OnClientClick="SetWaitingGrvList(true);">                
                                                        <span><%= GetLocalResourceObject("lblOverTimeStatusCode") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvOverTimeStatusCode" data-id="OverTimeStatusCode" data-value="<%# Eval("OverTimeStatusCode") %>"><%# Eval("OverTimeStatusCode") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" HeaderStyle-VerticalAlign="Middle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="lbtnOverTimeStatusNameSort" runat="server" CommandName="Sort" CommandArgument="OverTimeStatusName">                
                                                        <span><%= GetLocalResourceObject("lblOverTimeStatusName") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvOverTimeStatusName" data-id="OverTimeStatusName" data-value="<%# Eval("OverTimeStatusName") %>"><%# Eval("OverTimeStatusName") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                        ...
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group" style="display:none;">
                                    <div class="col-sm-6 text-left">
                                        <label for="<%= txtOverTimeStatusCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblOverTimeStatusCode")%></label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtOverTimeStatusCode" ReadOnly="true" CssClass="form-control control-validation cleanPasteText EnterKey" runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-6 text-left">
                                        <label for="<%= txtOverTimeStatusName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblOverTimeStatusName")%></label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtOverTimeStatusName" CssClass="form-control cleanPasteText EnterKey" onkeypress="return isNumberOrLetter(event);" runat="server" autocomplete="off" MaxLength="250" type="text"></asp:TextBox>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">     
        ...
        function pageLoad(sender, args) {
            ...
            $('#<%= btnAdd.ClientID %>').on('click', function (ev) {
                ...
                $("#<%=txtOverTimeStatusCode.ClientID%>").val("");
                $("#<%=txtOverTimeStatusName.ClientID%>").val("");
                if (validator != null) {
                    validator.resetForm();
                    validator.destroy();
                }
        ...
        function ProcessAcceptRequest(resetId) {
            ...
            $("#<%=txtOverTimeStatusCode.ClientID%>").prop('disabled', false);
            if (!ValidateForm()) {
                setTimeout(function () {
                    ResetButton(resetId);
            ...
            $("#<%=txtOverTimeStatusCode.ClientID%>").prop('disabled', true);
            return false;
        }
            ...
            if (validator == null) {
                ...
                var validator =
                    $('#' + document.forms[0].id).validate({
                        ...
                        rules: {
                            <%= txtOverTimeStatusCode.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
                },
                            <%= txtOverTimeStatusName.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        },
        ...
        function ProcessBtnAddUserRequest(resetId) {
            ...
            /// <param name="resetId" type="String">Id of the button to reset if not request proceed</param>
            if (!IsOnlyOneRowCheked($("#<%= txtOverTimeStatusCode.ClientID%>"))) {
                ErrorButton(resetId);
                ...
                var checks = $('#<%= txtOverTimeStatusCode.ClientID%>').find('input:checkbox[id*="chkSelected"]:checked:not(#chkSelectedAll)');
