<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="OvertimeApprovalTypesList.aspx.cs" Inherits="HRISWeb.Overtime.OvertimeApprovalTypesList" %>
                    ...
                    <div class="row">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%=txtApprovalTypeCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblOvertimeApprovalTypeCode")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtApprovalTypeCode" CssClass="form-control control-validation  " runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-5">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%=txtApprovalTypeName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblOvertimeApprovalTypeName")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtApprovalTypeName" CssClass="form-control" runat="server" autocomplete="off" MaxLength="250" type="text"></asp:TextBox>
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div>
                                <asp:GridView ID="grvList"
                                    ...
                                    CssClass="table table-striped table-hover table-bordered" DataKeyNames="OvertimeApprovalTypeCode"
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; vertical-align: middle; text-align: center;">
                                                    <asp:LinkButton ID="lbtnOvertimeApprovalTypeCodeSort" runat="server" CommandName="Sort" CommandArgument="OvertimeApprovalTypeCode">                
                                                        <span><%= GetLocalResourceObject("lblOvertimeApprovalTypeCode") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvOvertimeApprovalTypeCode" data-id="OvertimeApprovalTypeCode" data-value="<%# Eval("OvertimeApprovalTypeCode") %>"><%# Eval("OvertimeApprovalTypeCode") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" HeaderStyle-VerticalAlign="Middle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="lbtnOvertimeApprovalTypeNameSort" runat="server" CommandName="Sort" CommandArgument="OvertimeApprovalTypeName">                
                                                        <span><%= GetLocalResourceObject("lblOvertimeApprovalTypeName") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvOvertimeApprovalTypeName" data-id="OvertimeApprovalTypeName" data-value="<%# Eval("OvertimeApprovalTypeName") %>"><%# Eval("OvertimeApprovalTypeName") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group" style="display:none;">
                                    <div class="col-sm-6 text-left">
                                        <label for="<%= txtOvertimeApprovalTypeCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblOvertimeApprovalTypeCode")%></label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtOvertimeApprovalTypeCode" ReadOnly="true" CssClass="form-control control-validation" runat="server" autocomplete="off"  type="number"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-6 text-left">
                                        <label for="<%= txtOvertimeApprovalTypeName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblOvertimeApprovalTypeName")%></label>
                                    </div>
                                    <div class="col-sm-6">
                                        <asp:TextBox ID="txtOvertimeApprovalTypeName" CssClass="form-control" runat="server" autocomplete="off" MaxLength="250" type="text"></asp:TextBox>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">     
        ...
        function pageLoad(sender, args) {
            ...
            $('#<%= btnAdd.ClientID %>').on('click', function (ev) {
                ...
                $("#<%=txtOvertimeApprovalTypeCode.ClientID%>").val("");
                $("#<%=txtOvertimeApprovalTypeName.ClientID%>").val("");
                if (validator != null) {
                    validator.resetForm();
                    validator.destroy();
                }
        ...
        function ProcessAcceptRequest(resetId) {
            ...
            $("#<%=txtOvertimeApprovalTypeCode.ClientID%>").prop('disabled', false);
            if (!ValidateForm()) {
                setTimeout(function () {
                    ResetButton(resetId);
            ...
            $("#<%=txtOvertimeApprovalTypeCode.ClientID%>").prop('disabled', true);
            return false;
        }
            ...
            if (validator == null) {
                ...
                var validator =
                    $('#' + document.forms[0].id).validate({
                        ...
                        rules: {
                            <%= txtOvertimeApprovalTypeCode.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
                },
                            <%= txtOvertimeApprovalTypeName.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
        ...
        function ProcessBtnAddUserRequest(resetId) {
            ...
            /// <param name="resetId" type="String">Id of the button to reset if not request proceed</param>
            if (!IsOnlyOneRowCheked($("#<%= txtOvertimeApprovalTypeCode.ClientID%>"))) {
                ErrorButton(resetId);
                ...
                var checks = $('#<%= txtOvertimeApprovalTypeCode.ClientID%>').find('input:checkbox[id*="chkSelected"]:checked:not(#chkSelectedAll)');
