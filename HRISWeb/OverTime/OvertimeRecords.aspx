<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="OvertimeRecords.aspx.cs" Inherits="HRISWeb.Overtime.OvertimeRecords" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntBody" runat="server">
    <div class="main-content">
        ...
        <asp:UpdatePanel ID="uppMain" runat="server">
            <Triggers>
                <asp:PostBackTrigger ControlID="btnSearchFilter" />
            </Triggers>
            <ContentTemplate>
                        ...
                        <div class="col-sm-4">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <asp:TextBox runat="server" ID="dtpOvertimeDateFrom" class="form-control date control-validation cleanPasteDigits EnterKey" placeholder='<%$ Code:GetLocalResourceObject("lblDateFormatPlaceHolder") %>' type="text" autocomplete="off" />
                        ...
                        <div class="col-sm-4">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <asp:TextBox runat="server" ID="dtpOvertimeDateto" class="form-control date control-validation cleanPasteDigits EnterKey" placeholder='<%$ Code:GetLocalResourceObject("lblDateFormatPlaceHolder") %>' type="text" autocomplete="off" />
                        ...
                        <div class="col-sm-4">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtovetimeNumber" CssClass="form-control control-validation cleanPasteText EnterKey" runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-4" style="display: none">
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtStartHoursFrom" CssClass="form-control control-validation cleanPasteDigits EnterKey" runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                            ...
                            <div class="col-sm-4" style="display: none">
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtStartHoursTo" CssClass="form-control control-validation cleanPasteDigits EnterKey" runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                        ...
                        <div class="col-sm-4" style="display: none">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtEndHoursFrom" CssClass="form-control control-validation EnterKey" runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                        ...
                        <div class="col-sm-4" style="display: none">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtEndHoursTo" CssClass="form-control control-validation  EnterKey " runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-right">
                            <button id="btnSearchFilter" type="button" runat="server" class="btn btn-default btnAjaxAction" onserverclick="btnSearchFilter_ServerClick"
                                data-loading-text='<%$ Code:String.Concat("<span class=\"fa fa-spinner fa-spin glyphicon-main-button\"></span>&nbsp;", GetLocalResourceObject("btnSearch"))%>' data-error-text='<%$ Code:String.Concat("<span class=\"glyphicon glyphicon-exclamation-sign glyphicon-main-button\"></span>&nbsp;", GetLocalResourceObject("btnSearch"))%>'>
                        ...
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <asp:TextBox runat="server" ID="dtpOverTimeDate" class="form-control date control-validation cleanPasteDigits EnterKey" placeholder='<%$ Code:GetLocalResourceObject("lblDateFormatPlaceHolder") %>' autocomplete="off" />
                                ...
                                <div class="form-group" style="display: none">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= ddlEmployeeCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblEmployeeCode")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <select id="ddlEmployeeCode" runat="server" class="form-control limpiarCampos cleanPasteText"></select>
                                        <label id="txtEmployeeCodeValidation" for="<%= ddlEmployeeCode.ClientID%>" class="label label-danger label-validation" data-toggle="tooltip" data-container="body" data-placement="left" data-content="<%= GetLocalResourceObject("msjValidation") %>" style="display: none; float: right; margin-right: 6px; margin-top: -23px; position: relative; z-index: 2;">!</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:DropDownList ID="cboEndHour" runat="server" CssClass="form-control selectpicker" ></asp:DropDownList>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="col-sm-3" style="padding-left: 0px;">
                                         ...
                                         <div id="msjOvertimeHours" class="col-sm-9 text-left font-weight-bold" style="padding-left: 0px; display: none;">
                                            <label class="label label-danger"><%=GetLocalResourceObject("lblMaxHoursWarning")%></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtJustificationForExtraTime" CssClass="form-control cleanPasteText EnterKey" Rows="10" Height="120px" runat="server" MaxLength="2000" onkeypress="blockEnterKey();return isNumberOrLetter(event)" TextMode="Multiline"></asp:TextBox>
                                ...
                                <div id="divRemark" class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label id="lblApprovalRemark" for="<%= txtApprovalRemark.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblApprovalRemark")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtApprovalRemark" Enabled="false" CssClass="form-control cleanPasteText EnterKey" Rows="10" Height="120px" runat="server" MaxLength="2000" onkeypress="blockEnterKey();return isNumberOrLetter(event)" TextMode="Multiline"></asp:TextBox>
                                        <label id="lblApprovalRemarks" for="<%= txtApprovalRemark.ClientID%>" class="label label-danger label-validation" data-toggle="tooltip" data-container="body" data-placement="left" data-content="<%= GetLocalResourceObject("msjValidation") %>" style="display: none; float: right; margin-right: 6px; margin-top: -23px; position: relative; z-index: 2;">!</label>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">     
        ...
        function CleanModal() {
            $("#<%=txtOverTimeNumber.ClientID%>").val();
            $("#<%=dtpOverTimeDate.ClientID%>").val();
            $("#<%=cboStartHour.ClientID%>").val(-1);
            $("#<%=cboEndHour.ClientID%>").val(-1);
            $("#<%=txtTotalHours.ClientID%>").val();
            $("#<%=txtJustificationForExtraTime.ClientID%>").val();
            $("#<%=txtApprovalRemark.ClientID%>").val();
        }
        ...
        function CalcularHoras() {
            ...
            const [hora1, minuto1] = startHour.split(':').map(Number);
            const [hora2, minuto2] = endHour.split(':').map(Number);

            // Crear las fechas con las horas indicadas
            const fechaInicio = new Date(0, 0, 0, hora1, minuto1);
            const fechaFin = new Date(0, 0, 0, hora2, minuto2);
            ...
            if (startHour.trim() === "" || endHour.trim() === "") {
                $('#<%= txtTotalHours.ClientID %>').val('');
                $('#<%= hdnTotalHours.ClientID %>').val('');
            }
            else {
                $('#<%= txtTotalHours.ClientID %>').val(horasFormateadas + ":" + minutosFormateados);
                $('#<%= hdnTotalHours.ClientID %>').val(horasFormateadas + ":" + minutosFormateados);
            }
            validateTimeJourney();
        }
        ...
        function validateTimeJourney() {
            ...
            var employeeJourney = localStorage.getItem('Employee');
            var timeRegister = $('#<%= hdnTotalHours.ClientID %>').val();

            var workingTimeEntity = listWorkingTime.filter(z => z.WorkingTimeTypeCode == employeeJourney);
            var timeArray = timeRegister.split(":");
            if (parseInt(timeArray[0]) == workingTimeEntity[0].MaxWorkingTime) {
                if (parseInt(timeArray[1]) > 0) {
                    $('#msjOvertimeHours').show();
                    SetControlValid('<%=txtJustificationForExtraTime.ClientID%>');
                }
            } else if (parseInt(timeArray[0]) > workingTimeEntity[0].MaxWorkingTime) {
                $('#msjOvertimeHours').show();
                SetControlValid('<%=txtJustificationForExtraTime.ClientID%>');
            } else {
                $('#msjOvertimeHours').hide();
            }
        }
                    ...
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                             ...
                             "<%= txtJustificationForExtraTime.UniqueID %>": {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
        ...
        function ReturnFromBtnAcceptClickPostBackSucces() {
            /// <summary>Manage the events, ui and logic after the postback</summary>            
            DisableButtonsDialog();
            $('#MaintenanceDialog').modal('hide');
            $(".btnAccept").prop("disabled", false);
