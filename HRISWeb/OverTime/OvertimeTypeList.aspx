<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="OvertimeTypeList.aspx.cs" Inherits="HRISWeb.Overtime.OvertimeTypeList" %>
                    ...
                    <div class="row">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%=txtTypeCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblOvertimeTypeCode")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtTypeCode" CssClass="form-control control-validation cleanPasteText EnterKey" runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-5">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%=txtTypeName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblOvertimeTypeName")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtTypeName" CssClass="form-control cleanPasteText EnterKey" onkeypress="return isNumberOrLetter(event);"  runat="server" autocomplete="off" MaxLength="250" type="text"></asp:TextBox>
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div>
                                <asp:GridView ID="grvList"
                                    ...
                                    CssClass="table table-striped table-hover table-bordered" DataKeyNames="OvertimeTypeCode"
                                    ...
                                    <Columns>
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            ...
                                            <ItemTemplate>
                                                <span id="dvOvertimeTypeCode" data-id="OvertimeTypeCode" data-value="<%# Eval("OvertimeTypeCode") %>"><%# Eval("OvertimeTypeCode") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" HeaderStyle-VerticalAlign="Middle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="lbtnOvertimeTypeNameSort" runat="server" CommandName="Sort" CommandArgument="OvertimeTypeName">                
                                                        <span><%= GetLocalResourceObject("lblOvertimeTypeName") %></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvOvertimeTypeName" data-id="OvertimeTypeName" data-value="<%# Eval("OvertimeTypeName") %>"><%# Eval("OvertimeTypeName") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                        ...
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group" style="display:none;">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%= txtOvertimeTypeCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblOvertimeTypeCode")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtOvertimeTypeCode" ReadOnly="true" CssClass="form-control control-validation cleanPasteText EnterKey" runat="server" autocomplete="off" MaxLength="10" type="number" min="0"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%= txtOvertimeTypeName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblOvertimeTypeName")%></label>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtOvertimeTypeName" CssClass="form-control cleanPasteText EnterKey" onkeypress="return isNumberOrLetter(event);"  runat="server" autocomplete="off" MaxLength="250" type="text"></asp:TextBox>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">     
        ...
        function pageLoad(sender, args) {
            ...
            $('#<%= btnAdd.ClientID %>').on('click', function (ev) {
                ...
                $("#<%=txtOvertimeTypeCode.ClientID%>").val("");
                $("#<%=txtOvertimeTypeName.ClientID%>").val("");
                if (validator != null) {
                    validator.resetForm();
                    validator.destroy();
                }
        ...
        function ProcessAcceptRequest(resetId) {
            ...
            $("#<%=txtOvertimeTypeCode.ClientID%>").prop('disabled', false);
            if (!ValidateForm()) {
                setTimeout(function () {
                    ResetButton(resetId);
            ...
            $("#<%=txtOvertimeTypeCode.ClientID%>").prop('disabled', true);
            return false;
        }
            ...
            if (validator == null) {
                ...
                var validator =
                    $('#' + document.forms[0].id).validate({
                        ...
                        rules: {
                            <%= txtOvertimeTypeCode.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
                },
                            <%= txtOvertimeTypeName.UniqueID %>: {
                    required: true
                        , normalizer: function(value) {
                            return $.trim(value);
                        }
        ...
        function ProcessBtnAddUserRequest(resetId) {
            ...
            /// <param name="resetId" type="String">Id of the button to reset if not request proceed</param>
            if (!IsOnlyOneRowCheked($("#<%= txtOvertimeTypeCode.ClientID%>"))) {
                ErrorButton(resetId);
                ...
                var checks = $('#<%= txtOvertimeTypeCode.ClientID%>').find('input:checkbox[id*="chkSelected"]:checked:not(#chkSelectedAll)');
