<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ReasonNotAttention.aspx.cs" Inherits="HRISWeb.SocialResponsability.Maintenances.ReasonNotAttention" %>
                                ...
                                <div class="form-group">
                                    <div class="form-group col-sm-12 col-md-8 ES">
                                        <div class="col-sm-5 text-left">
                                            <label for="<%= txtReasonNotAttentionNameSpanishFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblReasonNotAttentionName")%></label>
                                        </div>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtReasonNotAttentionNameSpanishFilter" CssClass="form-control control-validation cleanPasteText ignoreValidation" runat="server" onkeypress="blockEnterKey(); return isNumberOrLetter(event)" MaxLength="150" autocomplete="off" type="text"></asp:TextBox>
                                        </div>
                                     </div>
                                    <div class="form-group col-sm-12 col-md-8 EN">
                                        <div class="col-sm-5 text-left">
                                            <label for="<%= txtReasonNotAttentionNameEnglishFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblReasonNotAttentionName")%></label>
                                        </div>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtReasonNotAttentionNameEnglishFilter" CssClass="form-control control-validation cleanPasteText ignoreValidation" runat="server" onkeypress="blockEnterKey(); return isNumberOrLetter(event)" MaxLength="150" autocomplete="off" type="text"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div>
                                <asp:GridView ID="grvList" Width="100%" runat="server" EmptyDataText='<%$ Code:GetLocalResourceObject("lblNoData") %>' 
                                    ...
                                    DataKeyNames="ReasonNotAttentionCode" OnPreRender="grvList_PreRender" OnSorting="grvList_Sorting" OnRowDataBound="GrvList_RowDataBound">                             
                                    <Columns>                                        
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle hidden" HeaderStyle-CssClass="hidden" FooterStyle-CssClass="hidden" >
                                            <HeaderTemplate>
                                                <div style="width:100%; text-align:center;">
                                                    <asp:LinkButton ID="ReasonNotAttentionCodeSort" runat="server" CommandName="Sort" CommandArgument="ReasonNotAttentionCode" OnClientClick="SetWaitingGrvList(true);">          
                                                        <span><%= GetLocalResourceObject("ReasonNotAttentionCode.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "ReasonNotAttentionCode") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvReasonNotAttentionCode" data-id="ReasonNotAttentioncode" data-value="<%# Eval("ReasonNotAttentionCode") %>"><%# Eval("ReasonNotAttentionCode") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField> 
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" >
                                            <HeaderTemplate>
                                                <div style="width:100%; text-align:center;">
                                                    <asp:LinkButton ID="ReasonNotAttentionNameEnglishSort" runat="server" CommandName="Sort" CommandArgument="ReasonNotAttentionNameEnglish" OnClientClick="SetWaitingGrvList(true);">          
                                                        <span><%= GetLocalResourceObject("ReasonNotAttentionNameEN.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "ReasonNotAttentionNameEnglish") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvReasonNotAttentionNameEnglish" data-id="ReasonNotAttentionnameenglish" data-value="<%# Eval("ReasonNotAttentionDescriptionEnglish") %>"><%# Eval("ReasonNotAttentionDescriptionEnglish")%></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>  
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" >
                                            <HeaderTemplate>
                                                <div style="width:100%; text-align:center;">
                                                    <asp:LinkButton ID="ReasonNotAttentionNameSpanishSort" runat="server" CommandName="Sort" CommandArgument="ReasonNotAttentionNameSpanish" OnClientClick="SetWaitingGrvList(true);">          
                                                        <span><%= GetLocalResourceObject("ReasonNotAttentionNameES.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "ReasonNotAttentionNameSpanish") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvReasonNotAttentionNameSpanish" data-id="ReasonNotAttentionnamespanish" data-value="<%# Eval("ReasonNotAttentionDescriptionSpanish") %>"><%# Eval("ReasonNotAttentionDescriptionSpanish")%></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>   
                                    </Columns>
                                </asp:GridView>           
                ...
                <asp:UpdatePanel runat="server" ID="uppDialogControl">
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                <asp:HiddenField ID="hdfReasonNotAttentionCodeEdit" runat="server" Value="" />
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtReasonNotAttentionNameSpanish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblReasonNotAttentionNameSpanish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtReasonNotAttentionNameSpanish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" MaxLength="150" TextMode="SingleLine" autocomplete="off"></asp:TextBox>
                                        <label id="txtReasonNotAttentionNameSpanishValidation" for="<%= txtReasonNotAttentionNameSpanish.ClientID%>" class="label label-danger label-validation" data-toggle="tooltip" data-container="body" data-placement="left" data-content="<%= GetLocalResourceObject("msgReasonNotAttentionNameSpanishValidation") %>" style="display:none; float: right;margin-right: 6px;margin-top: -23px;position: relative;z-index: 2;">!</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtReasonNotAttentionNameEnglish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblReasonNotAttentionNameEnglish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtReasonNotAttentionNameEnglish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" MaxLength="150" TextMode="SingleLine" autocomplete="off"></asp:TextBox>
                                        <label id="txtReasonNotAttentionNameEnglishValidation" for="<%= txtReasonNotAttentionNameEnglish.ClientID%>" class="label label-danger label-validation" data-toggle="tooltip" data-container="body" data-placement="left" data-content="<%= GetLocalResourceObject("msgReasonNotAttentionNameEnglishValidation") %>" style="display:none; float: right;margin-right: 6px;margin-top: -23px;position: relative;z-index: 2;">!</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtDuplicatedReasonNotAttentionNameSpanish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblReasonNotAttentionNameSpanish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtDuplicatedReasonNotAttentionNameSpanish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,150);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" MaxLength="150" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>                                        
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtDuplicatedReasonNotAttentionNameEnglish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblReasonNotAttentionNameEnglish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtDuplicatedReasonNotAttentionNameEnglish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,150);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" MaxLength="150" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>                                        
                                    </div>
                                </div>                                       
                                </asp:panel>
                            </div>
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">                                                                
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtActivateDeletedReasonNotAttentionNameSpanish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblReasonNotAttentionNameSpanish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtActivateDeletedReasonNotAttentionNameSpanish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,150);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" MaxLength="150" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>                                        
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtActivateDeletedReasonNotAttentionNameEnglish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblReasonNotAttentionNameEnglish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtActivateDeletedReasonNotAttentionNameEnglish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,150);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" MaxLength="150" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>                                        
                                    </div>
                                </div>
                            </div>                            
                        </div>
    ...
    <script type="text/javascript">
        ...
        function pageLoad(sender, args) {
            ...
            $('#btnActivateDeletedCancel, #btnActivateDeletedClose').on('click', function (event) {
                /// <summary>Handles the click event for button cancel in user dialog.</summary>
                $("#<%=hdfReasonNotAttentionCodeEdit.ClientID%>").val("-1");
                event.preventDefault();                    
                $('#MaintenanceDialog').modal('show');
            ...
            if (validator == null) {
                ...
                validator =
                    $('#' + document.forms[0].id).validate({
                        ...
                        rules: {                                                        
                            <%= txtReasonNotAttentionNameSpanish.UniqueID %>: {
                                required: true,
                            ...
                            <%= txtReasonNotAttentionNameEnglish.UniqueID %>: {
                                required: true,
                                normalizer: function(value) {
                                    return $.trim(value);
                                },
        ...
        function ClearModalForm() {
            ...
            $("#<%=hdfReasonNotAttentionCodeEdit.ClientID%>").val("-1");
            $("#<%=txtReasonNotAttentionNameSpanish.ClientID%>").val("");
            $("#<%=txtReasonNotAttentionNameEnglish.ClientID%>").val("");
