<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Jobs.aspx.cs" Inherits="HRISWeb.SocialResponsability.Maintenances.Jobs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntBody" runat="server">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-12 col-md-6">
                                            <div class="col-sm-5 text-left">
                                                <label for="<%= DescriptionFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("DescriptionLbl")%></label>
                                            </div>

                                            <div class="col-sm-7">
                                                <asp:TextBox ID="DescriptionFilter" CssClass="form-control control-validation cleanPasteText ignoreValidation" runat="server" onkeypress="blockEnterKey(); return isNumberOrLetter(event)" MaxLength="50" autocomplete="off" type="text"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12 text-center">
                                ...
                                <div>
                                    <asp:GridView ID="grvList"
                                        ...
                                        DataKeyNames="EmployeeWorksCode"
                                        ...
                                        <Columns>
                                            <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                                <HeaderTemplate>
                                                    <div style="width: 100%; text-align: center;">
                                                        <asp:LinkButton ID="EmployeeWorksDescriptionSort" runat="server" CommandName="Sort" CommandArgument="EmployeeWorksDescription" OnClientClick="SetWaitingGrvList(true);">          
                                                            <span><%= GetLocalResourceObject("DescriptionLbl") %></span>&nbsp;
                                                            <i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "EmployeeWorksDescription") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                                                        </asp:LinkButton>
                                                    </div>
                                                </HeaderTemplate>

                                                <ItemTemplate>
                                                    <span id="dvEmployeeWorksDescription" data-id="EmployeeWorksDescription" data-value="<%# Eval("EmployeeWorksDescription") %>"><%# Eval("EmployeeWorksDescription") %></span>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                                ...
                                                <ItemTemplate>
                                                    <span id="dvSearchEnabled" data-id="SearchEnabled" aria-hidden="true" data-value="<%# Eval("SearchEnabled") %>" class="fa <%# ((DOLE.HRIS.Shared.Entity.EmployeeWorksEntity)Container.DataItem).SearchEnabled ? "fa-check-circle" : "fa-times-circle" %> "></span>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
                ...
                <asp:UpdatePanel runat="server" ID="uppDialogControl">
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                <asp:HiddenField ID="hdfEmployeeWorksCode" runat="server" Value="" />

                                <div class="form-group">
                                    <div class="col-sm-2 text-left">
                                        <label for="<%=EmployeeWorksDescriptionEdit.ClientID%>" class="control-label"><%=GetLocalResourceObject("DescriptionLbl")%></label>
                                    </div>

                                    <div class="col-sm-10">
                                        <input type="text" name="EmployeeWorksDescriptionEdit" id="EmployeeWorksDescriptionEdit" runat="server" class="form-control limpiarCampos cleanPasteText" onkeypress="return isNumberOrLetter(event);" onkeyup="return isNumberOrLetter(event);" maxlength="500" value="" required />
                                        <label id="EmployeeWorksDescriptionEditValidation" for="<%= EmployeeWorksDescriptionEdit.ClientID%>" class="label label-danger label-validation"
                                            data-toggle="tooltip" data-container="body" data-placement="left"
                                            data-content="<%= GetLocalResourceObject("msjEmployeeWorksDescriptionEditValidation") %>"
                        ...
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <asp:Panel ID="pnlDuplicatedDialogDataDetail" runat="server">
                                    <div class="form-group">
                                        <div class="col-sm-4 text-left">
                                            <label for="<%= txtDuplicatedEmployeeWorksDescription.ClientID%>" class="control-label"><%=GetLocalResourceObject("DescriptionLbl")%></label>
                                        </div>

                                        <div class="col-sm-8">
                                            <asp:TextBox ID="txtDuplicatedEmployeeWorksDescription" CssClass="form-control cleanPasteText ignoreValidation" runat="server" ReadOnly="true"></asp:TextBox>
                                        </div>
                                    </div>
                                </asp:Panel>
                            </div>
    ...
    <script type="text/javascript">
        ...
        var validator = null;
        var EmployeeWorksDescriptionEdit;
        var SearchEnabledEdit;
        ...
        function pageLoad(sender, args) {
            ...
            EmployeeWorksDescriptionEdit = $("#<%=EmployeeWorksDescriptionEdit.ClientID %>");
            SearchEnabledEdit = $("#<%=SearchEnabledEdit.ClientID%>");
            //////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            $('#<%= DescriptionFilter.ClientID %>').on('keyup keypress', function (e) {
        ...
        function ValidateForm() {
            ...
            validator = $('#' + document.forms[0].id).validate({
                ...
                rules: {
                    "<%= EmployeeWorksDescriptionEdit.UniqueID%>": {
                        required: true,
        ...
        function ClearModalForm() {
            ...
            $("#<%=hdfEmployeeWorksCode.ClientID%>").val("-1");
