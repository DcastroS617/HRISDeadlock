<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Labor.aspx.cs" Inherits="HRISWeb.SocialResponsability.Maintenances.Labor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntBody" runat="server">
                                    ...
                                    <asp:GridView ID="grvList"
                                        ...
                                        <Columns>
                                            <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                                <HeaderTemplate>
                                                    <div style="width: 100%; text-align: center;">
                                                        <asp:LinkButton ID="EmployeeTaskDescriptionSort" runat="server" CommandName="Sort" CommandArgument="EmployeeTaskDescription" OnClientClick="SetWaitingGrvList(true);">
                                                            <span><%= GetLocalResourceObject("DescriptionLbl") %></span>&nbsp;
                                                            <i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "EmployeeTaskDescription") %> sorterDirection' aria-hidden="true" style="float: right; margin-right: -6px; margin-top: 4px; position: relative; z-index: 2;"></i>
                                                        </asp:LinkButton>
                                                    </div>
                                                </HeaderTemplate>

                                                <ItemTemplate>
                                                    <span id="dvEmployeeTaskDescription" data-id="EmployeeTaskDescription" data-value="<%# Eval("EmployeeTaskDescription") %>"><%# Eval("EmployeeTaskDescription") %></span>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                                ...
                                                <ItemTemplate>
                                                    <span id="dvSearchEnabled" data-id="SearchEnabled" aria-hidden="true" data-value="<%# Eval("SearchEnabled") %>" class="fa <%# ((DOLE.HRIS.Shared.Entity.EmployeeTaskEntity)Container.DataItem).SearchEnabled ? "fa-check-circle" : "fa-times-circle" %> "></span>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
                ...
                <asp:UpdatePanel runat="server" ID="uppDialogControl">
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                <asp:HiddenField ID="hdfEmployeeTaskCode" runat="server" Value="" />

                                <div class="form-group">
                                    <div class="col-sm-2 text-left">
                                        <label for="<%=EmployeeTaskDescriptionEdit.ClientID%>" class="control-label"><%=GetLocalResourceObject("DescriptionLbl")%></label>
                                    </div>

                                    <div class="col-sm-10">
                                        <input type="text" name="EmployeeTaskDescriptionEdit" id="EmployeeTaskDescriptionEdit" runat="server" class="form-control limpiarCampos cleanPasteText" onkeypress="return isNumberOrLetter(event);" onkeyup="return isNumberOrLetter(event);" maxlength="500" value="" required />
                                        <label id="EmployeeWorksDescriptionEditValidation" for="<%= EmployeeTaskDescriptionEdit.ClientID%>" class="label label-danger label-validation"
                        ...
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <asp:Panel ID="pnlDuplicatedDialogDataDetail" runat="server">
                                    <div class="form-group">
                                        <div class="col-sm-4 text-left">
                                            <label for="<%= txtDuplicatedEmployeeTaskDescription.ClientID%>" class="control-label"><%=GetLocalResourceObject("DescriptionLbl")%></label>
                                        </div>

                                        <div class="col-sm-8">
                                            <asp:TextBox ID="txtDuplicatedEmployeeTaskDescription" CssClass="form-control cleanPasteText ignoreValidation" runat="server" ReadOnly="true"></asp:TextBox>
                                        </div>
                                    </div>
                                </asp:Panel>
                            </div>
    ...
    <script type="text/javascript">
        ...
        var validator = null;
        var EmployeeTaskDescriptionEdit;
        ...
        function pageLoad(sender, args) {
            ...
            EmployeeTaskDescriptionEdit = $("#<%=EmployeeTaskDescriptionEdit.ClientID %>");
        ...
        function ValidateForm() {
            ...
            validator = $('#' + document.forms[0].id).validate({
                ...
                rules: {
                    "<%= EmployeeTaskDescriptionEdit.UniqueID%>": {
                        required: true,
        ...
        function ClearModalForm() {
            ...
            $("#<%=hdfEmployeeTaskCode.ClientID%>").val("-1");
