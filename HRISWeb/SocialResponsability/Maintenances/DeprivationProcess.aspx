<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DeprivationProcess.aspx.cs" Inherits="HRISWeb.SocialResponsability.Maintenances.DeprivationProcess" %>
                                ...
                                <div class="form-group">
                                    <div class="form-group col-sm-12 col-md-8 ES">
                                        <div class="col-sm-5 text-left">
                                            <label for="<%= txtDeprivationProcessDesSpanishFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDeprivationProcessName")%></label>
                                        </div>

                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtDeprivationProcessDesSpanishFilter" CssClass="form-control control-validation cleanPasteText ignoreValidation" runat="server" onkeypress="blockEnterKey(); return isNumberOrLetter(event)" MaxLength="50" autocomplete="off" type="text"></asp:TextBox>
                                        </div>
                                    </div>

                                    <div class="form-group col-sm-12 col-md-8 EN">
                                        <div class="col-sm-5 text-left">
                                            <label for="<%= txtDeprivationProcessDesEnglishFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDeprivationProcessName")%></label>
                                        </div>

                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtDeprivationProcessDesEnglishFilter" CssClass="form-control control-validation cleanPasteText ignoreValidation" runat="server" onkeypress="blockEnterKey(); return isNumberOrLetter(event)" MaxLength="50" autocomplete="off" type="text"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div>
                                <asp:GridView ID="grvList"
                                    ...
                                    DataKeyNames="DeprivationProcessCode"
                                    ...
                                    <Columns>
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle hidden" HeaderStyle-CssClass="hidden" FooterStyle-CssClass="hidden">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="DeprivationProcessCodeSort" runat="server" CommandName="Sort" CommandArgument="DeprivationProcessCode" OnClientClick="SetWaitingGrvList(true);">
                                                        <span><%= GetLocalResourceObject("DeprivationProcessCode.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "DeprivationProcessCode") %> sorterDirection' aria-hidden="true" style="float: right; margin-right: -6px; margin-top: 4px; position: relative; z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>

                                            <ItemTemplate>
                                                <span id="dvDeprivationProcessCode" data-id="DeprivationProcesscode" data-value="<%# Eval("DeprivationProcessCode") %>"><%# Eval("DeprivationProcessCode") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="DeprivationProcessDesEnglishSort" runat="server" CommandName="Sort" CommandArgument="DeprivationProcessDesEnglish" OnClientClick="SetWaitingGrvList(true);">
                                                        <span><%= GetLocalResourceObject("lblDeprivationProcessName") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "DeprivationProcessDesEnglish") %> sorterDirection' aria-hidden="true" style="float: right; margin-right: -6px; margin-top: 4px; position: relative; z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>

                                            <ItemTemplate>
                                                <span id="dvDeprivationProcessDesEnglish" data-id="DeprivationProcessDesEnglish" data-value="<%# Eval("DeprivationProcessDesEnglish") %>"><%# Eval("DeprivationProcessDesEnglish")%></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="DeprivationProcessDesSpanishSort" runat="server" CommandName="Sort" CommandArgument="DeprivationProcessDesSpanish" OnClientClick="SetWaitingGrvList(true);">
                                                        <span><%= GetLocalResourceObject("lblDeprivationProcessName") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "DeprivationProcessDesSpanish") %> sorterDirection' aria-hidden="true" style="float: right; margin-right: -6px; margin-top: 4px; position: relative; z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>

                                            <ItemTemplate>
                                                <span id="dvDeprivationProcessDesSpanish" data-id="DeprivationProcessDesSpanish" data-value="<%# Eval("DeprivationProcessDesSpanish") %>"><%# Eval("DeprivationProcessDesSpanish")%></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            ...
                                            <ItemTemplate>
                                                <span id="dvSearchEnabled" data-id="SearchEnabled" aria-hidden="true" data-value="<%# Eval("SearchEnabled") %>" class="fa <%# ((DOLE.HRIS.Shared.Entity.DeprivationProcessEntity)Container.DataItem).SearchEnabled ? "fa-check-circle" : "fa-times-circle" %> "></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                ...
                <asp:UpdatePanel runat="server" ID="uppDialogControl">
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                <asp:HiddenField ID="hdfDeprivationProcessCodeEdit" runat="server" Value="" />

                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtDeprivationProcessDesSpanish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDeprivationProcessDesSpanish")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtDeprivationProcessDesSpanish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" MaxLength="50" TextMode="SingleLine" autocomplete="off"></asp:TextBox>
                                        <label id="txtDeprivationProcessDesSpanishValidation" for="<%= txtDeprivationProcessDesSpanish.ClientID%>" class="label label-danger label-validation" data-toggle="tooltip" data-container="body" data-placement="left" data-content="<%= GetLocalResourceObject("msgDeprivationProcessDesSpanishValidation") %>" style="display: none; float: right; margin-right: 6px; margin-top: -23px; position: relative; z-index: 2;">!</label>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtDeprivationProcessDesEnglish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDeprivationProcessDesEnglish")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtDeprivationProcessDesEnglish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" MaxLength="50" TextMode="SingleLine" autocomplete="off"></asp:TextBox>
                                        <label id="txtDeprivationProcessDesEnglishValidation" for="<%= txtDeprivationProcessDesEnglish.ClientID%>" class="label label-danger label-validation" data-toggle="tooltip" data-container="body" data-placement="left" data-content="<%= GetLocalResourceObject("msgDeprivationProcessDesEnglishValidation") %>" style="display: none; float: right; margin-right: 6px; margin-top: -23px; position: relative; z-index: 2;">!</label>
                                    </div>
                                </div>
                        ...
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <asp:Panel ID="pnlDuplicatedDialogDataDetail" runat="server">
                                    <div class="form-group">
                                        <div class="col-sm-4 text-left">
                                            <label for="<%= txtDuplicatedDeprivationProcessDesSpanish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDeprivationProcessDesSpanish")%></label>
                                        </div>

                                        <div class="col-sm-8">
                                            <asp:TextBox ID="txtDuplicatedDeprivationProcessDesSpanish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,50);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" MaxLength="50" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <div class="col-sm-4 text-left">
                                            <label for="<%= txtDuplicatedDeprivationProcessDesEnglish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDeprivationProcessDesEnglish")%></label>
                                        </div>

                                        <div class="col-sm-8">
                                            <asp:TextBox ID="txtDuplicatedDeprivationProcessDesEnglish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,50);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" MaxLength="50" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>
                                        </div>
                                    </div>
                                </asp:Panel>
                            </div>
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtActivateDeletedDeprivationProcessDesSpanish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDeprivationProcessDesSpanish")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtActivateDeletedDeprivationProcessDesSpanish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,50);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" MaxLength="50" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtActivateDeletedDeprivationProcessDesEnglish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDeprivationProcessDesEnglish")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtActivateDeletedDeprivationProcessDesEnglish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,50);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" MaxLength="50" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function pageLoad(sender, args) {
            ...
            $('#btnActivateDeletedCancel, #btnActivateDeletedClose').on('click', function (event) {
                /// <summary>Handles the click event for button cancel in user dialog.</summary>
                $("#<%=hdfDeprivationProcessCodeEdit.ClientID%>").val("-1");
                event.preventDefault();
            ...
            $('#<%= txtDeprivationProcessDesSpanishFilter.ClientID %>').on('keyup keypress', function (e) {
                ReturnFromBtnSearchClickPostBack(e);

                return isNumberOrLetter(e);
            });

            $('#<%= txtDeprivationProcessDesEnglishFilter.ClientID %>').on('keyup keypress', function (e) {
                ReturnFromBtnSearchClickPostBack(e);
            ...
            if (validator == null) {
                ...
                validator =
                    $('#' + document.forms[0].id).validate({
                        ...
                        rules: {
                            "<%= txtDeprivationProcessDesSpanish.UniqueID %>": {
                                required: true,
                           ...
                           "<%= txtDeprivationProcessDesEnglish.UniqueID %>": {
                                required: true,
                                normalizer: function (value) {
                                    return $.trim(value);
                                },
        ...
        function ClearModalForm() {
            ...
            $("#<%=hdfDeprivationProcessCodeEdit.ClientID%>").val("-1");
            $("#<%=txtDeprivationProcessDesSpanish.ClientID%>").val("");
            $("#<%=txtDeprivationProcessDesEnglish.ClientID%>").val("");
