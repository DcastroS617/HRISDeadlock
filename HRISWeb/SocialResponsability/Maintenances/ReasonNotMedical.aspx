<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ReasonNotMedical.aspx.cs" Inherits="HRISWeb.SocialResponsability.Maintenances.ReasonNotMedical" %>
                                ...
                                <div class="form-group">
                                    <div class="form-group col-sm-12 col-md-8 ES">
                                        <div class="col-sm-5 text-left">
                                            <label for="<%= txtReasonNotMedicalNameSpanishFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblReasonNotMedicalName")%></label>
                                        </div>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtReasonNotMedicalNameSpanishFilter" CssClass="form-control control-validation cleanPasteText ignoreValidation" runat="server" onkeypress="blockEnterKey(); return isNumberOrLetter(event)" MaxLength="150" autocomplete="off" type="text"></asp:TextBox>
                                        </div>
                                     </div>
                                    <div class="form-group col-sm-12 col-md-8 EN">
                                        <div class="col-sm-5 text-left">
                                            <label for="<%= txtReasonNotMedicalNameEnglishFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblReasonNotMedicalName")%></label>
                                        </div>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtReasonNotMedicalNameEnglishFilter" CssClass="form-control control-validation cleanPasteText ignoreValidation" runat="server" onkeypress="blockEnterKey(); return isNumberOrLetter(event)" MaxLength="150" autocomplete="off" type="text"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div>
                                <asp:GridView ID="grvList" Width="100%" runat="server" EmptyDataText='<%$ Code:GetLocalResourceObject("lblNoData") %>' 
                                    ...
                                    DataKeyNames="ReasonNotMedicalCode" OnPreRender="grvList_PreRender" OnSorting="grvList_Sorting" OnRowDataBound="GrvList_RowDataBound">                             
                                    <Columns>                                        
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle hidden" HeaderStyle-CssClass="hidden" FooterStyle-CssClass="hidden" >
                                            <HeaderTemplate>
                                                <div style="width:100%; text-align:center;">
                                                    <asp:LinkButton ID="ReasonNotMedicalCodeSort" runat="server" CommandName="Sort" CommandArgument="ReasonNotMedicalCode" OnClientClick="SetWaitingGrvList(true);">          
                                                        <span><%= GetLocalResourceObject("ReasonNotMedicalCode.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "ReasonNotMedicalCode") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvReasonNotMedicalCode" data-id="ReasonNotMedicalcode" data-value="<%# Eval("ReasonNotMedicalCode") %>"><%# Eval("ReasonNotMedicalCode") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField> 
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" >
                                            <HeaderTemplate>
                                                <div style="width:100%; text-align:center;">
                                                    <asp:LinkButton ID="ReasonNotMedicalNameEnglishSort" runat="server" CommandName="Sort" CommandArgument="ReasonNotMedicalNameEnglish" OnClientClick="SetWaitingGrvList(true);">          
                                                        <span><%= GetLocalResourceObject("ReasonNotMedicalNameEN.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "ReasonNotMedicalNameEnglish") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvReasonNotMedicalNameEnglish" data-id="ReasonNotMedicalnameenglish" data-value="<%# Eval("ReasonNotMedicalDescriptionEnglish") %>"><%# Eval("ReasonNotMedicalDescriptionEnglish")%></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>  
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" >
                                            <HeaderTemplate>
                                                <div style="width:100%; text-align:center;">
                                                    <asp:LinkButton ID="ReasonNotMedicalNameSpanishSort" runat="server" CommandName="Sort" CommandArgument="ReasonNotMedicalNameSpanish" OnClientClick="SetWaitingGrvList(true);">          
                                                        <span><%= GetLocalResourceObject("ReasonNotMedicalNameES.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "ReasonNotMedicalNameSpanish") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvReasonNotMedicalNameSpanish" data-id="ReasonNotMedicalnamespanish" data-value="<%# Eval("ReasonNotMedicalDescriptionSpanish") %>"><%# Eval("ReasonNotMedicalDescriptionSpanish")%></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>   
                                    </Columns>
                                </asp:GridView>           
                ...
                <asp:UpdatePanel runat="server" ID="uppDialogControl">
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                <asp:HiddenField ID="hdfReasonNotMedicalCodeEdit" runat="server" Value="" />
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtReasonNotMedicalNameSpanish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblReasonNotMedicalNameSpanish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtReasonNotMedicalNameSpanish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" MaxLength="150" TextMode="SingleLine" autocomplete="off"></asp:TextBox>
                                        <label id="txtReasonNotMedicalNameSpanishValidation" for="<%= txtReasonNotMedicalNameSpanish.ClientID%>" class="label label-danger label-validation" data-toggle="tooltip" data-container="body" data-placement="left" data-content="<%= GetLocalResourceObject("msgReasonNotMedicalNameSpanishValidation") %>" style="display:none; float: right;margin-right: 6px;margin-top: -23px;position: relative;z-index: 2;">!</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtReasonNotMedicalNameEnglish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblReasonNotMedicalNameEnglish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtReasonNotMedicalNameEnglish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" MaxLength="150" TextMode="SingleLine" autocomplete="off"></asp:TextBox>
                                        <label id="txtReasonNotMedicalNameEnglishValidation" for="<%= txtReasonNotMedicalNameEnglish.ClientID%>" class="label label-danger label-validation" data-toggle="tooltip" data-container="body" data-placement="left" data-content="<%= GetLocalResourceObject("msgReasonNotMedicalNameEnglishValidation") %>" style="display:none; float: right;margin-right: 6px;margin-top: -23px;position: relative;z-index: 2;">!</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtDuplicatedReasonNotMedicalNameSpanish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblReasonNotMedicalNameSpanish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtDuplicatedReasonNotMedicalNameSpanish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,150);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" MaxLength="150" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>                                        
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtDuplicatedReasonNotMedicalNameEnglish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblReasonNotMedicalNameEnglish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtDuplicatedReasonNotMedicalNameEnglish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,150);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" MaxLength="150" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>                                        
                                    </div>
                                </div>                                       
                                </asp:panel>
                            </div>
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">                                                                
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtActivateDeletedReasonNotMedicalNameSpanish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblReasonNotMedicalNameSpanish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtActivateDeletedReasonNotMedicalNameSpanish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,150);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" MaxLength="150" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>                                        
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtActivateDeletedReasonNotMedicalNameEnglish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblReasonNotMedicalNameEnglish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtActivateDeletedReasonNotMedicalNameEnglish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,150);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" MaxLength="150" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>                                        
                                    </div>
                                </div>
                            </div>                            
                        </div>
    ...
    <script type="text/javascript">
        ...
        function pageLoad(sender, args) {
            ...
            $('#btnActivateDeletedCancel, #btnActivateDeletedClose').on('click', function (event) {
                /// <summary>Handles the click event for button cancel in user dialog.</summary>
                $("#<%=hdfReasonNotMedicalCodeEdit.ClientID%>").val("-1");
                event.preventDefault();                    
                $('#MaintenanceDialog').modal('show');
            ...
            if (validator == null) {
                ...
                validator =
                    $('#' + document.forms[0].id).validate({
                        ...
                        rules: {                                                        
                            <%= txtReasonNotMedicalNameSpanish.UniqueID %>: {
                                required: true,
                            ...
                            <%= txtReasonNotMedicalNameEnglish.UniqueID %>: {
                                required: true,
                                normalizer: function(value) {
                                    return $.trim(value);
                                },
        ...
        function ClearModalForm() {
            ...
            $("#<%=hdfReasonNotMedicalCodeEdit.ClientID%>").val("-1");
            $("#<%=txtReasonNotMedicalNameSpanish.ClientID%>").val("");
            $("#<%=txtReasonNotMedicalNameEnglish.ClientID%>").val("");
