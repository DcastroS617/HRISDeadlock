<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Transports.aspx.cs" Inherits="HRISWeb.SocialResponsability.Maintenances.Transports" %>
                ...
                <div class="container" style="width: 100%">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-12 col-md-8 EN">
                                            <div class="col-sm-5 text-left">
                                                <label for="<%= txtTransportDescriptionEnglishFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTransportDescription")%></label>
                                            </div>

                                            <div class="col-sm-7">
                                                <asp:TextBox ID="txtTransportDescriptionEnglishFilter" CssClass="form-control control-validation cleanPasteText ignoreValidation" runat="server" onkeypress="blockEnterKey(); return isNumberOrLetter(event)" MaxLength="50" autocomplete="off" type="text"></asp:TextBox>
                                            </div>
                                        </div>
                                        
                                        <div class="form-group col-sm-12 col-md-8 ES">
                                            <div class="col-sm-5 text-left">
                                                <label for="<%= txtTransportDescriptionSpanishFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTransportDescription")%></label>
                                            </div>

                                            <div class="col-sm-7">
                                                <asp:TextBox ID="txtTransportDescriptionSpanishFilter" CssClass="form-control control-validation cleanPasteText ignoreValidation" runat="server" onkeypress="blockEnterKey(); return isNumberOrLetter(event)" MaxLength="50" autocomplete="off" type="text"></asp:TextBox>
                                            </div>
                                        </div>

                                        <div class="form-group col-sm-12 col-md-4">
                                            <div class="col-sm-5 text-left">
                                               <label for="<%= cboTransportTypeFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("cboTransportType")%></label>
                                            </div>

                                            <div class="col-sm-7">
                                              <asp:DropDownList ID="cboTransportTypeFilter" CssClass="form-control control-validation ignoreValidation" AutoPostBack="false" runat="server"></asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-center">
                            <button id="btnSearch" type="button" runat="server" class="btn btn-default btnAjaxAction" onserverclick="BtnSearch_ServerClick" 
                                ...
                                <asp:GridView ID="grvList" 
                                    ...
                                    <Columns>
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle hidden" HeaderStyle-CssClass="hidden" FooterStyle-CssClass="hidden">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="TransportCodeSort" runat="server" CommandName="Sort" CommandArgument="TransportCode" OnClientClick="SetWaitingGrvList(true);">          
                                                        <span><%= GetLocalResourceObject("TransportCode.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "TransportCode") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>

                                            <ItemTemplate>
                                                <span id="dvTransportCode" data-id="transportcode" data-value="<%# Eval("TransportCode") %>"><%# Eval("TransportCode") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="TransportDescriptionEnglishSort" runat="server" CommandName="Sort" CommandArgument="TransportDescriptionEnglish" OnClientClick="SetWaitingGrvList(true);">          
                                                        <span><%= GetLocalResourceObject("TransportDescriptionEN.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "TransportDescriptionEnglish") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>

                                            <ItemTemplate>
                                                <span id="dvTransportDescriptionEnglish" data-id="transportdescriptionenglish" data-value="<%# Eval("TransportDescriptionEnglish") %>"><%# Eval("TransportDescriptionEnglish")%></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="TransportDescriptionSpanishSort" runat="server" CommandName="Sort" CommandArgument="TransportDescriptionSpanish" OnClientClick="SetWaitingGrvList(true);">          
                                                        <span><%= GetLocalResourceObject("TransportDescriptionES.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "TransportDescriptionSpanish") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>

                                            <ItemTemplate>
                                                <span id="dvTransportDescriptionSpanish" data-id="transportdescriptionspanish" data-value="<%# Eval("TransportDescriptionSpanish") %>"><%# Eval("TransportDescriptionSpanish")%></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="TransportTypeDescriptionSort" runat="server" CommandName="Sort" CommandArgument="TransportTypeDescription" OnClientClick="SetWaitingGrvList(true);">          
                                                        <span><%= GetLocalResourceObject("TransportType.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "TransportTypeDescription") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>

                                            <ItemTemplate>
                                                <span id="dvTransportTypeDescription" data-id="transporttypedescription" data-value="<%# Eval("TransportTypeDescription") %>"><%# Eval("TransportTypeDescription")%></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
            ...
            <asp:UpdatePanel ID="uppActions" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                ...
                <ContentTemplate>
                    <div class="btn-group" role="group" aria-label="main-buttons">
                        ...
                        <button id="btnEdit" type="button" runat="server" class="btn btn-default btnAjaxAction btnClick" 
                ...
                <asp:UpdatePanel runat="server" ID="uppDialogControl">
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                <asp:HiddenField ID="hdfTransportCodeEdit" runat="server" Value="" />
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtTransportDescriptionSpanish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTransportDescriptionSpanish")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtTransportDescriptionSpanish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" MaxLength="50" TextMode="SingleLine" autocomplete="off"></asp:TextBox>
                                        <label id="txtTransportDescriptionSpanishValidation" for="<%= txtTransportDescriptionSpanish.ClientID%>" class="label label-danger label-validation" data-toggle="tooltip" data-container="body" data-placement="left" data-content="<%= GetLocalResourceObject("msgTransportDescriptionSpanishValidation") %>" style="display: none; float: right; margin-right: 6px; margin-top: -23px; position: relative; z-index: 2;">!</label>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtTransportDescriptionEnglish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTransportDescriptionEnglish")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtTransportDescriptionEnglish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" MaxLength="50" TextMode="SingleLine" autocomplete="off"></asp:TextBox>
                                        <label id="txtTransportDescriptionEnglishValidation" for="<%= txtTransportDescriptionEnglish.ClientID%>" class="label label-danger label-validation" data-toggle="tooltip" data-container="body" data-placement="left" data-content="<%= GetLocalResourceObject("msgTransportDescriptionEnglishValidation") %>" style="display: none; float: right; margin-right: 6px; margin-top: -23px; position: relative; z-index: 2;">!</label>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= cboTransportType.ClientID%>" class="control-label"><%=GetLocalResourceObject("cboTransportType")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:DropDownList ID="cboTransportType" CssClass="form-control control-validation" AutoPostBack="false" runat="server"></asp:DropDownList>
                                        <label id="cboTransportTypeValidation" for="<%= cboTransportType.ClientID%>" class="label label-danger label-validation" data-toggle="tooltip" data-container="body" data-placement="left" data-content="<%= GetLocalResourceObject("msgTransportTypeValidation") %>" style="display: none; float: right; margin-right: 6px; margin-top: -23px; position: relative; z-index: 2;">!</label>
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer">
                            <button id="btnAccept" type="button" runat="server" class="btn btn-primary btnAjaxAction btns" 
                            ...
                            <button id="btnCancel" type="button" class="btn btn-default btns">
                        ...
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <asp:Panel ID="pnlDuplicatedDialogDataDetail" runat="server">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4 text-left">
                                            <label for="<%= txtDuplicatedTransportDescriptionSpanish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTransportDescriptionSpanish")%></label>
                                        </div>

                                        <div class="col-sm-8">
                                            <asp:TextBox ID="txtDuplicatedTransportDescriptionSpanish" CssClass="form-control cleanPasteText ignoreValidation" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,50);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" MaxLength="50" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <div class="col-sm-4 text-left">
                                            <label for="<%= txtDuplicatedTransportDescriptionEnglish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTransportDescriptionEnglish")%></label>
                                        </div>

                                        <div class="col-sm-8">
                                            <asp:TextBox ID="txtDuplicatedTransportDescriptionEnglish" CssClass="form-control cleanPasteText ignoreValidation" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,50);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" MaxLength="50" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <div class="col-sm-4 text-left">
                                            <label for="<%= cboDuplicatedTransportType.ClientID%>" class="control-label"><%=GetLocalResourceObject("cboTransportType")%></label>
                                        </div>

                                        <div class="col-sm-8">
                                            <asp:DropDownList ID="cboDuplicatedTransportType" CssClass="form-control cboAjaxAction control-validation ignoreValidation" AutoPostBack="false" runat="server" Enabled="false"></asp:DropDownList>
                                        </div>
                                    </div>
                                </asp:Panel>
                            </div>
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtActivateDeletedTransportDescriptionSpanish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTransportDescriptionSpanish")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtActivateDeletedTransportDescriptionSpanish" CssClass="form-control cleanPasteText ignoreValidation" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,50);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" MaxLength="50" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtActivateDeletedTransportDescriptionEnglish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTransportDescriptionEnglish")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtActivateDeletedTransportDescriptionEnglish" CssClass="form-control cleanPasteText ignoreValidation" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,50);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" MaxLength="50" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= cboActivateDeletedTransportType.ClientID%>" class="control-label"><%=GetLocalResourceObject("cboTransportType")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:DropDownList ID="cboActivateDeletedTransportType" CssClass="form-control cboAjaxAction control-validation ignoreValidation" AutoPostBack="false" runat="server" Enabled="false"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function pageLoad(sender, args) {
            ...
            $('#btnActivateDeletedCancel, #btnActivateDeletedClose').on('click', function (event) {
                /// <summary>Handles the click event for button cancel in user dialog.</summary>
                $("#<%=hdfTransportCodeEdit.ClientID%>").val("-1");
                event.preventDefault();
            ...
            $('#<%= txtTransportDescriptionEnglishFilter.ClientID %>').on('keyup keypress', function (e) {
                ReturnFromBtnSearchClickPostBack(e);

                return isNumberOrLetter(e);
            });

            $('#<%= txtTransportDescriptionSpanishFilter.ClientID %>').on('keyup keypress', function (e) {
                ReturnFromBtnSearchClickPostBack(e);
            ...
            if (validator == null) {
                ...
                validator =
                    $('#' + document.forms[0].id).validate({
                        ...
                        rules: {
                            "<%= txtTransportDescriptionSpanish.UniqueID %>": {
                                required: true,
                            ...
                            "<%= txtTransportDescriptionEnglish.UniqueID %>": {
                                required: true,
                                normalizer: function (value) {
                                    return $.trim(value);
                                },
        ...
        function ClearModalForm() {
            ...
            $("#<%=hdfTransportCodeEdit.ClientID%>").val("-1");
            $("#<%=txtTransportDescriptionSpanish.ClientID%>").val("");
            $("#<%=txtTransportDescriptionEnglish.ClientID%>").val("");
            $("#<%=cboTransportType.ClientID%>").val("-1");
        ...
        function ProcessEditRequest(resetId) {
            ...
            /// <param name="resetId" type="String">Id of the button to reset if not request proceed</param>  btnAjaxAction 
            disableButton($('.btnAjaxAction'));
