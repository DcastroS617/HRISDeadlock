...
{
    public partial class ReasonNotWork : System.Web.UI.Page
    {
        [Dependency]
        ...
        protected void btnActivateDeletedAccept_ServerClick(object sender, EventArgs e)
        {
            try
            {
                short hiddenReasonNotWorkCode = !string.IsNullOrWhiteSpace(hdfReasonNotWorkCodeEdit.Value) ?
                    Convert.ToInt16(hdfReasonNotWorkCodeEdit.Value) : (short)-1;

                string ReasonNotWorkNameSpanish = txtReasonNotWorkNameSpanish.Text.Trim();
                string ReasonNotWorkNameEnglish = txtReasonNotWorkNameEnglish.Text.Trim();
                ...
                {
                    objReasonNotWorkBll.Activate(new ReasonNotWorkEntity(hiddenReasonNotWorkCode, lastModifiedUser));
                }
                //update and activate the deleted item
                else
                {
                    objReasonNotWorkBll.Edit(new ReasonNotWorkEntity(hiddenReasonNotWorkCode
                        , ReasonNotWorkNameSpanish
                        , ReasonNotWorkNameEnglish
                        , searchEnable
                        , deleted
                        , lastModifiedUser));
                }
                ...
                {
                    List<ReasonNotWorkEntity> ReasonNotWorksBDList = objReasonNotWorkBll.ListEnabled();
                    Application.Add(HrisEnum.ApplicationSessionNames.cSocialResponsabilityCatalogReasonNotWorks, ReasonNotWorksBDList);
                }
            }
            catch (Exception ex)
            {
        ...
        protected void btnAccept_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (hiddenReasonNotWorkCode.Equals(-1))
                {
                    Tuple<bool, ReasonNotWorkEntity> addResult = objReasonNotWorkBll.Add(new ReasonNotWorkEntity(ReasonNotWorkNameSpanish
                        , ReasonNotWorkNameEnglish
                        , searchEnable
                        , deleted
                        , lastModifiedUser));

                    hiddenReasonNotWorkCode = addResult.Item2.ReasonNotWorkCode;
                    hdfReasonNotWorkCodeEdit.Value = addResult.Item2.ReasonNotWorkCode.ToString();
                    ...
                    {
                        ReasonNotWorkEntity previousEntity = addResult.Item2;
                        hdfReasonNotWorkCodeEdit.Value = "-1";
                        if (previousEntity.Deleted)
                        {
                            hdfReasonNotWorkCodeEdit.Value = Convert.ToString(hiddenReasonNotWorkCode);
                            txtActivateDeletedReasonNotWorkNameSpanish.Text = previousEntity.ReasonNotWorkDescriptionSpanish;
                            txtActivateDeletedReasonNotWorkNameEnglish.Text = previousEntity.ReasonNotWorkDescriptionEnglish;
                        ...
                        {
                            txtDuplicatedReasonNotWorkNameSpanish.Text = previousEntity.ReasonNotWorkDescriptionSpanish;
                            txtDuplicatedReasonNotWorkNameEnglish.Text = previousEntity.ReasonNotWorkDescriptionEnglish;
                ...
                {
                    var result = objReasonNotWorkBll.Edit(new ReasonNotWorkEntity(hiddenReasonNotWorkCode
                          , ReasonNotWorkNameSpanish
                          , ReasonNotWorkNameEnglish
                          , searchEnable
                          , deleted
                    ...
                    {
                        ReasonNotWorkEntity previousEntity = result.Item2;
                        hdfReasonNotWorkCodeEdit.Value = "-1";
                        if (previousEntity.Deleted)
                        {
                            hdfReasonNotWorkCodeEdit.Value = Convert.ToString(previousEntity.ReasonNotWorkCode);
                            txtActivateDeletedReasonNotWorkNameSpanish.Text = previousEntity.ReasonNotWorkDescriptionSpanish;
                            txtActivateDeletedReasonNotWorkNameEnglish.Text = previousEntity.ReasonNotWorkDescriptionEnglish;
        ...
        protected void btnEdit_ServerClick(object sender, EventArgs e)
        {
            try
            {
                if (hdfSelectedRowIndex.Value != "-1")
                {
                    ...
                    short selectedReasonNotWorkCode = Convert.ToInt16(grvList.DataKeys[Convert.ToInt32(hdfSelectedRowIndex.Value)].Value);

                    ReasonNotWorkEntity entity = objReasonNotWorkBll.ListByKey(selectedReasonNotWorkCode);

                    hdfReasonNotWorkCodeEdit.Value = selectedReasonNotWorkCode.ToString();
                    txtReasonNotWorkNameSpanish.Text = entity.ReasonNotWorkDescriptionSpanish;
                    txtReasonNotWorkNameEnglish.Text = entity.ReasonNotWorkDescriptionEnglish;
        ...
        protected void btnDelete_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    short selectedReasonNotWorkCode = Convert.ToInt16(grvList.DataKeys[Convert.ToInt32(hdfSelectedRowIndex.Value)].Value);
                    objReasonNotWorkBll.Delete(new ReasonNotWorkEntity(selectedReasonNotWorkCode, UserHelper.GetCurrentFullUserName));

                    PageHelper<ReasonNotWorkEntity> pageHelper = SearchResults(PagerUtil.GetActivePage(blstPager));
        ...
        protected void grvList_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            PageHelper<ReasonNotWorkEntity> pageHelper = SearchResults(1);
        ...
        private PageHelper<ReasonNotWorkEntity> SearchResults(int page)
        {
            string ReasonNotWorkNameSpanish = string.IsNullOrWhiteSpace(txtReasonNotWorkNameSpanishFilter.Text.Trim()) ? null : txtReasonNotWorkNameSpanishFilter.Text.Trim();
            string ReasonNotWorkNameEnglish = string.IsNullOrWhiteSpace(txtReasonNotWorkNameEnglishFilter.Text.Trim()) ? null : txtReasonNotWorkNameEnglishFilter.Text.Trim();
            ...
            PageHelper<ReasonNotWorkEntity> pageHelper = objReasonNotWorkBll.ListByFilters(
        ...
        /// </summary>
        private void DisplayResults(PageHelper<ReasonNotWorkEntity> pageHelper)
        {
            if (pageHelper != null)
            {
