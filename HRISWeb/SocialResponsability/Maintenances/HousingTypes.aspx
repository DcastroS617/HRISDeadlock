<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="HousingTypes.aspx.cs" Inherits="HRISWeb.SocialResponsability.Maintenances.HousingTypes" %>
                                ...
                                <div class="form-group">
                                    <div class="form-group col-sm-12 col-md-8 ES">
                                        <div class="col-sm-5 text-left">
                                            <label for="<%= txtHousingTypeDescriptionSpanishFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("HousingTypeDescriptionES.HeaderText")%></label>
                                        </div>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtHousingTypeDescriptionSpanishFilter" CssClass="form-control control-validation cleanPasteText ignoreValidation" runat="server" onkeypress="blockEnterKey(); return isNumberOrLetter(event)" MaxLength="50" autocomplete="off" type="text"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group col-sm-12 col-md-8 EN">
                                        <div class="col-sm-5 text-left">
                                            <label for="<%= txtHousingTypeDescriptionEnglishFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("HousingTypeDescriptionEN.HeaderText")%></label>
                                        </div>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtHousingTypeDescriptionEnglishFilter" CssClass="form-control control-validation cleanPasteText ignoreValidation" runat="server" onkeypress="blockEnterKey(); return isNumberOrLetter(event)" MaxLength="50" autocomplete="off" type="text"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div>
                                <asp:GridView ID="grvList" Width="100%" runat="server" EmptyDataText='<%$ Code:GetLocalResourceObject("lblNoData") %>' 
                                    ...
                                    DataKeyNames="HousingTypeCode" OnPreRender="grvList_PreRender" OnSorting="grvList_Sorting"  OnRowDataBound="GrvList_RowDataBound">                             
                                    <Columns>                                        
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle hidden" HeaderStyle-CssClass="hidden" FooterStyle-CssClass="hidden" >
                                            <HeaderTemplate>
                                                <div style="width:100%; text-align:center;">
                                                    <asp:LinkButton ID="HousingTypeCodeSort" runat="server" CommandName="Sort" CommandArgument="HousingTypeCode" OnClientClick="SetWaitingGrvList(true);">          
                                                        <span><%= GetLocalResourceObject("HousingTypeCode.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "HousingTypeCode") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvHousingTypeCode" data-id="housingtypecode" data-value="<%# Eval("HousingTypeCode") %>"><%# Eval("HousingTypeCode") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField> 
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" >
                                            <HeaderTemplate>
                                                <div style="width:100%; text-align:center;">
                                                    <asp:LinkButton ID="HousingTypeDescriptionEnglishSort" runat="server" CommandName="Sort" CommandArgument="HousingTypeDescriptionEnglish" OnClientClick="SetWaitingGrvList(true);">          
                                                        <span><%= GetLocalResourceObject("HousingTypeDescriptionEN.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "HousingTypeDescriptionEnglish") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvHousingTypeDescriptionEnglish" data-id="housingtypedescriptionenglish" data-value="<%# Eval("HousingTypeDescriptionEnglish") %>"><%# Eval("HousingTypeDescriptionEnglish")%></span>
                                            </ItemTemplate>
                                        </asp:TemplateField> 
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" >
                                            <HeaderTemplate>
                                                <div style="width:100%; text-align:center;">
                                                    <asp:LinkButton ID="HousingTypeDescriptionSpanishSort" runat="server" CommandName="Sort" CommandArgument="HousingTypeDescriptionSpanish" OnClientClick="SetWaitingGrvList(true);">          
                                                        <span><%= GetLocalResourceObject("HousingTypeDescriptionES.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "HousingTypeDescriptionSpanish") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvHousingTypeDescriptionSpanish" data-id="housingtypedescriptionspanish" data-value="<%# Eval("HousingTypeDescriptionSpanish") %>"><%# Eval("HousingTypeDescriptionSpanish")%></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>           
                ...
                <asp:UpdatePanel runat="server" ID="uppDialogControl">
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                <asp:HiddenField ID="hdfHousingTypeCodeEdit" runat="server" Value="" />
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtHousingTypeDescriptionSpanish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblHousingTypeDescriptionSpanish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtHousingTypeDescriptionSpanish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" MaxLength="50" TextMode="SingleLine" autocomplete="off"></asp:TextBox>
                                        <label id="txtHousingTypeDescriptionSpanishValidation" for="<%= txtHousingTypeDescriptionSpanish.ClientID%>" class="label label-danger label-validation" data-toggle="tooltip" data-container="body" data-placement="left" data-content="<%= GetLocalResourceObject("msgHousingTypeDescriptionSpanishValidation") %>" style="display:none; float: right;margin-right: 6px;margin-top: -23px;position: relative;z-index: 2;">!</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtHousingTypeDescriptionEnglish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblHousingTypeDescriptionEnglish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtHousingTypeDescriptionEnglish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" MaxLength="50" TextMode="SingleLine" autocomplete="off"></asp:TextBox>
                                        <label id="txtHousingTypeDescriptionEnglishValidation" for="<%= txtHousingTypeDescriptionEnglish.ClientID%>" class="label label-danger label-validation" data-toggle="tooltip" data-container="body" data-placement="left" data-content="<%= GetLocalResourceObject("msgHousingTypeDescriptionEnglishValidation") %>" style="display:none; float: right;margin-right: 6px;margin-top: -23px;position: relative;z-index: 2;">!</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtDuplicatedHousingTypeDescriptionSpanish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblHousingTypeDescriptionSpanish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtDuplicatedHousingTypeDescriptionSpanish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,50);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" MaxLength="50" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>                                        
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtDuplicatedHousingTypeDescriptionEnglish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblHousingTypeDescriptionEnglish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtDuplicatedHousingTypeDescriptionEnglish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,50);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" MaxLength="50" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>                                        
                                    </div>
                                </div>                                       
                                </asp:panel>
                            </div>
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">                                                                
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtActivateDeletedHousingTypeDescriptionSpanish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblHousingTypeDescriptionSpanish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtActivateDeletedHousingTypeDescriptionSpanish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,50);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" MaxLength="50" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>                                        
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtActivateDeletedHousingTypeDescriptionEnglish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblHousingTypeDescriptionEnglish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtActivateDeletedHousingTypeDescriptionEnglish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,50);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,50);" MaxLength="50" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>                                        
                                    </div>
                                </div>
                            </div>                            
                        </div>
    ...
    <script type="text/javascript">
        ...
        function pageLoad(sender, args) {
            ...
            $('#btnActivateDeletedCancel, #btnActivateDeletedClose').on('click', function (event) {
                /// <summary>Handles the click event for button cancel in user dialog.</summary> 
                $("#<%=hdfHousingTypeCodeEdit.ClientID%>").val("0");
                event.preventDefault();                    
                $('#MaintenanceDialog').modal('show');
            ...
            if (validator == null) {
                ...
                validator =
                    $('#' + document.forms[0].id).validate({
                        ...
                        rules: {                                                        
                            <%= txtHousingTypeDescriptionSpanish.UniqueID %>: {
                                required: true,
                            ...
                            <%= txtHousingTypeDescriptionEnglish.UniqueID %>: {
                                required: true,
                                normalizer: function(value) {
                                    return $.trim(value);
                                },
        ...
        function ClearModalForm() {
            ...
            $("#<%=hdfHousingTypeCodeEdit.ClientID%>").val("0");
            $("#<%=txtHousingTypeDescriptionSpanish.ClientID%>").val("");
            $("#<%=txtHousingTypeDescriptionEnglish.ClientID%>").val("");
