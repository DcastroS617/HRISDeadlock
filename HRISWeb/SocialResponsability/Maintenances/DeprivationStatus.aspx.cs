...
{
    public partial class DeprivationStatus : System.Web.UI.Page
    {
        [Dependency]
        protected IDeprivationStatusBLL<DeprivationStatusEntity> objDeprivationStatusBll { get; set; }

        //session key for the results
        readonly string sessionKeySocialResponsabilityResults = "SocialResponsability-DeprivationStatusResults";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    PageHelper<DeprivationStatusEntity> pageHelper = (PageHelper<DeprivationStatusEntity>)Session[sessionKeySocialResponsabilityResults];
        ...
        protected void BtnActivateDeletedAccept_ServerClick(object sender, EventArgs e)
        {
            try
            {
                short hiddenDeprivationStatusCode = !string.IsNullOrWhiteSpace(hdfDeprivationStatusCodeEdit.Value) ?
                    Convert.ToInt16(hdfDeprivationStatusCodeEdit.Value) : (short)-1;

                string DeprivationStatusDesSpanish = txtDeprivationStatusDesSpanish.Text.Trim();
                string DeprivationStatusDesEnglish = txtDeprivationStatusDesEnglish.Text.Trim();
                ...
                {
                    DeprivationStatusEntity dpe = new DeprivationStatusEntity();
                    dpe.DeprivationStatusDesEnglish = DeprivationStatusDesEnglish;
                    dpe.DeprivationStatusDesSpanish = DeprivationStatusDesSpanish;
                    dpe.DeprivationStatusCode = int.Parse(hiddenDeprivationStatusCode.ToString());
                    dpe.LastModifiedUser = lastModifiedUser;
                    objDeprivationStatusBll.Activate(dpe);
                }
                ...
                else
                {
                    ...
                    dpe.Deleted = deleted;
                    dpe.LastModifiedUser = lastModifiedUser;
                    objDeprivationStatusBll.Edit(dpe);
                }
                ...
                /*if (Application[HrisEnum.ApplicationSessionNames.cSocialResponsabilityCatalogDeprivationStatus] != null)
                {
                    List<DeprivationStatusEntity> DeprivationStatusBDList = objDeprivationStatusBll.ListEnabled();
                    Application.Add(HrisEnum.ApplicationSessionNames.cSocialResponsabilityCatalogDeprivationStatus, DeprivationStatusBDList);
                }*/
            }
        ...
        protected void BtnAccept_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (hiddenDeprivationStatusCode.Equals(-1))
                {
                    DeprivationStatusEntity dpe = new DeprivationStatusEntity();
                    dpe.DeprivationStatusDesEnglish = DeprivationStatusDesEnglish;
                    dpe.DeprivationStatusDesSpanish = DeprivationStatusDesSpanish;
                    ...
                    dpe.Deleted = deleted;
                    dpe.LastModifiedUser = lastModifiedUser;
                    Tuple<bool, DeprivationStatusEntity> addResult = objDeprivationStatusBll.Add(dpe);

                    hiddenDeprivationStatusCode = short.Parse(addResult.Item2.DeprivationStatusCode.ToString());
                    hdfDeprivationStatusCodeEdit.Value = addResult.Item2.DeprivationStatusCode.ToString();
                    ...
                    {
                        DeprivationStatusEntity previousEntity = addResult.Item2;
                        hdfDeprivationStatusCodeEdit.Value = "-1";
                        if (previousEntity.Deleted)
                        {
                            hdfDeprivationStatusCodeEdit.Value = Convert.ToString(hiddenDeprivationStatusCode);
                            txtActivateDeletedDeprivationStatusDesSpanish.Text = previousEntity.DeprivationStatusDesSpanish;
                            txtActivateDeletedDeprivationStatusDesEnglish.Text = previousEntity.DeprivationStatusDesEnglish;
                        ...
                        {
                            txtDuplicatedDeprivationStatusDesSpanish.Text = previousEntity.DeprivationStatusDesSpanish;
                            txtDuplicatedDeprivationStatusDesEnglish.Text = previousEntity.DeprivationStatusDesEnglish;
                ...
                {
                    DeprivationStatusEntity dpe = new DeprivationStatusEntity();
                    dpe.DeprivationStatusCode = hiddenDeprivationStatusCode;
                    dpe.DeprivationStatusDesEnglish = DeprivationStatusDesEnglish;
                    dpe.DeprivationStatusDesSpanish = DeprivationStatusDesSpanish;
                    dpe.SearchEnabled = searchEnable;
                    dpe.Deleted = deleted;
                    dpe.LastModifiedUser = lastModifiedUser;
                    var result = objDeprivationStatusBll.Edit(dpe);
                    ...
                    {
                        DeprivationStatusEntity previousEntity = result.Item2;
                        hdfDeprivationStatusCodeEdit.Value = "-1";

                        if (previousEntity.Deleted)
                        {
                            hdfDeprivationStatusCodeEdit.Value = Convert.ToString(previousEntity.DeprivationStatusCode);
                            txtActivateDeletedDeprivationStatusDesSpanish.Text = previousEntity.DeprivationStatusDesSpanish;
                            txtActivateDeletedDeprivationStatusDesEnglish.Text = previousEntity.DeprivationStatusDesEnglish;
        ...
        protected void BtnEdit_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    short selectedDeprivationStatusCode = Convert.ToInt16(grvList.DataKeys[Convert.ToInt32(hdfSelectedRowIndex.Value)].Value);

                    DeprivationStatusEntity entity = objDeprivationStatusBll.ListByKey(selectedDeprivationStatusCode);

                    hdfDeprivationStatusCodeEdit.Value = selectedDeprivationStatusCode.ToString();
                    txtDeprivationStatusDesSpanish.Text = entity.DeprivationStatusDesSpanish;
                    txtDeprivationStatusDesEnglish.Text = entity.DeprivationStatusDesEnglish;
        ...
        protected void BtnDelete_ServerClick(object sender, EventArgs e)
        {
            try
            {
                if (hdfSelectedRowIndex.Value != "-1")
                {
                    ...
                    dpe.DeprivationStatusCode = short.Parse(selectedDeprivationStatusCode.ToString());
                    dpe.LastModifiedUser = UserHelper.GetCurrentFullUserName;

                    objDeprivationStatusBll.Delete(dpe);

                    PageHelper<DeprivationStatusEntity> pageHelper = SearchResults(PagerUtil.GetActivePage(blstPager));
        ...
        protected void GrvList_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            PageHelper<DeprivationStatusEntity> pageHelper = SearchResults(1);
            PagerUtil.SetupPager(blstPager, pageHelper.TotalPages, pageHelper.CurrentPage);
        ...
        private PageHelper<DeprivationStatusEntity> SearchResults(int page)
        {
            string DeprivationStatusDesSpanish = string.IsNullOrWhiteSpace(txtDeprivationStatusDesSpanishFilter.Text.Trim()) ? null : txtDeprivationStatusDesSpanishFilter.Text.Trim();
            string DeprivationStatusDesEnglish = string.IsNullOrWhiteSpace(txtDeprivationStatusDesEnglishFilter.Text.Trim()) ? null : txtDeprivationStatusDesEnglishFilter.Text.Trim();
            ...
            PageHelper<DeprivationStatusEntity> pageHelper = objDeprivationStatusBll.ListByFilters(
                SessionManager.GetSessionValue<DivisionByUserEntity>(SessionKey.WorkingDivision).DivisionCode
                , DeprivationStatusDesSpanish
                , DeprivationStatusDesEnglish
                , sortExpression
                , sortDirection
                , page
                , null);
