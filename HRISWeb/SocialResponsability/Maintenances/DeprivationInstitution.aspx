<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DeprivationInstitution.aspx.cs" Inherits="HRISWeb.SocialResponsability.Maintenances.DeprivationInstitution" %>
                                ...
                                <div class="form-group">
                                    <div class="form-group col-sm-12 col-md-8 ES">
                                        <div class="col-sm-5 text-left">
                                            <label for="<%= txtDeprivationInstitutionDesSpanishFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDeprivationInstitutionName")%></label>
                                        </div>

                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtDeprivationInstitutionDesSpanishFilter" CssClass="form-control control-validation cleanPasteText ignoreValidation" runat="server" onkeypress="blockEnterKey(); return isNumberOrLetter(event)" MaxLength="50" autocomplete="off" type="text"></asp:TextBox>
                                        </div>
                                    </div>

                                    <div class="form-group col-sm-12 col-md-8 EN">
                                        <div class="col-sm-5 text-left">
                                            <label for="<%= txtDeprivationInstitutionDesEnglishFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDeprivationInstitutionName")%></label>
                                        </div>

                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtDeprivationInstitutionDesEnglishFilter" CssClass="form-control control-validation cleanPasteText ignoreValidation" runat="server" onkeypress="blockEnterKey(); return isNumberOrLetter(event)" MaxLength="50" autocomplete="off" type="text"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div>
                                <asp:GridView ID="grvList"
                                    ...
                                    DataKeyNames="DeprivationInstitutionCode"
                                    ...
                                    <Columns>
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle hidden" HeaderStyle-CssClass="hidden" FooterStyle-CssClass="hidden">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="DeprivationInstitutionCodeSort" runat="server" CommandName="Sort" CommandArgument="DeprivationInstitutionCode" OnClientClick="SetWaitingGrvList(true);">
                                                        <span><%= GetLocalResourceObject("DeprivationInstitutionCode.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "DeprivationInstitutionCode") %> sorterDirection' aria-hidden="true" style="float: right; margin-right: -6px; margin-top: 4px; position: relative; z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>

                                            <ItemTemplate>
                                                <span id="dvDeprivationInstitutionCode" data-id="DeprivationInstitutioncode" data-value="<%# Eval("DeprivationInstitutionCode") %>"><%# Eval("DeprivationInstitutionCode") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="DeprivationInstitutionDesEnglishSort" runat="server" CommandName="Sort" CommandArgument="DeprivationInstitutionDesEnglish" OnClientClick="SetWaitingGrvList(true);">
                                                        <span><%= GetLocalResourceObject("lblDeprivationInstitutionName") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "DeprivationInstitutionDesEnglish") %> sorterDirection' aria-hidden="true" style="float: right; margin-right: -6px; margin-top: 4px; position: relative; z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>

                                            <ItemTemplate>
                                                <span id="dvDeprivationInstitutionDesEnglish" data-id="DeprivationInstitutionDesEnglish" data-value="<%# Eval("DeprivationInstitutionDesEnglish") %>"><%# Eval("DeprivationInstitutionDesEnglish")%></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="DeprivationInstitutionDesSpanishSort" runat="server" CommandName="Sort" CommandArgument="DeprivationInstitutionDesSpanish" OnClientClick="SetWaitingGrvList(true);">
                                                        <span><%= GetLocalResourceObject("lblDeprivationInstitutionName") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "DeprivationInstitutionDesSpanish") %> sorterDirection' aria-hidden="true" style="float: right; margin-right: -6px; margin-top: 4px; position: relative; z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>

                                            <ItemTemplate>
                                                <span id="dvDeprivationInstitutionDesSpanish" data-id="DeprivationInstitutionDesSpanish" data-value="<%# Eval("DeprivationInstitutionDesSpanish") %>"><%# Eval("DeprivationInstitutionDesSpanish")%></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            ...
                                            <ItemTemplate>
                                                <span id="dvSearchEnabled" data-id="SearchEnabled" aria-hidden="true" data-value="<%# Eval("SearchEnabled") %>" class="fa <%# ((DOLE.HRIS.Shared.Entity.DeprivationInstitutionEntity)Container.DataItem).SearchEnabled ? "fa-check-circle" : "fa-times-circle" %> "></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                ...
                <asp:UpdatePanel runat="server" ID="uppDialogControl">
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                <asp:HiddenField ID="hdfDeprivationInstitutionCodeEdit" runat="server" Value="" />

                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtDeprivationInstitutionDesSpanish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDeprivationInstitutionDesSpanish")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtDeprivationInstitutionDesSpanish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event) && checkMaxLength(this,event,255);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,255);" MaxLength="255" TextMode="SingleLine" autocomplete="off"></asp:TextBox>
                                        <label id="txtDeprivationInstitutionDesSpanishValidation" for="<%= txtDeprivationInstitutionDesSpanish.ClientID%>" class="label label-danger label-validation" data-toggle="tooltip" data-container="body" data-placement="left" data-content="<%= GetLocalResourceObject("msgDeprivationInstitutionDesSpanishValidation") %>" style="display: none; float: right; margin-right: 6px; margin-top: -23px; position: relative; z-index: 2;">!</label>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtDeprivationInstitutionDesEnglish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDeprivationInstitutionDesEnglish")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtDeprivationInstitutionDesEnglish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event) && checkMaxLength(this,event,255);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,255);" MaxLength="255" TextMode="SingleLine" autocomplete="off"></asp:TextBox>
                                        <label id="txtDeprivationInstitutionDesEnglishValidation" for="<%= txtDeprivationInstitutionDesEnglish.ClientID%>" class="label label-danger label-validation" data-toggle="tooltip" data-container="body" data-placement="left" data-content="<%= GetLocalResourceObject("msgDeprivationInstitutionDesEnglishValidation") %>" style="display: none; float: right; margin-right: 6px; margin-top: -23px; position: relative; z-index: 2;">!</label>
                                    </div>
                                </div>
                        ...
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <asp:Panel ID="pnlDuplicatedDialogDataDetail" runat="server">
                                    <div class="form-group">
                                        <div class="col-sm-4 text-left">
                                            <label for="<%= txtDuplicatedDeprivationInstitutionDesSpanish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDeprivationInstitutionDesSpanish")%></label>
                                        </div>

                                        <div class="col-sm-8">
                                            <asp:TextBox ID="txtDuplicatedDeprivationInstitutionDesSpanish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,255);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,255);" MaxLength="255" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <div class="col-sm-4 text-left">
                                            <label for="<%= txtDuplicatedDeprivationInstitutionDesEnglish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDeprivationInstitutionDesEnglish")%></label>
                                        </div>

                                        <div class="col-sm-8">
                                            <asp:TextBox ID="txtDuplicatedDeprivationInstitutionDesEnglish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,255);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,255);" MaxLength="255" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>
                                        </div>
                                    </div>
                                </asp:Panel>
                            </div>
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtActivateDeletedDeprivationInstitutionDesSpanish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDeprivationInstitutionDesSpanish")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtActivateDeletedDeprivationInstitutionDesSpanish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,255);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,255);" MaxLength="255" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtActivateDeletedDeprivationInstitutionDesEnglish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblDeprivationInstitutionDesEnglish")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtActivateDeletedDeprivationInstitutionDesEnglish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,255);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,255);" MaxLength="255" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function pageLoad(sender, args) {
            ...
            $('#btnActivateDeletedCancel, #btnActivateDeletedClose').on('click', function (event) {
                /// <summary>Handles the click event for button cancel in user dialog.</summary>
                $("#<%=hdfDeprivationInstitutionCodeEdit.ClientID%>").val("-1");
                event.preventDefault();
            ...
            $('#<%= txtDeprivationInstitutionDesSpanishFilter.ClientID %>').on('keyup keypress', function (e) {
                ReturnFromBtnSearchClickPostBack(e);

                return isNumberOrLetter(e);
            });

            $('#<%= txtDeprivationInstitutionDesEnglishFilter.ClientID %>').on('keyup keypress', function (e) {
                ReturnFromBtnSearchClickPostBack(e);
            ...
            if (validator == null) {
                ...
                validator =
                    $('#' + document.forms[0].id).validate({
                        ...
                        rules: {
                            "<%= txtDeprivationInstitutionDesSpanish.UniqueID %>": {
                                required: true,
                           ...
                           "<%= txtDeprivationInstitutionDesEnglish.UniqueID %>": {
                                required: true,
                                normalizer: function (value) {
                                    return $.trim(value);
                                },
        ...
        function ClearModalForm() {
            ...
            $("#<%=hdfDeprivationInstitutionCodeEdit.ClientID%>").val("-1");
            $("#<%=txtDeprivationInstitutionDesSpanish.ClientID%>").val("");
            $("#<%=txtDeprivationInstitutionDesEnglish.ClientID%>").val("");
