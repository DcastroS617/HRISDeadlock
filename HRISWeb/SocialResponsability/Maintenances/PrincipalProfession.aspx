<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="PrincipalProfession.aspx.cs" Inherits="HRISWeb.SocialResponsability.Maintenances.PrincipalProfession" %>
                                ...
                                <div class="form-group">
                                    <div class="form-group col-sm-12 col-md-8 ES">
                                        <div class="col-sm-5 text-left">
                                            <label for="<%= txtPrincipalProfesionDescriptionSpanishFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblProfessionName")%></label>
                                        </div>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtPrincipalProfesionDescriptionSpanishFilter" CssClass="form-control control-validation cleanPasteText ignoreValidation" runat="server" onkeypress="blockEnterKey(); return isNumberOrLetter(event)" MaxLength="150" autocomplete="off" type="text"></asp:TextBox>
                                        </div>
                                     </div>
                                    <div class="form-group col-sm-12 col-md-8 EN">
                                        <div class="col-sm-5 text-left">
                                            <label for="<%= txtPrincipalProfesionDescriptionEnglishFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblProfessionName")%></label>
                                        </div>
                                        <div class="col-sm-7">
                                            <asp:TextBox ID="txtPrincipalProfesionDescriptionEnglishFilter" CssClass="form-control control-validation cleanPasteText ignoreValidation" runat="server" onkeypress="blockEnterKey(); return isNumberOrLetter(event)" MaxLength="150" autocomplete="off" type="text"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div>
                                <asp:GridView ID="grvList" Width="100%" runat="server" EmptyDataText='<%$ Code:GetLocalResourceObject("lblNoData") %>' 
                                    ...
                                    DataKeyNames="PrincipalProfesionCode" OnPreRender="grvList_PreRender" OnSorting="grvList_Sorting" OnRowDataBound="GrvList_RowDataBound">                             
                                    <Columns>                                        
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle hidden" HeaderStyle-CssClass="hidden" FooterStyle-CssClass="hidden" >
                                            <HeaderTemplate>
                                                <div style="width:100%; text-align:center;">
                                                    <asp:LinkButton ID="ProfessionCodeSort" runat="server" CommandName="Sort" CommandArgument="ProfessionCode" OnClientClick="SetWaitingGrvList(true);">          
                                                        <span><%= GetLocalResourceObject("ProfessionCode.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "ProfessionCode") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvProfessionCode" data-id="Principalprofessioncode" data-value="<%# Eval("PrincipalProfesionCode") %>"><%# Eval("PrincipalProfesionCode") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField> 
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" >
                                            <HeaderTemplate>
                                                <div style="width:100%; text-align:center;">
                                                    <asp:LinkButton ID="ProfessionNameEnglishSort" runat="server" CommandName="Sort" CommandArgument="ProfessionNameEnglish" OnClientClick="SetWaitingGrvList(true);">          
                                                        <span><%= GetLocalResourceObject("ProfessionNameEN.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "ProfessionNameEnglish") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvProfessionNameEnglish" data-id="professionnameenglish" data-value="<%# Eval("PrincipalProfesionDescriptionEnglish") %>"><%# Eval("PrincipalProfesionDescriptionEnglish")%></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>  
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle" >
                                            <HeaderTemplate>
                                                <div style="width:100%; text-align:center;">
                                                    <asp:LinkButton ID="ProfessionNameSpanishSort" runat="server" CommandName="Sort" CommandArgument="ProfessionNameSpanish" OnClientClick="SetWaitingGrvList(true);">          
                                                        <span><%= GetLocalResourceObject("ProfessionNameES.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "ProfessionNameSpanish") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <span id="dvProfessionNameSpanish" data-id="professionnamespanish" data-value="<%# Eval("PrincipalProfesionDescriptionSpanish") %>"><%# Eval("PrincipalProfesionDescriptionSpanish")%></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>   
                                    </Columns>
                                </asp:GridView>           
                ...
                <asp:UpdatePanel runat="server" ID="uppDialogControl">
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                <asp:HiddenField ID="hdfProfessionCodeEdit" runat="server" Value="" />
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtProfessionNameSpanish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblProfessionNameSpanish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtProfessionNameSpanish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" MaxLength="150" TextMode="SingleLine" autocomplete="off"></asp:TextBox>
                                        <label id="txtProfessionNameSpanishValidation" for="<%= txtProfessionNameSpanish.ClientID%>" class="label label-danger label-validation" data-toggle="tooltip" data-container="body" data-placement="left" data-content="<%= GetLocalResourceObject("msgProfessionNameSpanishValidation") %>" style="display:none; float: right;margin-right: 6px;margin-top: -23px;position: relative;z-index: 2;">!</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtProfessionNameEnglish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblProfessionNameEnglish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtProfessionNameEnglish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" MaxLength="150" TextMode="SingleLine" autocomplete="off"></asp:TextBox>
                                        <label id="txtProfessionNameEnglishValidation" for="<%= txtProfessionNameEnglish.ClientID%>" class="label label-danger label-validation" data-toggle="tooltip" data-container="body" data-placement="left" data-content="<%= GetLocalResourceObject("msgProfessionNameEnglishValidation") %>" style="display:none; float: right;margin-right: 6px;margin-top: -23px;position: relative;z-index: 2;">!</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtDuplicatedProfessionNameSpanish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblProfessionNameSpanish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtDuplicatedProfessionNameSpanish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,150);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" MaxLength="150" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>                                        
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtDuplicatedProfessionNameEnglish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblProfessionNameEnglish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtDuplicatedProfessionNameEnglish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,150);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" MaxLength="150" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>                                        
                                    </div>
                                </div>                                       
                                </asp:panel>
                            </div>
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">                                                                
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtActivateDeletedProfessionNameSpanish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblProfessionNameSpanish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtActivateDeletedProfessionNameSpanish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,150);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" MaxLength="150" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>                                        
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtActivateDeletedProfessionNameEnglish.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblProfessionNameEnglish")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtActivateDeletedProfessionNameEnglish" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumber(event) && checkMaxLength(this,event,150);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,150);" MaxLength="150" TextMode="SingleLine" ReadOnly="true"></asp:TextBox>                                        
                                    </div>
                                </div>
                            </div>                            
                        </div>
    ...
    <script type="text/javascript">
        ...
        function pageLoad(sender, args) {
            ...
            $('#btnActivateDeletedCancel, #btnActivateDeletedClose').on('click', function (event) {
                /// <summary>Handles the click event for button cancel in user dialog.</summary>
                $("#<%=hdfProfessionCodeEdit.ClientID%>").val("-1");
                event.preventDefault();                    
                $('#MaintenanceDialog').modal('show');
            ...
            if (validator == null) {
                ...
                validator =
                    $('#' + document.forms[0].id).validate({
                        ...
                        rules: {                                                        
                            <%= txtProfessionNameSpanish.UniqueID %>: {
                                required: true,
                            ...
                            <%= txtProfessionNameEnglish.UniqueID %>: {
                                required: true,
                                normalizer: function(value) {
                                    return $.trim(value);
                                },
        ...
        function ClearModalForm() {
            ...
            $("#<%=hdfProfessionCodeEdit.ClientID%>").val("-1");
            $("#<%=txtProfessionNameSpanish.ClientID%>").val("");
            $("#<%=txtProfessionNameEnglish.ClientID%>").val("");
