<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DeprivationsList.aspx.cs" Inherits="HRISWeb.SocialResponsability.ClosingDeprivations.DeprivationsList" %>
                            ...
                            <div>
                                ...
                                <asp:GridView ID="grvList"
                                    ...
                                    <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                        ...
                                        <asp:TemplateField HeaderText='<%$ Code:GetLocalResourceObject("lblHousehold") %>'>
                                            <ItemTemplate>
            ...
            <div class="modal-content">
                ...
                <asp:UpdatePanel runat="server" ID="uppDialogControl">
                    ...
                    <span>Notas</span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvListDeprivationProcedures.ClientID, "Notes") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                        ...
                        <div class="btn-group" role="group" aria-label="main-buttons"><button id="btnAccept" type="button" runat="server" onserverclick="btnAccept_ServerClick" class="btn btn-primary btnAjaxAction"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-4 text-left">
                                                    <label runat="server" visible="false" for="<%=cboInitiativeManagement.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblInitiative")%></label>
                                                </div>

                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        <asp:DropDownList ID="cboInitiativeManagement" visible="false" CssClass="form-control control-validation selectpicker" AutoPostBack="false" runat="server" data-live-search="true" data-actions-box="true"></asp:DropDownList>
                                                        <label id="cboInitiativeManagementValidation" for="<%= cboInitiativeManagement.ClientID%>" class="label label-danger label-validation" data-toggle="tooltip" data-container="body" data-placement="left" data-content="<%= GetLocalResourceObject("msjCourseValidation") %>" style="display: none; float: right; margin-right: 6px; margin-top: -23px; position: relative; z-index: 2;">!</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
