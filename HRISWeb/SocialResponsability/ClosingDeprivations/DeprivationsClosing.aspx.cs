...
{
    public partial class DeprivationsClosing : System.Web.UI.Page
    {
        [Dependency]
        ...
        protected void btnEdit_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Session[sessionKeyInitiativesResults] != null)
                {
                    ...
                    CloseDeprivationEdit.Checked = result.Deprived == 1 ? true : false;

                    CloseDeprivationEdit.Enabled = result.Deprived == 1 ? false : true;
        ...
        protected void btnDelete_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                DbaEntity result = null;
                result = objDeprivationManagementBLL.CloseDeprivation(entity);
                ...
                if (result.ErrorNumber == 0)
                {
                    ...
                    MensajeriaHelper.MostrarMensaje(Page,
                        TipoMensaje.Informacion,
                        string.Format(Convert.ToString(GetLocalResourceObject("msgDeprivationMgmClosedCompleted")), hdfDeprivationCode.Value), "ReturnDeprivationClosingResult");
                }
        ...
        protected void CloseDeprivationEdit_CheckedChanged(object sender, EventArgs e)
        {
            txtStatusDlg.Text = "Cerrada";

            /*MensajeriaHelper.MostrarMensaje(Page,
                        TipoMensaje.Informacion,
                        string.Format(Convert.ToString(GetLocalResourceObject("msgDeprivationMgmClosedCompleted"))), "ReturnDeprivationClosingResult");*/
        ...
        private void LoadFarms()
        {
            ...
            var farmList = ObjMatrixTargetBll.CostFarmsListEnableByDivisions(geographicDivisionCode, dtDivision);
        ...
        private PageHelper<IndividualsDeprivations> SearchResults(int page)
        {
            ...
            PageHelper<IndividualsDeprivations> pageHelper = objInitiativeBeneficiariesBLL.ClosedDeprivationsByFilters(
