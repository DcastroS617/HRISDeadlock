...
namespace HRISWeb.SocialResponsability.ClosingDeprivations
{
    public partial class InitiativeManagement : System.Web.UI.Page
    {
        ...
        readonly string sessionKeyInitiativesResults = "InitiativesBeneficiaries-InitiativesResults";
        readonly string sessionKeyInitiativesBeneficiariesResults = "InitiativesBeneficiaries-InitiativesBeneficiariesResults";
        readonly string sessionKeyInitiativeCodeResults = "TrainingInitiatives-InitiativeCodeResults";
        readonly string sessionKeyDivisionResults = "InitiativesBeneficiaries-DivisionResults";
        readonly string sessionKeyIndicatorsResults = "InitiativesBeneficiaries-IndicatorsResults";
        readonly string sessionKeyCoordinatorsResults = "InitiativesBeneficiaries-CoordinatorsResults";
        ...
        protected void BtnAdd_ServerClick(object sender, EventArgs e)
        {
            ...
            {              
                ...
                Response.Redirect("BeneficiariesRegistration.aspx");
        ...
        {
            if (Session[sessionKeyInitiativesBeneficiariesResults] != null)
            {
                CommonFunctions.SwitchSetSortDirection(Page.ClientID, grvList.ClientID, e.SortExpression);

                PageHelper<InitiativeBeneficiaries> pageHelper = SearchResults(1);
        ...
        protected void grvList_RowCommand(Object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "ViewDetails")
            {
                ...
                Session[sessionKeyEmployeeCodeResults] = e.CommandArgument.ToString().Split('-')[0];//e.CommandArgument;
                Session[sessionKeyDeprivationOrigin] = "1";

                string individualCode = e.CommandArgument.ToString();

                PageHelper<InitiativeBeneficiaries> pageHelper = (PageHelper<InitiativeBeneficiaries>)Session[sessionKeyInitiativesBeneficiariesResults];


                DataTable dt = pageHelper.ResultList.ToDataTableGet();

                // Buscar usando Select (retorna un array de DataRow)
                DataRow[] filas = dt.Select($"IndividualCode = '{individualCode.Replace("'", "''")}'");
                ...
                if (filas.Length > 0)
                {
                    ...
                    string indicator = fila["IndicatorName"].ToString();
                    Session[sessionKeyDeprivationName] = indicator;
                    
                    //string deprivationCode = fila["Correo"].ToString();

                    // Aquí haces lo que necesites con la información
                }
                else
                {
        ...
        private PageHelper<InitiativeBeneficiaries> SearchResults(int page)
        {
            ...
            PageHelper<InitiativeBeneficiaries> pageHelper = objInitiativeBeneficiariesBLL.ListByFilters(int.Parse(Session[sessionKeyInitiativeCodeResults].ToString()),
            ...
            Session[sessionKeyInitiativesBeneficiariesResults] = pageHelper;
            return pageHelper;
        }
