<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="InitiativeManagement.aspx.cs" Inherits="HRISWeb.SocialResponsability.ClosingDeprivations.InitiativeManagement" %>
                            ...
                            <div>
                                ...
                                <asp:GridView ID="grvList"
                                    ...
                                    <asp:TemplateField HeaderText='<%$ Code:GetLocalResourceObject("lblActions") %>'> 
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkView" runat="server" class="btn btn-default" Text='<%$ Code:GetLocalResourceObject("lblManageHousehold") %>' CommandName="ViewDetails" CommandArgument='<%# Eval("IndividualCode") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField> 
