...
namespace HRISWeb
{
    ...
    /// </summary>
    public class GlobalCard : System.Web.HttpApplication
    {
        ...
        protected void Session_Start(object sender, EventArgs e)
        {
            if (Session.IsNewSession)
            {
                ...
                {
                    if (!Context.Request.Url.AbsoluteUri.ToLower().Contains("/startsurvey.aspx"))
                    {
        ...
        {
            return ConfigurationManager.AppSettings[preloadSocialResponsibilityCatalogs] != null && ConfigurationManager.AppSettings[preloadSocialResponsibilityCatalogs].ToString().Equals("1");
        }
    }
}