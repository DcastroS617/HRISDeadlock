<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="TypeTraining.aspx.cs" Inherits="HRISWeb.Training.Maintenances.TypeTraining" %>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-12 col-md-6">
                                            <div class="col-sm-5 text-left">
                                                <label for="<%= TypeTrainingCodeFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTypeTrainingCode")%></label>
                                            </div>

                                            <div class="col-sm-7">
                                                <asp:TextBox ID="TypeTrainingCodeFilter" CssClass="form-control control-validation cleanPasteText ignoreValidation" runat="server" MaxLength="10" autocomplete="off" type="text" data-id="TypeTrainingCode" data-value="isPermitted"></asp:TextBox>
                                            </div>
                                        </div>
                                       
                                        <div class="form-group col-sm-12 col-md-6">
                                            <div class="col-sm-5 text-left">
                                                <label for="<%= TypeTrainingNameFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTypeTrainingName")%></label>
                                            </div>

                                            <div class="col-sm-7">
                                                <asp:TextBox ID="TypeTrainingNameFilter" CssClass="form-control control-validation cleanPasteText ignoreValidation" runat="server" MaxLength="500" autocomplete="off" type="text" data-id="TypeTrainingName" data-value="isPermitted"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <asp:GridView ID="grvList"
                                        ...
                                        <Columns>
                                            <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                                <HeaderTemplate>
                                                    <div style="width: 100%; text-align: center;">
                                                        <asp:LinkButton ID="TypeTrainingCodeSort" runat="server" CommandName="Sort" CommandArgument="TypeTrainingCode"
                                                            OnClientClick="SetWaitingGrvList(true);">          
                                                            <span><%= GetLocalResourceObject("TypeTrainingCodeHeaderText") %></span>&nbsp;
                                                            <i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "TypeTrainingCode") %> sorterDirection' 
                                                ...
                                                <ItemTemplate>
                                                    <span id="dvTypeTrainingCode" data-id="TypeTrainingCode" data-value="<%# Eval("TypeTrainingCode") %>"><%# Eval("TypeTrainingCode") %></span>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                                <HeaderTemplate>
                                                    <div style="width: 100%; text-align: center;">
                                                        <asp:LinkButton ID="TypeTrainingNameSort" runat="server" CommandName="Sort" CommandArgument="TypeTrainingName" OnClientClick="SetWaitingGrvList(true);">          
                                                            <span><%= GetLocalResourceObject("TypeTrainingNameHeaderText") %></span>&nbsp;
                                                ...
                                                <ItemTemplate>
                                                    <span id="dvTypeTrainingName" data-id="TypeTrainingName" style="overflow-wrap: break-word; word-wrap:break-word; word-break:break-all;" data-value="<%# Eval("TypeTrainingName") %>"><%# Eval("TypeTrainingName") %></span>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
                ...
                <asp:UpdatePanel runat="server" ID="uppDialogControl">
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                <asp:HiddenField ID="hdfTypeTrainingIdEdit" runat="server" Value="" />

                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%=TypeTrainingCodeEdit.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTypeTrainingCode")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="TypeTrainingCodeEdit" CssClass="form-control cleanPasteText enterkey emptyinput trim" runat="server" onkeypress="return isNumberOrLetter(event)" MaxLength="10"></asp:TextBox>
                                        
                                        <label id="TypeTrainingCodeEditValidation" for="<%= TypeTrainingCodeEdit.ClientID%>" 
                                            class="label label-danger label-validation" data-toggle="tooltip" 
                                            data-container="body" data-placement="left" 
                                            data-content="<%= GetLocalResourceObject("msjTypeTrainingCodeValidation") %>" 
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%=TypeTrainingNameEdit.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTypeTrainingName")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="TypeTrainingNameEdit" CssClass="form-control cleanPasteText enterkey emptyinput trim" runat="server" onkeypress="return isNumberOrLetter(event)" MaxLength="500"></asp:TextBox>
                                       
                                        <label id="TypeTrainingName" for="<%= TypeTrainingNameEdit.ClientID%>" 
                                            class="label label-danger label-validation" data-toggle="tooltip" 
                                            data-container="body" data-placement="left" 
                                            data-content="<%= GetLocalResourceObject("msjTypeTrainingNameValidation") %>" 
                                            style="display: none; float: right; margin-right: 6px; margin-top: -23px; position: relative; z-index: 2;">!</label>
                                    </div>
                                </div>
                        ...
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <asp:Panel ID="pnlDuplicatedDialogDataDetail" runat="server">
                                    <div class="form-group">
                                        <div class="col-sm-4 text-left">
                                            <label for="<%= txtDuplicatedTypeTrainingCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTypeTrainingCode")%></label>
                                        </div>

                                        <div class="col-sm-8">
                                            <asp:TextBox ID="txtDuplicatedTypeTrainingCode" CssClass="form-control cleanPasteText ignoreValidation" runat="server" ReadOnly="true"></asp:TextBox>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <div class="col-sm-4 text-left">
                                            <label for="<%= txtDuplicatedTrainerCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTypeTrainingName")%></label>
                                        </div>
            ...
            <div class="modal-content">
                ...
                <asp:UpdatePanel runat="server" ID="uppActivateDeletedDialog">
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                <asp:HiddenField ID="hdfActivateDeletedTypeTrainingId" runat="server" Value="" />
                               ...
                               <div id="divActivateDeletedDialog" runat="server"></div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtActivateDeletedTypeTrainingCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTypeTrainingCode")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtActivateDeletedTypeTrainingCode" CssClass="form-control cleanPasteText ignoreValidation" runat="server" TextMode="MultiLine" Columns="3" ReadOnly="true"></asp:TextBox>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtActivateDeletedTypeTrainingName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTypeTrainingName")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtActivateDeletedTypeTrainingName" CssClass="form-control cleanPasteText ignoreValidation" runat="server" ReadOnly="true"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function pageLoad(sender, args) {
            ...
            $('#<%= btnAdd.ClientID %>').on('click', function (ev) {
                ...
                $('#<%= TypeTrainingCodeEdit.ClientID %>').prop('disabled', false);
            ...
            $('#<%= TypeTrainingCodeFilter.ClientID %>').on('keyup keypress', function (e) {
                ReturnFromBtnSearchClickPostBack(e);

                return isNumberOrLetter(e);
            });

            $('#<%= TypeTrainingNameFilter.ClientID %>').on('keyup keypress', function (e) {
                ReturnFromBtnSearchClickPostBack(e);
        ...
        function ClearModalForm() {
            $(".emptyinput").val("");
            $("#<%=hdfTypeTrainingIdEdit.ClientID%>").val("-1");

            $("#<%=TypeTrainingCodeEdit.ClientID%>").val("");
        ...
        function ProcessEditRequest(resetId) {
            ...
            if (IsRowSelected()) {
                $('#<%= TypeTrainingCodeEdit.ClientID %>').prop('disabled', true);
