<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ThematicAreas.aspx.cs" Inherits="HRISWeb.Training.Maintenances.ThematicAreas" %>
                    ...
                    <div class="row">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%= txtThematicAreaCodeFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblThematicAreaCode")%></label>
                                    </div>

                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtThematicAreaCodeFilter" CssClass="form-control control-validation cleanPasteText" runat="server" MaxLength="10" autocomplete="off" type="text" data-id="ThematicAreaCode" data-value="isPermitted"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%= txtThematicAreaNameFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblThematicAreaName")%></label>
                                    </div>

                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtThematicAreaNameFilter" CssClass="form-control control-validation cleanPasteText" runat="server" MaxLength="500" autocomplete="off" type="text" data-id="ThematicAreaName" data-value="isPermitted"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div>
                                <asp:GridView ID="grvList" Width="100%" runat="server" EmptyDataText='<%$ Code:GetLocalResourceObject("lblNoData") %>'
                                    ...
                                    DataKeyNames="ThematicAreaCode" OnPreRender="GrvList_PreRender" OnSorting="GrvList_Sorting">
                                    <Columns>
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="ThematicAreaCodeSort" runat="server" CommandName="Sort" CommandArgument="ThematicAreaCode" OnClientClick="SetWaitingGrvList(true);">          
                                                        <span><%= GetLocalResourceObject("ThematicAreaCode.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "ThematicAreaCode") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>

                                            <ItemTemplate>
                                                <span id="dvThematicAreaCode" data-id="thematicAreacode" data-value="<%# Eval("ThematicAreaCode") %>"><%# Eval("ThematicAreaCode") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="ThematicAreaNameSort" runat="server" CommandName="Sort" CommandArgument="ThematicAreaName" OnClientClick="SetWaitingGrvList(true);">          
                                                        <span><%= GetLocalResourceObject("ThematicAreaName.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "ThematicAreaName") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>

                                            <ItemTemplate>
                                                <span id="dvThematicAreaName" data-id="thematicAreaname" data-value="<%# Eval("ThematicAreaName") %>"><%# Eval("ThematicAreaName") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
            ...
            <asp:UpdatePanel ID="uppActions" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                ...
                <ContentTemplate>
                    <div class="btn-group" role="group" aria-label="main-buttons">
                        <button id="btnAdd" type="button" runat="server" class="btn btn-default btnAjaxAction btnsdisabled"
                        ...
                        <button id="btnEdit" type="button" runat="server" class="btn btn-default btnAjaxAction btnsdisabled"
                        ...
                        <button id="btnDelete" type="button" runat="server" class="btn btn-default btnAjaxAction btnsdisabled"
                        ...
                        <button id="btnEditCourses" type="button" runat="server" class="btn btn-default btnAjaxAction btnsdisabled"
                ...
                <asp:UpdatePanel runat="server" ID="uppDialogControl">
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                <asp:HiddenField ID="hdfThematicAreaCodeEdit" runat="server" Value="" />

                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtThematicAreaCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblThematicAreaCode")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtThematicAreaCode" CssClass="form-control cleanPasteText  txtdisabled" runat="server" onkeypress="return isNumberOrLetter(event)" MaxLength="10"></asp:TextBox>
                                        
                                        <label id="txtThematicAreaCodeValidation" for="<%= txtThematicAreaCode.ClientID%>" 
                                            class="label label-danger label-validation" data-toggle="tooltip" 
                                            data-container="body" data-placement="left" 
                                            data-content="<%= GetLocalResourceObject("msjThematicAreaCodeValidation") %>" 
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtThematicAreaName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblThematicAreaName")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtThematicAreaName" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event) && checkMaxLength(this,event,500);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,500);" MaxLength="500" TextMode="MultiLine" Columns="3"></asp:TextBox>
                                       
                                        <label id="txtThematicAreaNameValidation" for="<%= txtThematicAreaName.ClientID%>" 
                                            class="label label-danger label-validation" data-toggle="tooltip" 
                                            data-container="body" data-placement="left" 
                                            data-content="<%= GetLocalResourceObject("msjThematicAreaNameValidation") %>" 
                                            style="display: none; float: right; margin-right: 6px; margin-top: -23px; position: relative; z-index: 2;">!</label>
                                    </div>
                                </div>
                ...
                <div class="modal-body">
                    <div class="form-horizontal">
                            ...
                            <ContentTemplate>
                                <div class="form-group">
                                    <div class="col-sm-12 text-left">
                                        <h4>
                                            <label id="lblAssociatedCourses" runat="server" class="control-label"><%=GetLocalResourceObject("lblAssociatedCourses")%></label></h4>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-12 text-left">
                                <h4>
                                    <label id="lblAddCourses" runat="server" class="control-label"><%=GetLocalResourceObject("lblAddCourse")%></label></h4>
                            </div>
                        </div>
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtDuplicatedThematicAreaCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblThematicAreaCode")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtDuplicatedThematicAreaCode" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event)" MaxLength="10" ReadOnly="true"></asp:TextBox>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtDuplicatedThematicAreaName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblThematicAreaName")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtDuplicatedThematicAreaName" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event) && checkMaxLength(this,event,500);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,500);" MaxLength="500" TextMode="MultiLine" Columns="3" ReadOnly="true"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <asp:UpdatePanel runat="server" ID="uppActivateDeletedDialog">
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                <asp:HiddenField ID="hdfThematicAreaCodeActivateDeleted" runat="server" Value="" />

                                <div id="divActivateDeletedDialog" runat="server"></div>

                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtActivateDeletedThematicAreaCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblThematicAreaCode")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtActivateDeletedThematicAreaCode" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event)" MaxLength="10" ReadOnly="true"></asp:TextBox>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtActivateDeletedThematicAreaName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblThematicAreaName")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtActivateDeletedThematicAreaName" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event) && checkMaxLength(this,event,500);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,500);" MaxLength="500" TextMode="MultiLine" Columns="3" ReadOnly="true"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function pageLoad(sender, args) {
            ...
            $('#btnCancel, #btnClose').on('click', function (event) {
                ...
                EnableButtonsDialog();
                $('.btnsdisabled').prop('disabled', false);
            });
            ...
            $('#btnDuplicatedAccept, #btnDuplicatedClose').on('click', function (event) {
                ...
                $('#<%= txtThematicAreaCode.ClientID %>').prop('disabled', false);
            });
            //////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            $('#<%= txtThematicAreaCodeFilter.ClientID %>').on('keyup keypress', function (e) {
            ...
            $('#<%= txtThematicAreaNameFilter.ClientID %>').on('keyup keypress', function (e) {
                ReturnFromBtnSearchClickPostBack(e);
        ...
        function SelectInternalCourse(btnId) {
            setTimeout(function () { $("#" + btnId).button('reset'); }, 100);
        }

        function ClearModalForm() {
            /// <summary>Clear the modal form</summary>
            $("#<%=hdfThematicAreaCodeEdit.ClientID%>").val("");
            $("#<%=txtThematicAreaCode.ClientID%>").val("");
            $("#<%=txtThematicAreaName.ClientID%>").val("");
        ...
        function ProcessEditRequest(resetId) {
            ...
            /// <param name="resetId" type="String">Id of the button to reset if not request proceed</param>
            if (IsRowSelected()) {
                $('#<%= txtThematicAreaCode.ClientID %>').prop('disabled', true);
