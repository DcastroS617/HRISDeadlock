<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="TrainingPrograms.aspx.cs" Inherits="HRISWeb.Training.Maintenances.TrainingPrograms" %>
                    ...
                    <div class="row">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%= txtTrainingProgramCodeFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTrainingProgramCode")%></label>
                                    </div>

                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtTrainingProgramCodeFilter" CssClass="form-control control-validation cleanPasteText" runat="server" MaxLength="10" autocomplete="off" type="text" data-id="TrainingProgramCode" data-value="isPermitted"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-sm-5 text-left">
                                        <label for="<%= txtTrainingProgramNameFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTrainingProgramName")%></label>
                                    </div>

                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtTrainingProgramNameFilter" CssClass="form-control control-validation cleanPasteText" runat="server" MaxLength="500" autocomplete="off" type="text" data-id="TrainingProgramName" data-value="isPermitted"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 text-center">
                            ...
                            <div>
                                <asp:GridView ID="grvList" Width="100%" runat="server" EmptyDataText='<%$ Code:GetLocalResourceObject("lblNoData") %>'
                                    ...
                                    DataKeyNames="GeographicDivisionCode, TrainingProgramCode" OnPreRender="GrvList_PreRender" OnSorting="GrvList_Sorting">
                                    <Columns>
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="TrainingProgramCodeSort" runat="server" CommandName="Sort" CommandArgument="TrainingProgramCode" OnClientClick="SetWaitingGrvList(true);">          
                                                        <span><%= GetLocalResourceObject("TrainingProgramCode.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "TrainingProgramCode") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>

                                            <ItemTemplate>
                                                <span id="dvTrainingProgramCode" data-id="trainingProgramcode" data-value="<%# Eval("TrainingProgramCode") %>"><%# Eval("TrainingProgramCode") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                            <HeaderTemplate>
                                                <div style="width: 100%; text-align: center;">
                                                    <asp:LinkButton ID="TrainingProgramNameSort" runat="server" CommandName="Sort" CommandArgument="TrainingProgramName" OnClientClick="SetWaitingGrvList(true);">          
                                                        <span><%= GetLocalResourceObject("TrainingProgramName.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "TrainingProgramName") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                                                    </asp:LinkButton>
                                                </div>
                                            </HeaderTemplate>

                                            <ItemTemplate>
                                                <span id="dvTrainingProgramName" data-id="trainingProgramname" data-value="<%# Eval("TrainingProgramName") %>"><%# Eval("TrainingProgramName") %></span>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                ...
                <asp:UpdatePanel runat="server" ID="uppDialogControl">
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                <asp:HiddenField ID="hdfTrainingProgramCodeEdit" runat="server" Value="" />
                                <asp:HiddenField ID="hdfTrainingProgramGeographicDivisionCodeEdit" runat="server" Value="" />

                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtTrainingProgramCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTrainingProgramCode")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtTrainingProgramCode" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event)" MaxLength="10"></asp:TextBox>
                                        
                                        <label id="txtTrainingProgramCodeValidation" for="<%= txtTrainingProgramCode.ClientID%>" 
                                            class="label label-danger label-validation" 
                                            data-toggle="tooltip" data-container="body" data-placement="left" 
                                            data-content="<%= GetLocalResourceObject("msjTrainingProgramCodeValidation") %>" 
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtTrainingProgramName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTrainingProgramName")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtTrainingProgramName" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event) && checkMaxLength(this,event,500);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,500);" MaxLength="500" TextMode="MultiLine" Columns="3"></asp:TextBox>
                                        
                                        <label id="txtTrainingProgramNameValidation" for="<%= txtTrainingProgramName.ClientID%>" 
                                            class="label label-danger label-validation" data-toggle="tooltip" 
                                            data-container="body" data-placement="left" 
                                            data-content="<%= GetLocalResourceObject("msjTrainingProgramNameValidation") %>" 
                                            style="display: none; float: right; margin-right: 6px; margin-top: -23px; position: relative; z-index: 2;">!</label>
                                    </div>
                                </div>
            ...
            <div class="modal-content">
                ...
                <asp:UpdatePanel runat="server" ID="uppDuplicatedDialog">
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                <asp:HiddenField ID="hdfDuplicatedTrainingProgramGeographicDivisionCode" runat="server" Value="" />
                                <asp:HiddenField ID="hdfDuplicatedTrainingProgramCode" runat="server" Value="" />

                                <div id="divDuplicatedDialogText" runat="server"></div>

                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtDuplicatedTrainingProgramCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTrainingProgramCode")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtDuplicatedTrainingProgramCode" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event)" MaxLength="10" ReadOnly="true"></asp:TextBox>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtDuplicatedTrainingProgramName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTrainingProgramName")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtDuplicatedTrainingProgramName" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event) && checkMaxLength(this,event,500);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,500);" MaxLength="500" TextMode="MultiLine" Columns="3" ReadOnly="true"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <asp:UpdatePanel runat="server" ID="uppActivateDeletedDialog">
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            <div class="form-horizontal">
                                <asp:HiddenField ID="hdfActivateDeletedTrainingProgramGeographicDivisionCode" runat="server" Value="" />
                                <asp:HiddenField ID="hdfActivateDeletedTrainingProgramCode" runat="server" Value="" />

                                <div id="divActivateDeletedDialog" runat="server"></div>

                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtActivateDeletedTrainingProgramCode.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTrainingProgramCode")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtActivateDeletedTrainingProgramCode" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event)" MaxLength="10" ReadOnly="true"></asp:TextBox>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= txtActivateDeletedTrainingProgramName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblTrainingProgramName")%></label>
                                    </div>

                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtActivateDeletedTrainingProgramName" CssClass="form-control cleanPasteText" runat="server" onkeypress="return isNumberOrLetter(event) && checkMaxLength(this,event,500);" onkeyUp="return isNumberOrLetter(event) && checkMaxLength(this,event,500);" MaxLength="500" TextMode="MultiLine" Columns="3" ReadOnly="true"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function pageLoad(sender, args) {
            ...
            $('#<%= btnAdd.ClientID %>').on('click', function (ev) {
                ...
                $('#<%= txtTrainingProgramCode.ClientID %>').prop('disabled', false);
            ...
            $('#<%= txtTrainingProgramCodeFilter.ClientID %>').on('keyup keypress', function (e) {
            ...
            $('#<%= txtTrainingProgramNameFilter.ClientID %>').on('keyup keypress', function (e) {
                ReturnFromBtnSearchClickPostBack(e);
            ...
            if (validator == null) {
                ...
                validator =
                    $('#' + document.forms[0].id).validate({
                        ...
                        rules: {
                            "<%= txtTrainingProgramCode.UniqueID %>": {
                                required: true,
                            ...
                            "<%= txtTrainingProgramName.UniqueID %>": {
                                required: true,
                                normalizer: function (value) {
                                    return $.trim(value);
                                },
        ...
        function ClearModalForm() {
            ...
            $("#<%=hdfTrainingProgramCodeEdit.ClientID%>").val("");
            $("#<%=txtTrainingProgramCode.ClientID%>").val("");
            $("#<%=txtTrainingProgramName.ClientID%>").val("");
        ...
        function ReturnFromBtnEditClickPostBack() {
            ...
            $('#<%= txtTrainingProgramCode.ClientID %>').prop('disabled', true);
