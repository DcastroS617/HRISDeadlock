<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="GtiParameterMaintenance.aspx.cs" Inherits="HRISWeb.GTI.GtiParameterMaintenance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntBody" runat="server">
                                ...
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        <div class="col-sm-2 text-left">
                                            <label for="<%= txtPeriodPeriodParameterDivisionName.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblNameParameter")%></label>
                                        </div>
                                        <div class="col-sm-3">
                                            <asp:TextBox ID="txtPeriodPeriodParameterDivisionName" CssClass="form-control control-validation cleanPasteText ignoreValidation" runat="server" onkeypress="blockEnterKey(); return isNumberOrLetter(event)" MaxLength="50" autocomplete="off" type="text"></asp:TextBox>
                                        </div>

                                        <div class="col-sm-2 text-left">
                                            <label for="<%= cboDivisionFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblNameDivision")%></label>
                                        </div>
                                        <div class="col-sm-3">
                                            <asp:DropDownList ID="cboDivisionFilter" CssClass="form-control control-validation" AutoPostBack="false" runat="server" data-id="Status" data-value="isPermitted"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-2 text-left">
                                            <label for="<%= cboNominalClassFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblNameNominalClass")%></label>
                                        </div>
                                        <div class="col-sm-3">
                                            <asp:DropDownList ID="cboNominalClassFilter" CssClass="form-control control-validation" AutoPostBack="false" runat="server" data-id="Status" data-value="isPermitted"></asp:DropDownList>
                                        </div>

                                        <div class="col-sm-2 text-left">
                                            <label for="<%= cboCurrencyFilter.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblNameCurrency")%></label>
                                        </div>
                                        <div class="col-sm-3">
                                            <asp:DropDownList ID="cboCurrencyFilter" CssClass="form-control control-validation" AutoPostBack="false" runat="server" data-id="Status" data-value="isPermitted"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 text-center">
                                ...
                                <div>
                                    <asp:GridView ID="grvList" Width="100%" runat="server" EmptyDataText='<%$ Code:GetLocalResourceObject("lblNoData") %>'
                                        ...
                                        DataKeyNames="PeriodParameterDivisionCurrencyId" OnPreRender="GrvList_PreRender" OnSorting="GrvList_Sorting" OnRowDataBound="GrvList_RowDataBound">
                                        <Columns>
                                            <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle hidden" HeaderStyle-CssClass="hidden" FooterStyle-CssClass="hidden">
                                                <HeaderTemplate>
                                                    <div style="width: 100%; text-align: center;">
                                                        <asp:LinkButton ID="PeriodParameterDivisionCurrencyIdSort" runat="server" CommandName="Sort" CommandArgument="PeriodParameterDivisionCurrencyId" OnClientClick="SetWaitingGrvList(true);">          
                                                            <span><%= GetLocalResourceObject("PeriodParameterDivisionCurrencyId.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "PeriodParameterDivisionCurrencyId") %> sorterDirection' aria-hidden="true" style="float: right;margin-right: -6px;margin-top: 4px;position: relative;z-index: 2;"></i>
                                                        </asp:LinkButton>
                                                    </div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <span id="dvPeriodParameterDivisionCurrencyId" data-id="PrincipalPeriodParameterDivisionCurrencyId" data-value="<%# Eval("PeriodParameterDivisionCurrencyId") %>"><%# Eval("PeriodParameterDivisionCurrencyId") %></span>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                                <HeaderTemplate>
                                                    <div style="width: 100%; text-align: center;">
                                                        <asp:LinkButton ID="QuarterIDSort" runat="server" CommandName="Sort" CommandArgument="PeriodParameterDivisionCurrencyName" OnClientClick="SetWaitingGrvList(true);">
                                                            <span><%= GetLocalResourceObject("ParameterName.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "PeriodParameterDivisionCurrencyName") %> sorterDirection' aria-hidden="true" style="float: right; margin-right: -6px; margin-top: 4px; position: relative; z-index: 2;"></i>
                                                        </asp:LinkButton>
                                                    </div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <span id="dvPeriodParameterDivisionCurrencyName" data-id="PeriodParameterDivisionCurrencyName" data-value="<%# Eval("PeriodParameterDivisionCurrencyName") %>"><%# Eval("PeriodParameterDivisionCurrencyName")%></span>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                                <HeaderTemplate>
                                                    <div style="width: 100%; text-align: center;">
                                                        <asp:LinkButton ID="GeographicDivisionIDSort" runat="server" CommandName="Sort" CommandArgument="GeographicDivisionID" OnClientClick="SetWaitingGrvList(true);">
                                                            <span><%= GetLocalResourceObject("DivisionName.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "GeographicDivisionID") %> sorterDirection' aria-hidden="true" style="float: right; margin-right: -6px; margin-top: 4px; position: relative; z-index: 2;"></i>
                                                        </asp:LinkButton>
                                                    </div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <span id="dvGeographicDivisionID" data-id="GeographicDivisionID" data-value="<%# Eval("GeographicDivisionID") %>"><%# Eval("GeographicDivisionID")%></span>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                                <HeaderTemplate>
                                                    <div style="width: 100%; text-align: center;">
                                                        <asp:LinkButton ID="NominalClassSort" runat="server" CommandName="Sort" CommandArgument="NominalClassId" OnClientClick="SetWaitingGrvList(true);">
                                                            <span><%= GetLocalResourceObject("NominalClass.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "NominalClassId") %> sorterDirection' aria-hidden="true" style="float: right; margin-right: -6px; margin-top: 4px; position: relative; z-index: 2;"></i>
                                                        </asp:LinkButton>
                                                    </div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <span id="dvNominalClass" data-id="NominalClassId" data-value="<%# Eval("NominalClassId") %>"><%# Eval("NominalClassId")%></span>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <%--<asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                                <HeaderTemplate>
                                                    <div style="width: 100%; text-align: center;">
                                                        <asp:LinkButton ID="CurrencyNameEnglishSort" runat="server" CommandName="Sort" CommandArgument="CurrencyNameEnglish" OnClientClick="SetWaitingGrvList(true);">
                                                            <span><%= GetLocalResourceObject("CurrencyName.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "CurrencyNameEnglish") %> sorterDirection' aria-hidden="true" style="float: right; margin-right: -6px; margin-top: 4px; position: relative; z-index: 2;"></i>
                                                        </asp:LinkButton>
                                                    </div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <span id="dvCurrencyNameEnglish" data-id="CurrencyNameEnglish" data-value="<%# Eval("CurrencyNameEnglish") %>"><%# Eval("CurrencyNameEnglish")%></span>
                                                </ItemTemplate>
                                            </asp:TemplateField>--%>
                                            <asp:TemplateField ItemStyle-CssClass="ItemSelector ItemStyle">
                                                <HeaderTemplate>
                                                    <div style="width: 100%; text-align: center;">
                                                        <asp:LinkButton ID="CurrencyNameSpanishSort" runat="server" CommandName="Sort" CommandArgument="FinalDate" OnClientClick="SetWaitingGrvList(true);">
                                                            <span><%= GetLocalResourceObject("CurrencyName.HeaderText") %></span>&nbsp;<i class='fa <%= HRISWeb.Shared.CommonFunctions.GetSortDirectionStyle(Page.ClientID, grvList.ClientID, "CurrencyNameSpanish") %> sorterDirection' aria-hidden="true" style="float: right; margin-right: -6px; margin-top: 4px; position: relative; z-index: 2;"></i>
                                                        </asp:LinkButton>
                                                    </div>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <span id="dvCurrencyNameSpanish" data-id="CurrencyNameSpanish" data-value="<%# Eval("CurrencyNameSpanish") %>"><%# Eval("CurrencyNameSpanish")%></span>
                                                </ItemTemplate>
                                            </asp:TemplateField>
            ...
            <asp:UpdatePanel ID="uppActions" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                ...
                <ContentTemplate>
                    <div class="btn-group" role="group" aria-label="main-buttons">
                        ...
                        <%--<button id="btnEnable" type="button" runat="server" class="btn btn-default btnAjaxAction"
                            onserverclick="BtnEnable_ServerClick" onclick="return ProcessEnableRequest(this.id);"
                            data-loading-text='<%$ Code:String.Concat("<span class=\"fa fa-spinner fa-spin glyphicon-main-button\"></span><br />", GetLocalResourceObject("btnEnable"))%>'
                            data-error-text='<%$ Code:String.Concat("<span class=\"glyphicon glyphicon-exclamation-sign glyphicon-main-button\"></span><br />", GetLocalResourceObject("btnEnable"))%>'>
                            <span class="glyphicon glyphicon-off glyphicon-main-button" aria-hidden="true" aria-label="main-buttons"></span>
                            <br />
                            <%= GetLocalResourceObject("btnEnable") %>
                        </button>--%>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <asp:UpdatePanel runat="server" ID="uppDialogControl">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= cboDivisionModal.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblNameDivision")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:DropDownList ID="cboDivisionModal" CssClass="form-control control-validation" AutoPostBack="true" OnSelectedIndexChanged="cboDivisionModal_SelectedIndexChanged" runat="server" data-id="Division" ata-value="isPermitted"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= cboNominalClassModal.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblNameNominalClass")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:DropDownList ID="cboNominalClassModal" CssClass="form-control control-validation" runat="server" Enabled="false"></asp:DropDownList>
                                        <!-- Está deshabilitado por defecto -->
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                                        <label for="<%= cboCurrencyModal.ClientID%>" class="control-label"><%=GetLocalResourceObject("lblNameCurrency")%></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <asp:DropDownList ID="cboCurrencyModal" CssClass="form-control control-validation" AutoPostBack="false" runat="server"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-4 text-left">
                    ...
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="cboDivisionModal" EventName="SelectedIndexChanged" />
                    </Triggers>
                </asp:UpdatePanel>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        <%--$(document).ready(function () {
            // Adjuntar el evento para cuando se muestre el modal
            $('#MaintenanceDialog').on('shown.bs.modal', function () {
                // Detecta cambios en el cboDivisionModal dentro del modal
                $('#<%= cboDivisionModal.ClientID %>').off('change').on('change', function () {
                    var selectedDivisionId = $(this).val(); // Obtiene la división seleccionada


                    if (selectedDivisionId && selectedDivisionId.trim() !== "") {
                        // Llama a la función AJAX para cargar las clases nominales

                        loadNominalClasses(selectedDivisionId);
                    } else {
                        // Si no hay división seleccionada, deshabilita el cboNominalClassModal

                        $('#<%= cboNominalClassModal.ClientID %>').prop('disabled', true).empty();
                    }
                });
            });
        });--%>
        ...
        function pageLoad(sender, args) {
            ...
            var divisionDropdown = document.getElementById("<%= cboDivisionModal.ClientID %>");
            var nominalClassDropdown = document.getElementById("<%= cboNominalClassModal.ClientID %>");
            ...
            divisionDropdown.addEventListener("change", function () {
                ...
                if (divisionDropdown.value !== "") {
                    nominalClassDropdown.disabled = false;
                } else {
                    nominalClassDropdown.disabled = true;
                }
            });
        ...
        function loadNominalClasses(divisionId) {
            $.ajax({
                type: "POST",
                url: "/GTI/GtiParameterMaintenance.aspx/GetNominalClasses",
                data: JSON.stringify({ divisionId: divisionId }), // Envía el ID de la división seleccionada
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
                    var classes = response.d; // Asume que el servicio devuelve una lista de clases nominales
                    var $nominalClassDropdown = $('#<%= cboNominalClassModal.ClientID %>');

                    // Limpia el combobox
                    $nominalClassDropdown.empty();

                    // Llena el cboNominalClassModal con las clases nominales recibidas
                    $.each(classes, function (index, item) {
                        $nominalClassDropdown.append($('<option>', { value: item.Value, text: item.Text }));
                    });

                    // Habilita el combobox
                    $nominalClassDropdown.prop('disabled', false);
                },
        ...
        function ClearModalForm() {
            ...
            $("#<%=cboDivisionModal.ClientID%>").val("").trigger('change');
            $("#<%=cboNominalClassModal.ClientID%>").val("").trigger('change');
            $("#<%=cboCurrencyModal.ClientID%>").val("").trigger('change');


            document.getElementById("<%= cboNominalClassModal.ClientID %>").disabled = true;
        }
        ...
        function ProcessEnableRequest(resetId) {
            /// <summary>Process the Enable request according to the validation of row selected</summary>
            /// <param name="resetId" type="String">Id of the button to reset if not request proceed</param>
            if (IsRowSelected()) {
                ShowConfirmationMessageEnable(resetId);
                return false;
            }
        ...
        function ShowConfirmationMessageEnable(resetId) {
            /// <summary>Show confirmation message for Save and Close funtionality</summary>
            /// <param name="resetId" type="String">Id of the button to reset if cancel</param>
            /// <returns>False</returns>

            MostrarConfirmacion(
                  '<%= GetLocalResourceObject("msjUpdate") %>'
                , '<%=GetLocalResourceObject("Yes")%>'
                , function () {
