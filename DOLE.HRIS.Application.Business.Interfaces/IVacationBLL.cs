...
namespace DOLE.HRIS.Application.Business.Interfaces
{
    public interface IVacationBLL
    {
        ...
        /// </exception>
        PageHelper<VacacitonsBalanceEntity> ListByFilter(PageHelper<VacacitonsBalanceEntity> page, string geographicDivisionCode) ;
        ...
        int ValidateRequest(string employeeCode, string geographicDivisionCode, int divisionCode, bool isRange, List<VacationRequestDay> vacationDays);
        ...
        /// </remarks>
        long VacationRequestAdd(int seatSuperior, string employeeCode, string geographicDivisionCode, int divisionCode, bool isRange, decimal totalDaysRequest, string user, List<VacationRequestDay> vacationDays);
    }
}
