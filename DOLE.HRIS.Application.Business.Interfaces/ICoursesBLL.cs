...
{
    public interface ICoursesBll<T> where T : CourseEntity
    {
        /// <summary>
        ...
        PageHelper<CourseEntity> ListByFilters(int divisionCode, string geographicDivisionCode, string courseCode, string courseName, string courseState, string sortExpression, string sortDirection, int? pageNumber, string Lang = "ES");
        ...
        Tuple<bool, CourseEntity> Add(CourseEntity entity);

        /// <summary>
        /// Edit the course
        /// </summary>
        /// <param name="entity">The course</param>        
        Tuple<bool, CourseEntity> Edit(T entity);
        ...
        List<CourseEntity> ListByCoursesByTrainersAssociated(string geographicDivisionCode, int divisionCode, string trainerCode);
