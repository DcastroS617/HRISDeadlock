...
{
    public interface IMasterProgramDal
    {
        /// <summary>
        /// List the master Program assocated with a training programs key: GeographicDivisionCode
        /// </summary>
        PageHelper<MasterProgramEntity> MasterProgramByFilter(MasterProgramEntity entity, string Lang, int Divisioncode, string sortExpression, string sortDirection, int pageNumber, int? pageSize, int pageSizeValue);
