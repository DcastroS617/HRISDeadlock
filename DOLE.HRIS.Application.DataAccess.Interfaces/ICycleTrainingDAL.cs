...
{
    public interface ICycleTrainingDal
    {
        /// <summary>
        ...
        PageHelper<CycleTrainingEntity> CycleTrainingListByFilter(CycleTrainingEntity CycleTraining, int DivisionCode, string sortExpression, string sortDirection, int pageNumber, int? pageSize, int pageSizeValue);
