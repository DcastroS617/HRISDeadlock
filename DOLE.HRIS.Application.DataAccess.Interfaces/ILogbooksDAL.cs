...
namespace DOLE.HRIS.Application.DataAccess.Interfaces
{
    public interface ILogbooksDal
    {
        ...
        PageHelper<LogbookEntity> ListByFilters(LogbookEntity logbookEntity, string trainingCenterCode, string user, string sortExpression, string sortDirection, int pageNumber, int? pageSize, int pageSizeValue);
        ...
        /// <param name="trainingModuleCode">Training module code</param>
        /// <returns>The logbooks meeting the given filters and page config</returns>
        PageHelper<LogbookEntity> ListHistoryByFilters(LogbookEntity logbookEntity, string trainingCenterCode, string user, string sortExpression, string sortDirection, int pageNumber, int? pageSize, int pageSizeValue);
