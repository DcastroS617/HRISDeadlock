...
{
    public interface IGtiPeriodDAL
    {
        ...
        /// <param name="pageSizeValue">Page size parameter module code</param>
        /// <returns>The period meeting the given filters and page config</returns>
        PageHelper<PeriodCampaignEntity> ListGtiPeriodByFilters(PeriodCampaignEntity periodCampaignEntity, string sortExpression, string sortDirection, int pageNumber, int pageSize);

        /// <summary>
        /// List a Period Campaign by its key
        /// </summary>
