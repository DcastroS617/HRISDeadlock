...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Instructor")]
    public class TC003CreacionEspaciosBlancosInstructoresTest
    {
        ...
        [Test]
        public async Task TC003CreacionEspaciosBlancosinstructores()
        {
            ...
            myCommons.SelectBootstrapTrainerOptionByText(driver, wait, "ctl00_cntBody_cboTrainerType", "Persona externa");
            ...
            driver.FindElement(By.Id("ctl00_cntBody_txtExternalsTrainerCode")).SendKeys(seleniumEntities.Code);
            ...
            driver.FindElement(By.Id("ctl00_cntBody_txtExternalsTrainerName")).SendKeys(seleniumEntities.Description);
