...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Instructor")]
    public class TC001CreacionInstructiorCuentaGenericaTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("123693453", "Javier Arroyo"));
        }
        ...
        [Test]
        public async Task TC001CreacionInstructiorCuentaGenerica()
        {
            ...
            Thread.Sleep(1500);
            myCommons.CreateTrainer(wait, driver, js, seleniumEntities, "Cuenta Genérica");
