...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Instructor")]
    public class TC003CaracteresEspecialesInstructoresTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity(@"INSscript/>test!@#$%^*()__++{}:<>?<script />;:,.[L¨P¨P*ñ{09'987:Ñ[*?P>.><<!@#$%^&*((", @"INSscript/>test!@#$%^*()__++{}:<>?<script />;:,.[L¨P¨P*ñ{09'987:Ñ[*?P>.><<!@#$%^&*(("));
        ...
        [Test]
        public async Task TC003CreacionCaracteresInstructores()
        {
            ...
            wait.Until(ExpectedConditions.ElementToBeClickable(By.Id("ctl00_cntBody_txtTrainerCodeFilter"))).Click();
            driver.FindElement(By.Id("ctl00_cntBody_txtTrainerCodeFilter")).SendKeys("INSscriptt");
            ...
            Assert.AreEqual("INSscriptt", displayedCode, "el código del instructor no coincide.");
            ...
            Assert.AreEqual("INSscripttest@__:script :.LPPñ09987:ÑP.@", displayedDescription, "El nombre del instructor no coincide.");
            myCommons.Log.Information($"{DateTime.Now}: Validando el Assert en el campo de Nombre del instructor  " + displayedDescription);
        }
    }
}