...

{
    [TestFixture]
    [Category("Instructor")]
    public class TC001ActualizacionInstructorPersonaExternaTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("PEED01", "PEED01_Guillermo Morena"));
           

            seleniumEntitiesEdited.Add(new SeleniumEntity("PEED01", "Guillermo Morena Rojas"));
            seleniumEntitiesEdited.Add(new SeleniumEntity("PEED01", "3434223"));
        ...
        [Test]
        public async Task TC001ActualizacionInstructorPersonaExternaEdicion()
        {
            ...
            Thread.Sleep(1000);
            wait.Until(ExpectedConditions.ElementExists(By.Id("dvTrainerCode")));
            ...
            myCommons.EditTrainer(wait, driver, js, seleniumEntitiesEdited);
            ...
            myCommons.TrainerEmployeeByName(wait, driver, js, seleniumEntitiesEdited[0].Description);
            ...
            Assert.AreEqual(seleniumEntitiesEdited[0].Code, displayedCode, "El código del Instructor no coincide.");
            myCommons.Log.Information($"{DateTime.Now}: Validando el Assert por Código de instructor  " + seleniumEntitiesEdited[0].Code);


            string displayedDescription = driver.FindElement(By.Id("dvTrainerName")).Text;
            Assert.AreEqual(seleniumEntitiesEdited[0].Description, displayedDescription, "El nombre del instructor no coincide.");
            myCommons.Log.Information($"{DateTime.Now}: Validando el Assert por Nombre del Instructor  " + seleniumEntitiesEdited[0].Description);
