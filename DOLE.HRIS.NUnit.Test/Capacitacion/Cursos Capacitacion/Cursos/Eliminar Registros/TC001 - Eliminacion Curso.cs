...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Cursos")]
    public class TC001EliminacionCursoTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("COEL001", "COEL001_CursoAEliminar"));
            seleniumEntities.Add(new SeleniumEntity("COEL002", "COEL002_CuroAEliminar"));
        }
        [TearDown]
        ...
        [Test]
        public async Task TC001EliminacionCurso()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                myCommons.DeleteCourse(wait, driver, js, seleniumEntities[i].Code);
