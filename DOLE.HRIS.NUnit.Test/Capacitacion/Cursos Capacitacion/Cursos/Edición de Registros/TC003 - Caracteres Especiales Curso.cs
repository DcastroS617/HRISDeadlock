...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Cursos")]
    public class TC003EdicionCaracteresEspecialesCursoTest
    {
        ...
        private readonly SeleniumEntity seleniumEntitiesEdited = new SeleniumEntity("COC001", @"COCscripttest@__:script:LPPñ09987:ÑP@__:s@?*]%#$%^*()++{}*{[*?>><<!#$%^&*((");
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("COC001", "COC001_EditarCaracteres"));
        ...
        [Test]
        public async Task TC003EdicionCaracteresEspecialesCurso()
        {
            ...
            myCommons.EditCourse(wait, driver, js, new List<SeleniumEntity> { seleniumEntitiesEdited });
            ...
            driver.FindElement(By.Id("ctl00_cntBody_txtCourseCodeFilter")).SendKeys(seleniumEntities[0].Code);
            ...
            Assert.AreEqual("COC001", displayedCode, "El código de la curso no coincide.");
            ...
            Assert.AreEqual("COCscripttest@__:script:LPPñ09987:ÑP@__:s@", displayedDescription, "La descripción del Curso no coincide.");
