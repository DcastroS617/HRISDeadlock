...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Cursos")]
    public class TC001CreacionCursoConNOTAConMatrizConCicloTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("CNMC001", "CNMC001_CourseCreateNotaMatrizCiclo"));
           
            seleniumEntities.Add(new SeleniumEntity("CNMC002", "CNMC002_CourseCreateNotaMatrizCiclo"));
        }
        ...
        [Test]
        public async Task TC001CreacionDeCursoConNotaConMatrizConCiclo()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Thread.Sleep(1000);
               myCommons.CourseCreateWithGradeMatrixCycle(wait, driver, js, i, seleniumEntities);
                ...
                Assert.AreEqual("$ 60,00", displayedCourseCostByParticipant, "Costo por Participante no coincide.");
                ...
                Assert.AreEqual("50,00 hrs", displayeddvCourseDuration, "Duración del Curso no coincide.");
