...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Cursos")]
    public class TC001CreacionCursoConMatrizTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("CU001", "CU001_CourseCreate"));
           
            seleniumEntities.Add(new SeleniumEntity("CU002", "CU002_CourseCreate"));
        }
        ...
        [Test]
        public async Task TC001CreacionDeCursoConMatriz()
        {
