...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Cursos")]
    public class TC001CreacionCursoSINNOTAConMatrizConCicloTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("CSNC001", "CSNC001_CreateSINNotaMatrizCiclo1"));
           
            seleniumEntities.Add(new SeleniumEntity("CSNC002", "CSNC002_CreateSINNotaMatrizCiclo2"));
        }
        ...
        [Test]
        public async Task TC001CreacionDeCursoSINNotaConMatrizConCiclo()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Thread.Sleep(1000);
               myCommons.CourseCreateWithoutGrade(wait, driver, js, i, seleniumEntities);
