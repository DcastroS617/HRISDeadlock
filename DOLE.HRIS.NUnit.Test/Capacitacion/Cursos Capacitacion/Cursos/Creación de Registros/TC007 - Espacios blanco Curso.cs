...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Cursos")]
    public class TC003CreacionEspaciosBlancosCursoTest
    {
        ...
        [Test]
        public async Task TC003CreacionEspaciosBlancosCurso()
        {
            ...
            driver.FindElement(By.Id("ctl00_cntBody_txtCourseCode")).SendKeys(seleniumEntities.Code);


            wait.Until(ExpectedConditions.ElementToBeClickable(By.Id("ctl00_cntBody_txtCourseName"))).Click();
            driver.FindElement(By.Id("ctl00_cntBody_txtCourseName")).SendKeys(seleniumEntities.Description);
            ...
            //driver.FindElement(By.Id("ctl00_cntBody_txtTypeTrainingEdit")).Click();
            {
               ...
               driver.FindElement(By.Id("ctl00_cntBody_txtTypeTrainingEdit")).SendKeys(seleniumEntities.Description);
            ...
            driver.FindElement(By.Id("ctl00_cntBody_txtCourseCostByParticipant")).SendKeys(seleniumEntities.Description);
            ...
            driver.FindElement(By.Id("ctl00_cntBody_txtCourseDuration")).SendKeys(seleniumEntities.Description);
