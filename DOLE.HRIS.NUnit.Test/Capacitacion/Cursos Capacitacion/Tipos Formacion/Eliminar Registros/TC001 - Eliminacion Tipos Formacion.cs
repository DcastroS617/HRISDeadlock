...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Propositos")]
    public class TC001EliminacionTiposFormacionTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("TFEL01", "TFEL01_TipoFormaciónAEliminar"));
            seleniumEntities.Add(new SeleniumEntity("TFEL02", "TFEL02_TipoFormaciónAEliminar"));
        }
        ...
        [Test]
        public async Task TC001EliminacionTiposFormacion()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                myCommons.DeleteTrainingType(wait, driver, js, seleniumEntities[i].Code);
