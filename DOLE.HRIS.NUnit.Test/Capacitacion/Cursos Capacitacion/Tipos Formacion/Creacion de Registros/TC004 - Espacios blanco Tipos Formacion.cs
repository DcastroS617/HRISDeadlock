...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Propositos")]
    public class TC003EspaciosBlancosTiposFormacionTest
    {
        ...
        public async Task TC003EspaciosBlancosTiposFormacionCreacion()
        {
            ...
            wait.Until(ExpectedConditions.PresenceOfAllElementsLocatedBy(By.Id("ctl00_cntBody_TypeTrainingCodeEdit")));
            IWebElement codeField = wait.Until(ExpectedConditions.ElementToBeClickable(By.Id("ctl00_cntBody_TypeTrainingCodeEdit")));
            codeField.Click();
            codeField.SendKeys(seleniumEntities.Code);

            wait.Until(ExpectedConditions.PresenceOfAllElementsLocatedBy(By.Id("ctl00_cntBody_TypeTrainingNameEdit")));
            IWebElement nameField = wait.Until(ExpectedConditions.ElementToBeClickable(By.Id("ctl00_cntBody_TypeTrainingNameEdit")));
            nameField.Click();
