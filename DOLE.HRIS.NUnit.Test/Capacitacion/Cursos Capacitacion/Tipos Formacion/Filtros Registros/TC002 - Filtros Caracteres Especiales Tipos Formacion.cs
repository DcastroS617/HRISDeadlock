...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Propositos")]
    public class TC002FiltrosCaracteresEspecialesTiposFormacionTest
    {
        ...
        private readonly SeleniumEntity seleniumEntities = new SeleniumEntity(@"TFCHAscript/>test!@#$%^*()__++{}:<>?<script/>;:,.[L¨P¨P*ñ{09'987:Ñ[*?P>.><<!@#$%^&*((", @"TFCHAscript/>test!@#$%^*()__++{}:<>?<script/>;:,.[L¨P¨P*ñ{09'987:Ñ[*?P>.><<!@#$%^&*((");
        ...
        [Test]
        public async Task TC002FiltrosCaracteresEspecialesTiposFormacion()
        {
            ...
            Assert.AreEqual("TFCHAscrip", displayedCode, "La código del centro no coincide.");
            ...
            Assert.AreEqual("TFCHAscripttest@__:script:.LPPñ09987:ÑP.@", displayedDescription, "La descripción del Tipo de formación no coincide.");
