...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Escuelas")]
    public class TC001EliminacionEscuelaEntrenamientoTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("SHEL001", "SHEL001_EscuelaAEliminar"));
            seleniumEntities.Add(new SeleniumEntity("SHEL002", "SHEL002_EscuelaAEliminar"));
        }
        ...
        [Test]
        public async Task TC001EliminacionEscuelaEntrenamiento()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                myCommons.DeleteSchoolTraining(wait, driver, js, seleniumEntities[i].Code);
