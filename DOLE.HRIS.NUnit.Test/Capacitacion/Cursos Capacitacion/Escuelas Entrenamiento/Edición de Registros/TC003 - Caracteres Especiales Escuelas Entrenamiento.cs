...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Escuelas")]
    public class TC003EdicionCaracteresEspecialesEscuelaEntrenamientoTest
    {
        ...
        private readonly SeleniumEntity seleniumEntitiesEdited = new SeleniumEntity("SHC001", @"SHCscripttest@__:script:LPPñ09987:ÑP@__:s@?*]%#$%^*()++{}*{[*?>><<!#$%^&*((");
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("SHC001", "SHC001_EditarCaracteres"));
        ...
        [Test]
        public async Task TC003EdicionCaracteresEspecialesEscuelaEntrenamiento()
        {
            ...
            myCommons.SchoolTrainingCreateCharacters(wait, driver, js, seleniumEntities);
            myCommons.Log.Information($"{DateTime.Now}: Escuela creado Exitosamente.");

            myCommons.SearchSchoolByCode(wait, driver, js, seleniumEntities[0].Code);
            ...
            wait.Until(ExpectedConditions.ElementToBeClickable(By.Id("dvSchoolTrainingName"))).Click();
            ...
            myCommons.EditSchoolTraining(wait, driver, js, new List<SeleniumEntity> { seleniumEntitiesEdited });
            ...
            driver.FindElement(By.Id("ctl00_cntBody_SchoolTrainingCodeFilter")).SendKeys(seleniumEntities[0].Code);
            ...
            Assert.AreEqual("SHC001", displayedCode, "La código de la Escuela no coincide.");
            ...
            Assert.AreEqual("SHCscripttest@__:script:LPPñ09987:ÑP@__:s@", displayedDescription, "La descripción de la Escuela no coincide.");
