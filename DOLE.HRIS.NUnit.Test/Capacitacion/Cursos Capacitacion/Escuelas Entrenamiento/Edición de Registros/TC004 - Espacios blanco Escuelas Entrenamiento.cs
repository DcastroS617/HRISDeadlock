...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Escuelas")]
    public class TC003EdicionEspaciosBlancosEscuelaEntrenamientoTest
    {
        ...
        private readonly SeleniumEntity seleniumEntitiesEmpty = new SeleniumEntity("SHEM001", "   ");
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("SHEM001", "SHEM001_EditarConEmpty"));
        }
        ...
        [Test]
        public async Task TC003EdicionEspaciosBlancosEscuelaEntrenamiento()
        {
            ...
            driver.FindElement(By.Id("ctl00_cntBody_SchoolTrainingNameEdit")).SendKeys(seleniumEntitiesEmpty.Description);
