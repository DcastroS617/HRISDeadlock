...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Escuelas")]
    public class TC001ActualizacionEscuelaEntrenamientoTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("SHU001", "SHU001_EscuelaAEditar001"));


            seleniumEntitiesEdited.Add(new SeleniumEntity("SHU001", "SHU001_EscuelaUpdate001"));
        ...
        [Test]
        public async Task TC001ActualizacionEscuelaEntrenamiento()
        {
            ...
            myCommons.EditSchoolTraining(wait, driver, js, seleniumEntitiesEdited);
            ...
            myCommons.SearchSchoolByDescription(wait, driver, js, seleniumEntitiesEdited[0].Description);
            ...
            Assert.AreEqual(seleniumEntities[0].Code, displayedCode, "El código de la Escuela no coincide.");
            myCommons.Log.Information($"{DateTime.Now}: Validando el Assert por Código de la Escuela  " + seleniumEntitiesEdited[0].Code);


            string displayedDescription = driver.FindElement(By.Id("dvSchoolTrainingName")).Text;
            Assert.AreEqual(seleniumEntitiesEdited[0].Description, displayedDescription, "El nombre de la Escuela no coincide.");
            myCommons.Log.Information($"{DateTime.Now}: Validando el Assert para el Nombre de la Escuela  " + seleniumEntitiesEdited[0].Description);
