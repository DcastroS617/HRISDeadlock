...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Escuelas")]
    public class TC003CaracteresEspecialesEscuelaEntrenamientoTest
    {
        ...
        private readonly SeleniumEntity seleniumEntities = new SeleniumEntity(@"SHOscript/>test!@#$%^*()__++{}:<>?<script />;:,.[L¨P¨P*ñ{09'987:Ñ[*?P>.><<!@#$%^&*((", @"SHOscript/>test!@#$%^*()__++{}:<>?<script />;:,.[L¨P¨P*ñ{09'987:Ñ[*?P>.><<!@#$%^&*((");
        ...
        [Test]
        public async Task TC003CreacionCaracteresEspecialesEscuelaEntrenamiento()
        {
            ...
            wait.Until(ExpectedConditions.ElementToBeClickable(By.Id("ctl00_cntBody_SchoolTrainingCodeFilter"))).Click();
            driver.FindElement(By.Id("ctl00_cntBody_SchoolTrainingCodeFilter")).SendKeys("SHOscriptt");
            ...
            Assert.AreEqual("SHOscriptt", displayedCode, "La código de la escuela no coincide.");
            ...
            Assert.AreEqual("SHOscripttest@__:script :.LPPñ09987:ÑP.@", displayedDescription, "El nombre de la Escuela no coincide.");
            myCommons.Log.Information($"{DateTime.Now}: Validando el Assert en el campo de Nombre de la Escuela  " + displayedDescription);
        }
    }
}