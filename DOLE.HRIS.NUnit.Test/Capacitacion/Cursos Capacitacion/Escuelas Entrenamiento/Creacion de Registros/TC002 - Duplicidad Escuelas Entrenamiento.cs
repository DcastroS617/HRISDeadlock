...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Escuelas")]
    public class TC002DuplicidadEscuelaEntrenamientoTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("SHD001", "SHD001_DuplicarRegistro"));
            seleniumEntities.Add(new SeleniumEntity("SHD002", "SHD002_DuplicarRegistro"));
        }
        ...
        [Test]
        public async Task TC002CreacionDuplicidadEscuelaEntrenamiento()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                myCommons.SchoolTrainingDuplicate(wait, driver, js, i, seleniumEntities);
                myCommons.Log.Information($"{DateTime.Now}: Digitando los datos para la creación del registro.");
