...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    ...
    public class TC003CreacionCaracteresEspecialesAreaTematicaTest
    {
        ...
        private readonly SeleniumEntity seleniumEntities = new SeleniumEntity(@"ATHscript/>test!@#$%^*()__++{}:<>?<script />;:,.[L¨P¨P*ñ{09'987:Ñ[*?P>.><<!@#$%^&*((", @"ATHscript/>test!@#$%^*()__++{}:<>?<script />;:,.[L¨P¨P*ñ{09'987:Ñ[*?P>.><<!@#$%^&*((");
        ...
        [Test]
        public async Task TC003CreacionCaracteresEspecialesAreaTematica()
        {
            ...
            driver.FindElement(By.Id("ctl00_cntBody_txtThematicAreaCodeFilter")).SendKeys("ATHscriptt");
            ...
            Assert.AreEqual("ATHscriptt", displayedCode, "La código del Area no coincide.");
            ...
            Assert.AreEqual("ATHscripttest@__:script :.LPPñ09987:ÑP.@", displayedDescription, "El nombre del Area no coincide.");
            myCommons.Log.Information($"{DateTime.Now}: Validando el Assert en el campo de Nombre del Area  " + displayedDescription);
        }
    }
}