...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    ...
    public class TC003CreacionEspaciosBlancosAreaTematicaTest
    {
        ...
        [Test]
        public async Task TC003CreacionEspaciosBlancosAreaTematica()
        {
            ...
            driver.FindElement(By.Id("ctl00_cntBody_txtThematicAreaCode")).SendKeys(seleniumEntities.Code);

          
            wait.Until(ExpectedConditions.ElementToBeClickable(By.Id("ctl00_cntBody_txtThematicAreaName"))).Click();
            driver.FindElement(By.Id("ctl00_cntBody_txtThematicAreaName")).SendKeys(seleniumEntities.Description);
