...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    ...
    public class TC001EliminacionAreaTematicaTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("ATEL001", "ATEL001_AreaAEliminar"));
            seleniumEntities.Add(new SeleniumEntity("ATEL002", "ATEL002_AreaAEliminar"));
        }
        ...
        [Test]
        public async Task TC001EliminacionAreaTematica()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                myCommons.SearchThematicAreaByCode(wait, driver, js, seleniumEntities[i].Code);
                Thread.Sleep(2000);
                wait.Until(ExpectedConditions.ElementIsVisible(By.Id("dvThematicAreaCode")));

                myCommons.DeleteThematicArea(wait, driver, js, seleniumEntities[i].Code);
