...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Propositos")]
    public class TC002FiltrosCaracteresEspecialesPropositoEntrenamientoTest
    {
        ...
        private readonly SeleniumEntity seleniumEntities = new SeleniumEntity(@"PROPscript/>test!@#$%^*()__++{}:<>?<script/>;:,.[L¨P¨P*ñ{09'987:Ñ[*?P>.><<!@#$%^&*((", @"PROPscript/>test!@#$%^*()__++{}:<>?<script/>;:,.[L¨P¨P*ñ{09'987:Ñ[*?P>.><<!@#$%^&*((");
        ...
        [Test]
        public async Task TC002FiltrosCaracteresEspecialesPropositoEntrenamiento()
        {
            ...
            Assert.AreEqual("PROPscript", displayedCode, "La código del centro no coincide.");
            myCommons.Log.Information($"{DateTime.Now}: Validando el Assert en el campo de Código  " + displayedCode);


            myCommons.SearchPurposeByDescription(wait, driver, js, seleniumEntities.Description);
            ...
            Assert.AreEqual("PROPscripttest@__:script:.LPPñ09987:ÑP.@", displayedDescription, "La descripción del centro no coincide.");
