...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Propositos")]
    public class TC002DuplicidadPropositoEntrenamientoTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("PDU001", "PDU001_DuplicarRegistro"));
            seleniumEntities.Add(new SeleniumEntity("PDU002", "PDU002_DuplicarRegistro"));
        }
        [TearDown]
        ...
        [Test]
        public async Task TC002DuplicidadPropositoEntrenamiento()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
             ...
             Thread.Sleep(1000);
                ...
                myCommons.AgregarPropositoaDuplicar(wait, driver, js, i, seleniumEntities);
                myCommons.Log.Information($"{DateTime.Now}: Digitando los datos para la creación del registro.");

              
             Thread.Sleep(1000);
             wait.Until(ExpectedConditions.ElementExists(By.Id("ctl00_cntBody_divDuplicatedDialogText")));
