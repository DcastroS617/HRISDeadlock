...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Propositos")]
    public class TC001CreacionPropositoEntrenamientoTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("P001", "P001_Proposito"));
            seleniumEntities.Add(new SeleniumEntity("P002", "P002_Proposito"));
        ...
        [Test]
        public async Task TC001CreacionPropositoEntrenamiento()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                myCommons.Log.Information($"{DateTime.Now}: Buscando el Propósito creado  " + seleniumEntities[i].Code);
                ...
                Assert.AreEqual(seleniumEntities[i].Code, displayedCode, "La código del proposito no coincide.");
                myCommons.Log.Information($"{DateTime.Now}: Validando el Assert por Código de propósito  " + seleniumEntities[i].Code);


                string displayedDescription = driver.FindElement(By.Id("dvTrainingProgramName")).Text;
                Assert.AreEqual(seleniumEntities[i].Description, displayedDescription, "La descripción del propósito no coincide.");
                myCommons.Log.Information($"{DateTime.Now}: Validando el Assert por Descripción del propósito  " + seleniumEntities[i].Description);
            }
