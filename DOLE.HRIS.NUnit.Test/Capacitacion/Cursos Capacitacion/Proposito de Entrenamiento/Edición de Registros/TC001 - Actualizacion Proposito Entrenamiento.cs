...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Propositos")]
    public class TC001ActualizacionPropositoEntrenamientoTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("POU001", "POU001_PropositoAEditar001"));
            seleniumEntities.Add(new SeleniumEntity("POU002", "POU002_PropositoAEditar002"));

            seleniumEntitiesEdited.Add(new SeleniumEntity("POU001", "POU001_PropositoUpdate001"));
            seleniumEntitiesEdited.Add(new SeleniumEntity("POU002", "POU002_PropositoUpdate002"));
        ...
        [Test]
        public async Task TC001ActualizacionPropositoEntrenamiento()
        {
            ...
            // Espera a que el botón con ID que contiene 'btnAdd' sea clickeable y haz clic en él
                ...
                Thread.Sleep(1000);
                myCommons.AgregarPropositosEdicion(wait, driver, js, seleniumEntities);
            ...
            myCommons.EditPurposes(wait, driver, js, seleniumEntitiesEdited);
                ...
                myCommons.SearchPurposeByDescription(wait, driver, js, seleniumEntitiesEdited[0].Description);
