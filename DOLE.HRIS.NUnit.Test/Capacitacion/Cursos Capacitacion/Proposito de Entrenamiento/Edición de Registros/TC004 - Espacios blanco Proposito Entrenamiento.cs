...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Propositos")]
    public class TC003EdiciónEspaciosBlancosPropositoEntrenamientoTest
    {
        ...
        private readonly SeleniumEntity seleniumEntitiesEmpty = new SeleniumEntity("POE001", "   "); 
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("POE001", "POE001_EditarConEmpty"));
        ...
        [Test]
        public async Task TC003EdicionEspaciosBlancosPropositoEntrenamiento()
        {
            ...
            driver.FindElement(By.Id("ctl00_cntBody_txtTrainingProgramCodeFilter")).SendKeys("POE001");
            ...
            wait.Until(ExpectedConditions.ElementToBeClickable(By.Id("ctl00_cntBody_txtTrainingProgramName"))).Click();
            driver.FindElement(By.Id("ctl00_cntBody_txtTrainingProgramName")).SendKeys(seleniumEntitiesEmpty.Description);
