...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Cursos")]
    public class TC002DuplicidadCursosClasificacionCreacionTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("CCLA001", "CCLA001_DuplicarRegistro"));
            seleniumEntities.Add(new SeleniumEntity("CCLA002", "CCLA002_DuplicarRegistro"));
        }
        ...
        [Test]
        public async Task TC002DuplicidadCursosClasificacionCreacion()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                {
                    wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("//button[contains(@id, 'btnAdd')]")));
                ...
                myCommons.ClassificationCourseDuplicate(wait, driver, js, i, seleniumEntities);
                myCommons.Log.Information($"{DateTime.Now}: Digitando los datos para la creación del registro.");
