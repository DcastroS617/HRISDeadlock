...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Cursos")]
    public class TC001EliminacionCursosClasificacionTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("CCELIM001", "CCELIM001_CursoCLAAEliminar"));
            seleniumEntities.Add(new SeleniumEntity("CCELIM002", "CCELIM002_CursoCLAAEliminar"));
        ...
        [Test]
        public async Task TC001EliminacionCursosClasificacion()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                myCommons.Log.Information($"{DateTime.Now}: Ingresando a la modal de Creación de la Curso de Clasificación.");
                ...
                myCommons.DeleteClassificationCourse(wait, driver, js, seleniumEntities[i].Code);
