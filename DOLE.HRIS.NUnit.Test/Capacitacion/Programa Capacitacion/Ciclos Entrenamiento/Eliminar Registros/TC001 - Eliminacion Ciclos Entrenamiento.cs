...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Ciclo")]
    public class TC001EliminacionCiclosEntrenamientoTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("CYEEL01", "CYEEL01_CicloEntrenamientoAEliminar"));
        }
        ...
        [Test]
        public async Task TC001EliminacionCiclosEntrenamiento()
        {
            ...
            Thread.Sleep(1000);
                ...
                myCommons.DeleteTrainingCycle(wait, driver, js, seleniumEntities[0].Code);
