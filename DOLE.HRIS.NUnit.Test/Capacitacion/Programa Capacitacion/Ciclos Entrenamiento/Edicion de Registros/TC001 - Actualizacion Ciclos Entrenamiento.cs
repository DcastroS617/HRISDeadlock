...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Ciclo")]
    public class TC001ActualizacionCiclosEntrenamientoTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("CYE001", "POE001_CicloEditar001"));


            seleniumEntitiesEdited.Add(new SeleniumEntity("CYE001", "POE001_CicloUpdate001"));
        }
        ...
        [Test]
        public async Task TC001ActualizacionCiclosEntrenamiento()
        {
            ...
            Thread.Sleep(1000);
            wait.Until(ExpectedConditions.ElementExists(By.Id("dvCycleTrainingCode")));
            ...
            myCommons.EditTrainingCycle(wait, driver, js, seleniumEntitiesEdited);
            ...
            myCommons.SearchTrainingCycleByName(wait, driver, js, seleniumEntitiesEdited[0].Description);
            ...
            Assert.AreEqual(seleniumEntitiesEdited[0].Code, displayedCode, "La código del Ciclo no coincide.");
            ...
            Assert.AreEqual(seleniumEntitiesEdited[0].Description, displayedDescription, "La descripción del Ciclo no coincide.");
            myCommons.Log.Information($"{DateTime.Now}: Validando el Assert por Descripción del Ciclo  " + seleniumEntitiesEdited[0].Description);
        }
