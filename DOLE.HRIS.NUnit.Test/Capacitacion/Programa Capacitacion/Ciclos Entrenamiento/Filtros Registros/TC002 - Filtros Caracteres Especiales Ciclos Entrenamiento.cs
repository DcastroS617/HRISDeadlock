...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    ...
    public class TC002FiltrosCaracteresEspecialesCiclosEntrenamientoTest
    {
        ...
        private readonly SeleniumEntity seleniumEntities = new SeleniumEntity(@"CCCHAscrip", @"CCCHAscript/>test!@#$%^*()__++{}:<>?<script/>;:,.[L¨P¨P*ñ{09'987:Ñ[*?P>.><<!@#$%^&*((");
        ...
        [Test]
        public async Task TC002FiltrosCaracteresEspecialesCiclosEntrenamiento()
        {
            ...
            Assert.AreEqual("CCCHAscrip", displayedCode, "El código del ciclo no coincide.");
            ...
            Assert.AreEqual("CCCHAscripttest@__:script:.LPPñ09987:ÑP.@", displayedDescription, "La descripción del Ciclo de Entrenamiento no coincide.");
