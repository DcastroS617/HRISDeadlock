...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Ciclo")]
    public class TC002DuplicidadCiclosEntrenamientoCreacionTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("CLD001", "CLD001_DuplicarRegistro"));
            seleniumEntities.Add(new SeleniumEntity("CLD002", "TCLD002_DuplicarRegistro"));
        }
        ...
        [Test]
        public async Task C002CreacionDuplicidadCiclosEntrenamiento()
        {
            ...
            myCommons.TrainingCycleDuplicate(wait, driver, js, seleniumEntities);
            myCommons.Log.Information($"{DateTime.Now}: Digitando los datos para la creación del registro.");
