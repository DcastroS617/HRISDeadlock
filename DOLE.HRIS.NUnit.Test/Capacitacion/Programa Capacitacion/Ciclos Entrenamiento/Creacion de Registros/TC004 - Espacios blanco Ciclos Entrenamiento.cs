...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Ciclo")]
    public class TC003CreacionEspaciosBlancosCiclosEntrenamientoTest
    {
        ...
        [Test]
        public async Task TC003CreacionEspaciosBlancosCiclosEntrenamiento()
        {
            ...
            wait.Until(ExpectedConditions.PresenceOfAllElementsLocatedBy(By.Id("ctl00_cntBody_CycleTrainingCodeEdit")));
            IWebElement codeField = wait.Until(ExpectedConditions.ElementToBeClickable(By.Id("ctl00_cntBody_CycleTrainingCodeEdit")));
            codeField.Click();
            codeField.SendKeys(seleniumEntities.Code);

            wait.Until(ExpectedConditions.PresenceOfAllElementsLocatedBy(By.Id("ctl00_cntBody_CycleTrainingNameEdit")));
            IWebElement nameField = wait.Until(ExpectedConditions.ElementToBeClickable(By.Id("ctl00_cntBody_CycleTrainingNameEdit")));
            nameField.Click();
