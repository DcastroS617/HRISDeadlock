...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Matriz")]
    public class TC002FiltrosCaracteresEspecialesMatrizAlcanceTest
    {
        ...
        private readonly SeleniumEntity seleniumEntities = new SeleniumEntity(@"MAXHAscrip", @"MAXHAscripttest@__:script:.LPPñ09987:ÑP.@");
        ...
        [Test]
        public async Task TC002FiltrosCaracteresEspecialesMatrizAlcance()
        {
            ...
            myCommons.MatrixTargetByCode(wait, driver, js, "MAXHAscrip" );
            ...
            Assert.AreEqual("MAXHAscrip", displayedCode, "El código del centro no coincide.");
            ...
            Assert.AreEqual("MAXHAscripttest@__:script:.LPPñ09987:ÑP.@", displayedDescription, "La descripción de la Matriz no coincide.");
