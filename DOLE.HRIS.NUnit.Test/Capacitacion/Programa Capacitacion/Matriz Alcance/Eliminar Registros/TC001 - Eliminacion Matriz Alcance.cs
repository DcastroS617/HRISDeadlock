...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Matriz")]
    public class TC001EliminacionMatrizAlcanceTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("MAEL01", "MAEL01_TipoFormaciónAEliminar"));
            seleniumEntities.Add(new SeleniumEntity("MAEL02", "MAEL02_TipoFormaciónAEliminar"));
        }
        ...
        [Test]
        public async Task TC001EliminacionMatrizAlcance()
        {
            ...
            //    Thread.Sleep(1000);
                ...
                myCommons.Log.Information($"{DateTime.Now}: Registro creado." + seleniumEntities[0].Code + seleniumEntities[0].Description);
                ...
                myCommons.Log.Information($"{DateTime.Now}: Buscando por código." + seleniumEntities[0].Code );


                myCommons.DeleteMatrixTarget(wait, driver, js, seleniumEntities[0].Code);
                myCommons.Log.Information($"{DateTime.Now}: Borrando el registro" + seleniumEntities[0].Code);
