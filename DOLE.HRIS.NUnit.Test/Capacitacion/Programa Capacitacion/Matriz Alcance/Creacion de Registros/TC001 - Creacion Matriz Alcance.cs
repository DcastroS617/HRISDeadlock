...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Matriz")]
    public class TC001CreacionMatrizAlcanceTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("MA001", "MA001_MatrixCreate"));
            seleniumEntities.Add(new SeleniumEntity("MA002", "MA002_MatrixCreate"));
        }
        ...
        [Test]
        public async Task TC001CreacionMatrizAlcance()
        {
