...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Matriz")]
    public class TC007CreacionMatrizAlcanceConSelecciónMultipleClaseNominaTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("MEN001", "MEN001_MatrixCreate"));
            seleniumEntities.Add(new SeleniumEntity("MEN002", "MEN002_MatrixCreate"));
        }
        ...
        [Test]
        public async Task TC007CreacionMatrizAlcanceConSeleccionMultiplePorClaseNomina()
        {
