...
namespace DOLE.HRIS.Application.Automation.Selenium
{
    [TestFixture]
    [Category("Programas")]
    public class TC002DuplicidadProgramasPlanesEntrenamientoCreacionTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("PPED001", "PPED001_ProgramaPlanesCreado"));
        ...
        [Test]
        public async Task TC002DuplicidadProgramasPlanesEntrenamientoCreacion()
        {
            ...
            myCommons.Log.Information($"{DateTime.Now}: Ingresando a la modal de Creación Programa Planes de Entrenamiento.");
            ...
            myCommons.Log.Information($"{DateTime.Now}: Ingresando a la modal de Creación del Ciclo.");

            Thread.Sleep(1000);

            myCommons.TrainingPlanProgramsDuplicate(wait, driver, js, seleniumEntities);
            myCommons.Log.Information($"{DateTime.Now}: Digitando los datos para la creación del registro.");
