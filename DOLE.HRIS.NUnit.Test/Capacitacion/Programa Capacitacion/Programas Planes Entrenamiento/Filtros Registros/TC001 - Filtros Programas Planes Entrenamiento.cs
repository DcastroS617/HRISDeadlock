...
{
    [TestFixture]
    public class TC001FiltrosProgramasPlanesEntrenamientoTest
    {
        private readonly string urlTest = ConfigurationManager.AppSettings.Get("UrlApplicationForTesting");
        private readonly SeleniumEntity seleniumEntities = new SeleniumEntity("099S1", "TC01_Update001");
        ...
        [Test]
        public void TC001FiltrosProgramasPlanesEntrenamiento()
        {
            ...
            driver.FindElement(By.Id("ctl00_cntBody_SchoolTrainingNameFilter")).SendKeys(seleniumEntities.Description);
