...
{
    [TestFixture]
    public class TC001ActualizacionProgramasPlanesEntrenamientoTest
    {
        ...
        public void SetUp()
        {
            ...
            seleniumEntities.Add(new SeleniumEntity("PPEU001", "PPEU001_ProgramaEditar001"));

            seleniumEntitiesEdited.Add(new SeleniumEntity("PPEU001", "PPEU001_ProgramUpdate001"));
        ...
        [Test]
        public async Task TC001ActualizacionProgramasPlanesEntrenamiento()
        {
            ...
            myCommons.Log.Information($"{DateTime.Now}: Ingresando a la modal de Creación de Programa Plan de Entrenamiento .");
            ...
            Thread.Sleep(1000);
            wait.Until(ExpectedConditions.ElementExists(By.Id("dvTrainingPlanProgramCode")));
            wait.Until(ExpectedConditions.ElementIsVisible(By.Id("dvTrainingPlanProgramCode")));
            wait.Until(ExpectedConditions.ElementToBeClickable(By.Id("dvTrainingPlanProgramCode"))).Click();
            ...
            myCommons.EditTrainingPlanPrograms(wait, driver, js, seleniumEntitiesEdited);
            ...
            myCommons.TrainingPlanProgramsByName(wait, driver, js, seleniumEntitiesEdited[0].Description);
            ...
            Assert.AreEqual(seleniumEntitiesEdited[0].Code, displayedCode, "El código del Programa Plan no coincide.");
            myCommons.Log.Information($"{DateTime.Now}: Validando el Assert por Código del ciclo  " + seleniumEntitiesEdited[0].Code);


            string displayedDescription = driver.FindElement(By.Id("dvTrainingPlanProgramName")).Text;
            Assert.AreEqual(seleniumEntitiesEdited[0].Description, displayedDescription, "La descripción del Programa Plan no coincide.");
            myCommons.Log.Information($"{DateTime.Now}: Validando el Assert por Descripción del Programa  " + seleniumEntitiesEdited[0].Description);
        }
