...
{
    [TestFixture]
    public class TC003EspaciosBlancosProgramasPlanesEntrenamientoTest
    {
        private readonly string urlTest = ConfigurationManager.AppSettings.Get("UrlApplicationForTesting");
        private readonly SeleniumEntity seleniumEntities = new SeleniumEntity("099S1", "");
        ...
        [Test]
        public void TC003EspaciosBlancosProgramasPlanesEntrenamiento()
        {
