...
namespace ProgramasPlanesEntrenamientoEdicion
{
    [TestFixture]
    public class TC003CaracteresEspecialesProgramasPlanesEntrenamientoTest
    {
        private readonly string urlTest = ConfigurationManager.AppSettings.Get("UrlApplicationForTesting");
        private readonly SeleniumEntity seleniumEntities = new SeleniumEntity("099S1", @"script/>test!@#$%^*()__++{}: <>?< script />  ;:,.[L¨P¨P*ñ{09987:Ñ[*?P>.><<!@#$%^&*((");
        ...
        [Test]
        public void TC003CaracteresEspecialesProgramasPlanesEntrenamiento()
        {
