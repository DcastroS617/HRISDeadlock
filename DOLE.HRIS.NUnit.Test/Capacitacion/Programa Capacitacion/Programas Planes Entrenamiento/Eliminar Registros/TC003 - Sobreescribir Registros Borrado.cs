...
{
    [TestFixture]
    public class TC003SobreescribirRegistroBorradoProgramasPlanesEntrenamientoTest
    {
        private readonly string urlTest = ConfigurationManager.AppSettings.Get("UrlApplicationForTesting");
        private readonly SeleniumEntity seleniumEntities = new SeleniumEntity("099S2", "TC001_Deleted002");
        ...
        [Test]
        public void TC003SobreescribirRegistroBorradoProgramasPlanesEntrenamiento()
        {
            ...
            driver.FindElement(By.CssSelector(".groupedCheckbox > .btn-default .active")).Click();
